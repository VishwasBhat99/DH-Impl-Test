...
pub struct ConfigurationParameters {
    ...
    pub mapper_col_file_path: String,
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(
            logger,
            "mapper_col_file_path: {}",
            self.mapper_col_file_path()
        );
        info!(
            logger,
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let ref_file_path_8 = matches
            ...
            .to_string();
        let mapper_col_file_path = matches
            .value_of("mapper_col_file")
            .expect("Error getting `mapper_col_file` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn mapper_col_file_path(&self) -> &str {
        &self.mapper_col_file_path
    }
    ...
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("ref_file_7")
                ...
                .help("Path to the FN Interest Income file.")
                .required(true)
        )
        .arg(
            Arg::with_name("ref_file_8")
                .long("ref-file-8")
                .value_name("REF_FILE_8")
                .help("Path to the FN Income GL Master reference file.")
                .required(true)
        )
        .arg(
            Arg::with_name("mapper_col_file")
                .long("mapper-col-file")
                .value_name("Mapper Column File")
                .help("Path to the Mapper Column file.")
                .required(true)
        )
        .arg(
