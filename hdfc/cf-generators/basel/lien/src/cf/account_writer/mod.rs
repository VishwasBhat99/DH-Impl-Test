use cf::account_as_cashflows::LienAccount;
use cf::account_writer::account_indices::Index;
use macros;
...
impl AccountWriter {
    pub fn write(&mut self, record: LienAccount) {
        // Write the account
...
impl AccountWriter {
    pub fn close(self) {
        flush_contents(self.account_w_cf_writer, "AccountWriter")
    }
}
