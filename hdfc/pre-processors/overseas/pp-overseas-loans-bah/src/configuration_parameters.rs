...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Pre-processor for Overseas Loans.")
        .author("Sougata Bhattacharjee <sougata.b@surya-soft.com> , Tarun Jaiswal <tarun.j@surya-soft.com>")
        .version("1.2.2024")
        .arg(
        ...
        .arg(
            Arg::with_name("output_concat_file")
                ...
                .help("Path to the concat output file.")
                .required(true)
        )
        .arg(
