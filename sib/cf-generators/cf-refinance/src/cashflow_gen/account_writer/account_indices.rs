...
//! Generated file from `writer.proto`
...
fn parse_descriptor_proto() -> ::protobuf::descriptor::FileDescriptorProto {
    ::protobuf::Message::parse_from_bytes(file_descriptor_proto_data).expect("Unable to Parse Descriptor Proto")
}
