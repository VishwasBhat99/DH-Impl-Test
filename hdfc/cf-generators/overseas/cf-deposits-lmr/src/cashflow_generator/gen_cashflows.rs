...
fn generate_simple_interest_cfs(
    ...
    let o_a = a.current_book_balance;
    let i_r = a.int_rate;
...
fn generate_compounding_interest_cfs(
    ...
    for cashflow_date in cf_date_iterator {
        ...
        let mut compounding_principal_amount = a.current_book_balance;
    ...
    cashflows
        ...
        .principal_amount = a.current_book_balance;
...
fn generate_bullet_cf(a: &InputAccount, convention: &Conventions) -> Cashflow {
    ...
    if a.comp_freq <= 0 {
        ...
        let i_a = interest_amount(a.current_book_balance, a.int_rate, days);
        let cf = new_cashflow(i_a, a.current_book_balance, &mat_date);
        ...
        let cf = new_cashflow(
            interest_to_pay_amount,
            a.current_book_balance,
            &a.maturity_date,
        );
...
fn generate_matured_cf(a: &InputAccount, date: &NaiveDate) -> Cashflow {
    new_cashflow(DEFAULT_FLOAT, a.current_book_balance, date)
}
