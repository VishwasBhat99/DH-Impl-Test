...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "percentage_file: {}", self.percentage_file_path());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        let input_file_path = matches
            ...
            .to_string();
        let percentage_file_path = matches
            .value_of("percentage_file")
            .expect("Error getting `percentage_file_value`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn percentage_file_path(&self) -> &str {
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    Command::new(app_name)
        .version("1.1.2314")
        .about("Cashflow generation for Undrawn Individual")
        ...
        .arg(
            Arg::new("percentage_file")
                .long("percentage-file")
                .value_name("Percentage File")
                .help("Path to the percentage file.")
                .required(true)
        )
        .arg(
            Arg::new("output_file")
