...
impl AccountWithCashflows {
    ...
    // int64 derived_next_reprice_date = 74;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.asondate != 0 {
            my_size += ::protobuf::rt::value_size(70, self.asondate, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.balm_l2.is_empty() {
            my_size += ::protobuf::rt::string_size(71, &self.balm_l2);
        }
        if !self.derived_npa_class.is_empty() {
            my_size += ::protobuf::rt::string_size(72, &self.derived_npa_class);
        }
        if !self.common_cust_id.is_empty() {
            my_size += ::protobuf::rt::string_size(73, &self.common_cust_id);
        }
        if self.derived_next_reprice_date != 0 {
            my_size += ::protobuf::rt::value_size(74, self.derived_next_reprice_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.derived_risk_weight.is_empty() {
            my_size += ::protobuf::rt::string_size(75, &self.derived_risk_weight);
        }
        if !self.restructure_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(76, &self.restructure_flag);
        }
        if !self.resid.is_empty() {
            my_size += ::protobuf::rt::string_size(77, &self.resid);
        }
        if !self.ia_line.is_empty() {
            my_size += ::protobuf::rt::string_size(78, &self.ia_line);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.tot_prin_amt != 0. {
            os.write_double(68, self.tot_prin_amt)?;
        }
        if self.tot_int_amt != 0. {
            os.write_double(69, self.tot_int_amt)?;
        }
        if self.asondate != 0 {
            os.write_int64(70, self.asondate)?;
        }
        if !self.balm_l2.is_empty() {
            os.write_string(71, &self.balm_l2)?;
        }
        if !self.derived_npa_class.is_empty() {
            os.write_string(72, &self.derived_npa_class)?;
        }
        if !self.common_cust_id.is_empty() {
            os.write_string(73, &self.common_cust_id)?;
        }
        if self.derived_next_reprice_date != 0 {
            os.write_int64(74, self.derived_next_reprice_date)?;
        }
        if !self.derived_risk_weight.is_empty() {
            os.write_string(75, &self.derived_risk_weight)?;
        }
        if !self.restructure_flag.is_empty() {
            os.write_string(76, &self.restructure_flag)?;
        }
        if !self.resid.is_empty() {
            os.write_string(77, &self.resid)?;
        }
        if !self.ia_line.is_empty() {
            os.write_string(78, &self.ia_line)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\tR\x05accNo\x12#\n\rdisbursed_amt\x18\x02\x20\x01(\x01R\x0cdis\
    bursedAmt\x12%\n\x0fos_loan_bal_lcy\x18\x03\x20\x01(\x01R\x0cosLoanBalLc\
    y\x12\x19\n\x08int_rate\x18\x04\x20\x01(\x01R\x07intRate\x12\x1e\n\x0bei\
    _amt_crnt\x18\x05\x20\x01(\x01R\teiAmtCrnt\x12\x19\n\x08int_type\x18\x06\
    \x20\x01(\tR\x07intType\x121\n\x16os_p_bal_due_local_ccy\x18\x07\x20\x01\
    (\x01R\x11osPBalDueLocalCcy\x121\n\x16os_i_bal_due_local_ccy\x18\x08\x20\
    \x01(\x01R\x11osIBalDueLocalCcy\x12,\n\x13ei_amt_paid_adv_lcy\x18\t\x20\
    \x01(\x01R\x0feiAmtPaidAdvLcy\x12#\n\x0epre_ei_bal_lcy\x18\n\x20\x01(\
    \x01R\x0bpreEiBalLcy\x12-\n\x13acc_open_value_date\x18\x0b\x20\x01(\x03R\
    \x10accOpenValueDate\x12#\n\rmaturity_date\x18\x0c\x20\x01(\x03R\x0cmatu\
    rityDate\x12+\n\x12ei_start_date_crnt\x18\r\x20\x01(\x03R\x0feiStartDate\
    Crnt\x12'\n\x10ei_end_date_crnt\x18\x0e\x20\x01(\x03R\reiEndDateCrnt\x12\
    '\n\x10ei_pay_freq_crnt\x18\x0f\x20\x01(\tR\reiPayFreqCrnt\x124\n\x17emi\
    _last_paid_date_crnt\x18\x10\x20\x01(\x03R\x13emiLastPaidDateCrnt\x12\
    \x1c\n\nei_pay_day\x18\x11\x20\x01(\x03R\x08eiPayDay\x12&\n\x0fei_orgina\
    l_term\x18\x12\x20\x01(\x03R\reiOrginalTerm\x12\x1e\n\x0bei_bal_term\x18\
    \x13\x20\x01(\x03R\teiBalTerm\x12\x15\n\x06rep_bm\x18\x14\x20\x01(\tR\
    \x05repBm\x12\x16\n\x06spread\x18\x15\x20\x01(\tR\x06spread\x12\"\n\rlas\
    t_rep_date\x18\x16\x20\x01(\x03R\x0blastRepDate\x12\"\n\rnext_rep_date\
    \x18\x17\x20\x01(\x03R\x0bnextRepDate\x12\x19\n\x08rep_freq\x18\x18\x20\
    \x01(\x03R\x07repFreq\x12(\n\x10no_ei_structures\x18\x19\x20\x01(\x03R\
    \x0enoEiStructures\x12\x1b\n\tnpa_class\x18\x1a\x20\x01(\tR\x08npaClass\
    \x12\x16\n\x06remark\x18\x1b\x20\x01(\tR\x06remark\x12$\n\x0emonths_os_c\
    omb\x18\x1c\x20\x01(\tR\x0cmonthsOsComb\x12\x19\n\x08mor_type\x18\x1d\
    \x20\x01(\tR\x07morType\x12\"\n\rfrom_mor_date\x18\x1e\x20\x01(\x03R\x0b\
    fromMorDate\x12\x1e\n\x0bto_mor_date\x18\x1f\x20\x01(\x03R\ttoMorDate\
    \x12+\n\x12recalc_ei_amt_flag\x18\x20\x20\x01(\tR\x0frecalcEiAmtFlag\x12\
    \x20\n\x0cmor_int_calc\x18!\x20\x01(\tR\nmorIntCalc\x12&\n\x0fbullet_pay\
    _flag\x18\"\x20\x01(\tR\rbulletPayFlag\x12!\n\x0crestrct_flag\x18#\x20\
    \x01(\tR\x0brestrctFlag\x121\n\x14residential_mortgage\x18$\x20\x01(\tR\
    \x13residentialMortgage\x12\x1f\n\x0brisk_weight\x18%\x20\x01(\tR\nriskW\
    eight\x12'\n\x0finternal_rating\x18&\x20\x01(\tR\x0einternalRating\x12'\
    \n\x0fexternal_rating\x18'\x20\x01(\tR\x0eexternalRating\x12+\n\x11contr\
    actual_tenor\x18(\x20\x01(\x03R\x10contractualTenor\x12%\n\x0eresidual_t\
    enor\x18)\x20\x01(\x03R\rresidualTenor\x124\n\x16cust_constitution_code\
    \x18*\x20\x01(\tR\x14custConstitutionCode\x12\x1b\n\tprod_code\x18+\x20\
    \x01(\tR\x08prodCode\x12\x1a\n\tp_gl_code\x18,\x20\x01(\tR\x07pGlCode\
    \x12\x1d\n\nm_npaclass\x18-\x20\x01(\tR\tmNpaclass\x12\x19\n\x08acrd_int\
    \x18.\x20\x01(\x01R\x07acrdInt\x12\x17\n\x07cust_id\x18/\x20\x01(\tR\x06\
    custId\x12\x1b\n\tcust_name\x180\x20\x01(\tR\x08custName\x12\x19\n\x08gr\
    ...
    \x188\x20\x01(\tR\texcessAcc\x12\x1b\n\tloan_type\x189\x20\x01(\tR\x08lo\
    anType\x12\x1b\n\tresid_int\x18:\x20\x01(\x01R\x08residInt\x12\x10\n\x03\
    ccy\x18;\x20\x01(\tR\x03ccy\x12(\n\x10hdfc_ltd_percent\x18<\x20\x01(\x01\
    R\x0ehdfcLtdPercent\x12\x1f\n\x0bsec_percent\x18=\x20\x01(\x01R\nsecPerc\
    ent\x12!\n\x0coverdue_type\x18>\x20\x01(\tR\x0boverdueType\x12\x19\n\x08\
    alm_line\x18?\x20\x01(\tR\x07almLine\x12)\n\x11emi_overdue_gl_cd\x18@\
    \x20\x01(\x03R\x0eemiOverdueGlCd\x120\n\x15pre_emi_overdue_gl_cd\x18A\
    \x20\x01(\x03R\x11preEmiOverdueGlCd\x12'\n\x10excess_emi_gl_cd\x18B\x20\
    \x01(\x03R\rexcessEmiGlCd\x12.\n\x14excess_pre_emi_gl_cd\x18C\x20\x01(\
    \x03R\x10excessPreEmiGlCd\x12\x20\n\x0ctot_prin_amt\x18D\x20\x01(\x01R\n\
    totPrinAmt\x12\x1e\n\x0btot_int_amt\x18E\x20\x01(\x01R\ttotIntAmt\x12\
    \x1a\n\x08asondate\x18F\x20\x01(\x03R\x08asondate\x12\x17\n\x07balm_l2\
    \x18G\x20\x01(\tR\x06balmL2\x12*\n\x11derived_npa_class\x18H\x20\x01(\tR\
    \x0fderivedNpaClass\x12$\n\x0ecommon_cust_id\x18I\x20\x01(\tR\x0ccommonC\
    ustId\x129\n\x19derived_next_reprice_date\x18J\x20\x01(\x03R\x16derivedN\
    extRepriceDate\x12.\n\x13derived_risk_weight\x18K\x20\x01(\tR\x11derived\
    RiskWeight\x12)\n\x10restructure_flag\x18L\x20\x01(\tR\x0frestructureFla\
    g\x12\x14\n\x05resid\x18M\x20\x01(\tR\x05resid\x12\x17\n\x07ia_line\x18N\
    \x20\x01(\tR\x06iaLine\x12'\n\tcashflows\x18O\x20\x03(\x0b2\t.CashflowR\
