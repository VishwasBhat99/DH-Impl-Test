...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "ref3_sheet_name: {}", self.ref3_sheet_name());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let ref_file_path_4 = matches
            ...
            .to_string();
        let ref3_sheet_name = matches
            .value_of("ref3_sheet_name")
        ...
        let ref_file_path_5 = matches
            .value_of("ref_file_5")
            .expect("Error getting `Term Loans Updatetype Master File`.")
            .to_string();
        let ref5_sheet_name = matches
            .value_of("ref5_sheet_name")
            .expect("Error getting `Term Loans Updatetype Master File Sheet`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn ref3_sheet_name(&self) -> &str {
        &self.ref3_sheet_name
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Pre-processor for term loans")
        .version("1.2.3361")
        ...
        .arg(
            Arg::with_name("ref3_sheet_name")
                .long("ref3-sheet-name")
                .value_name("ref3_sheet_name")
                .help("ref-3 File Sheet Name.")
                .required(true)
        )
        .arg(
