use crate::configuration_parameters::{get_configuration_parameters, ConfigurationParameters};
use crate::log::setup_loggers;
use crate::macros::LOG_PARAMS;
use crate::macros::PERF_PARAMS;
use slog::Logger;

pub fn init_loggers() -> (ConfigurationParameters, Logger, Logger) {
    let config_params = get_configuration_parameters();
