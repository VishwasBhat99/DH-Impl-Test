...
use cashflow_generator::der_cashflows::derive_cashflows;
...
pub fn generate(config_params: &ConfigurationParameters, log: &Logger, diag_log: &Logger) {
    ...
    loop {
        ...
        let nxt_rep_dt = input_account.cf_date;
        tot_prin_in_ip += input_account.cf_principal_amount;
        tot_int_in_ip += input_account.cf_interest_amount;
    ...
    let health_stat = HealthReport::new(
        tot_acc_encntrd,
        tot_acc_with_cfs,
        tot_acc_encntrd - tot_acc_with_cfs,
        tot_prin_in_ip,
        tot_prin_in_op,
        tot_cfs as i64,
    );
