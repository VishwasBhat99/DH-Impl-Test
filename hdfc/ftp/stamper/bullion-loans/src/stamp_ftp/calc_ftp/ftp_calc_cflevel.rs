...
pub fn calc_ftp_cflevel(
    ...
    if Path::new(&full_file_path).exists() {
            ...
            .iter_mut()
        {
            ...
            for index in 0..lst_adjustments.len() {
                let adj_key = Adj_key::new(cf_data_out.st_dt, lst_adjustments[index]);
    ...
    for index in 0..lst_adjustments.len() {
        ...
        let adj_rate = half_away_from_zero(
            ...
            lst_adjustments[index], st_dt, cf_data_out.acc_no
        );
                    0.0
                }
            },
        ...
        adj_codes[index] = lst_adjustments[index] as i64;
    ...
    if is_lock {
        let spread = cf_data_out.int_rt - cf_data_out.FTP_Rate;
