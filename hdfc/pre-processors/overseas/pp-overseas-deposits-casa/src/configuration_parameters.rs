...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "input_file_delimiter: {}", self.field_delimiter());
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app helps convert inputs to outputs for Overseas CASA deposits!")
        .version("1.0.3037")
        .arg(
        ...
        .arg(
            Arg::with_name("delimiter")
                ...
                .help("The field delimiter of Input file.")
                .required(true)
        )
        .get_matches()
}
