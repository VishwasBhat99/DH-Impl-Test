    ...
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let day_convention = {
            ...
            match &conv[..] {
                ...
                _ => {
                    panic!("{}", "Incorrect day convention parameter passed:- Must be one of { ACTbyACT, ACTby365, ACTby360, Thirtyby360")
                }
            }
        };
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    ...
    App::new(app_name)
        .about("This app helps deriving cashflows for Security Closing Stock!")
        .version("1.0.5204")
        ...
        .arg(
            Arg::with_name("day_convention")
                ...
                .possible_values(&["ACTbyACT","ACTby365","ACTby360","Thirtyby360"])
