...
impl InputAccountReaderReport {
    pub fn new() -> InputAccountReaderReport {
        InputAccountReaderReport {
            total_input_lines_count: 0,
            well_formed_lines_count: 0,
            malformed_lines_count: 0,
            input_accounts_parsed_count: 0,
            input_accounts_not_parsed_count: 0,
        }
    }
}
