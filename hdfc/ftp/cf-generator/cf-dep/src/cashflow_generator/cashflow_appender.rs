...
pub fn create_account_with_cashflows(
    ...
    account_with_cashflows.date_last_withdraw = rbdate::timestamp(account.date_last_withdraw);
    account_with_cashflows.prepayment_less_than_7_days = account.prepayment_less_than_7_days;
    account_with_cashflows.two_point_concat = account.two_point_concat;
    account_with_cashflows.four_point_concat = account.four_point_concat;
    for cf in &cashflows {
