...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    Command::new(app_name)
        .about("Cashflow generation for Gsec Investments")
        .version("1.1.2506")
        .arg(
            Arg::new("input_file")
                .long("input-file")
        ...
        .arg(
            Arg::new("amount_type")
                ...
                .possible_values(&["book_val", "market_val"])
                .help("Type of amount to be written as principal amount of cashflow.")
                .default_value("book_val")
                .required(true)
        )
        .arg(
            Arg::new("log_level")
