...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "convention_type: {}", self.convention_type());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let output_file_path = matches
            ...
            .to_string();
        let convention_type = matches
            .value_of("convention_type")
            .expect("Error getting `convention_type`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn convention_type(&self) -> &str {
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Cashflow derivation for Finnone Loans.")
        ...
        .arg(
            Arg::with_name("convention_type")
                .long("convention-type")
                .value_name("Convetion Type")
                .help("Convetion Type")
