...
pub struct ConfigurationParameters {
    ...
    pub output_file_path_od: String,
    pub output_concat_file_path_od: String,
    pub output_concat_file_path_td: String,
    pub output_concat_file_path_casa: String,
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "mf_master_file: {}", self.mf_master_file());
        info!(
            logger,
        ...
        info!(logger, "instance_name: {}", self.instance_name());
        ...
        info!(
            logger,
            "output_concat_file_path_td: {}",
            self.output_concat_file_path_td()
        );
        info!(
            logger,
            "output_concat_file_path_od: {}",
            self.output_concat_file_path_od()
        );
        info!(
            logger,
            "output_concat_file_path_casa: {}",
            self.output_concat_file_path_casa()
        );
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let output_file_path_casa = matches
            ...
            .to_string();
        let output_file_path_od = matches
            .value_of("output_file_od")
            .expect("Error getting `output_file_od` value.")
            .to_string();
        let output_concat_file_path_td = matches
            .value_of("output_concat_file_td")
            .expect("Error getting `output_concat_file_td` value.")
            .to_string();
        let output_concat_file_path_casa = matches
            .value_of("output_concat_file_casa")
            .expect("Error getting `output_concat_file_casa` value.")
            .to_string();
        let output_concat_file_path_od = matches
            .value_of("output_concat_file_od")
            .expect("Error getting `output_concat_file_od` value.")
            .to_string();
        ...
        let ref_file_path_5 = matches
            ...
            .to_string();
        let mf_master_file = matches
            .value_of("mf_master_file")
            .expect("Error getting `mf_master_file` value.")
            .to_string();
        ...
        let instance_name = matches
            .value_of("instance_name")
            .expect("Error getting `instance_name` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn mf_master_file(&self) -> &str {
        &self.mf_master_file
    }
    ...
    pub fn output_file_path_od(&self) -> &str {
        &self.output_file_path_od
    }
    pub fn output_file_path_casa(&self) -> &str {
        &self.output_file_path_casa
    }
    pub fn output_concat_file_path_td(&self) -> &str {
        &self.output_concat_file_path_td
    }
    pub fn output_concat_file_path_od(&self) -> &str {
        &self.output_concat_file_path_od
    }
    pub fn output_concat_file_path_casa(&self) -> &str {
        &self.output_concat_file_path_casa
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("mf_master_file")
                .long("mf-master-file")
                .value_name("MF_MASTER_FILE")
                .help("Path to the reference files: MF Master.")
                .required(true)
        )
        .arg(
        ...
        .arg(
            Arg::with_name("output_file_od")
                .long("output-file-od")
                .value_name("OD-FILE")
                .help("Path to the OD output file.")
                .required(true)
        )
        .arg(
            Arg::with_name("output_concat_file_td")
                .long("output-concat-file-td")
                .value_name("CONCAT-TD-FILE")
                .help("Path to the TD concat output file.")
                .required(true)
        )
        .arg(
            Arg::with_name("output_concat_file_od")
                .long("output-concat-file-od")
                .value_name("CONCAT-OD-FILE")
                .help("Path to the OD concat output file.")
                .required(true)
        )
        .arg(
            Arg::with_name("output_concat_file_casa")
                .long("output-concat-file-casa")
                .value_name("CONCAT-CASA-FILE")
                .help("Path to the CASA concat output file.")
                .required(true)
        )
        .arg(
