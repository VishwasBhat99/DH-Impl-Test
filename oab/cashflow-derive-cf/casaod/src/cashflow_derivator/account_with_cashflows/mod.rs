...
impl ::protobuf::Message for OutputAccount {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.pension_acc_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(39, &self.pension_acc_flag);
        }
        if !self.waiver_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(40, &self.waiver_flag);
        }
        if !self.aorl.is_empty() {
            my_size += ::protobuf::rt::string_size(41, &self.aorl);
        }
        if self.rl1 != 0 {
            my_size +=
                ::protobuf::rt::value_size(42, self.rl1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.rl2 != 0 {
            my_size +=
                ::protobuf::rt::value_size(43, self.rl2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.rl3 != 0 {
            my_size +=
                ::protobuf::rt::value_size(44, self.rl3, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(
        ...
        if !self.pension_acc_flag.is_empty() {
            os.write_string(39, &self.pension_acc_flag)?;
        }
        if !self.waiver_flag.is_empty() {
            os.write_string(40, &self.waiver_flag)?;
        }
        if !self.aorl.is_empty() {
            os.write_string(41, &self.aorl)?;
        }
        if self.rl1 != 0 {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                >(
                    "pension_acc_flag",
                    |m: &OutputAccount| &m.pension_acc_flag,
                    |m: &mut OutputAccount| &mut m.pension_acc_flag,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeString,
                >(
                    "waiver_flag",
                    |m: &OutputAccount| &m.waiver_flag,
                    |m: &mut OutputAccount| &mut m.waiver_flag,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeString,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xef\x0b\n\rOutputAcco\
    ...
    e\x12(\n\x10pension_acc_flag\x18'\x20\x01(\tR\x0epensionAccFlag\x12\x1f\
    \n\x0bwaiver_flag\x18(\x20\x01(\tR\nwaiverFlag\x12\x12\n\x04aorl\x18)\
    \x20\x01(\tR\x04aorl\x12\x10\n\x03rl1\x18*\x20\x01(\x05R\x03rl1\x12\x10\
    \n\x03rl2\x18+\x20\x01(\x05R\x03rl2\x12\x10\n\x03rl3\x18,\x20\x01(\x05R\
    \x03rl3\x12'\n\tcashflows\x18-\x20\x03(\x0b2\t.CashflowR\tcashflowsb\x06\
    proto3\
";
