...
pub fn get_717_aggregates(
    ...
    let last_dt_for_daily_bucket = incr_dt_by_mon_presrv_eom_checked(as_on_day.pred(), 12)
    ...
    for i in 1..=351 {
        let monthly_date = incr_dt_by_mon_presrv_eom_checked(as_on_day.pred(), 12 + i)
