...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let currency_conversion_file_path = matches
            ...
            .expect("Error getting `currency_conversion_file_path`.")
            .to_string();
        ...
        let default_llg_code = matches
            ...
            .to_string()
            .parse::<i32>()
            .expect("Error while parsing `default_llg_code` as i32.");
        ...
        let is_acc_level_ex_rt = matches
            .value_of("acc_level_ex_rt")
            .expect("Error getting `exchange_rate` flag.")
            .parse::<bool>()
            .expect("Error while parsing `is_acc_level_ex_rt` as bool");
...
impl ConfigurationParameters {
    ...
    pub fn is_acc_level_ex_rt(&self) -> bool {
        self.is_acc_level_ex_rt
    }
