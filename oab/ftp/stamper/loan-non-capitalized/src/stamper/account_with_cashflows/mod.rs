...
impl AccountWithCashflows {
    ...
    // double total_interest_amount = 52;
    ...
    // double total_principal_amount = 53;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.total_interest_amount != 0. {
            os.write_double(52, self.total_interest_amount)?;
        }
        if self.total_principal_amount != 0. {
            os.write_double(53, self.total_principal_amount)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xe9\x0e\n\x14AccountW\
    ...
    \x01(\x01R\x0eoutstandingBal\x12\x1d\n\nfield_type\x18\x05\x20\x01(\tR\t\
    fieldType\x12.\n\x13cf_principal_amount\x18\x06\x20\x01(\x01R\x11cfPrinc\
    ipalAmount\x12\x1c\n\tprincipal\x18\x07\x20\x01(\x01R\tprincipal\x12\x1a\
    \n\x08interest\x18\x08\x20\x01(\x01R\x08interest\x12\x17\n\x07cf_date\
    \x18\t\x20\x01(\x03R\x06cfDate\x12\x0e\n\x02gl\x18\n\x20\x01(\tR\x02gl\
    \x12\x1d\n\nstart_date\x18\x0b\x20\x01(\x03R\tstartDate\x12#\n\rmaturity\
    _date\x18\x0c\x20\x01(\x03R\x0cmaturityDate\x12\x1b\n\trate_flag\x18\r\
    \x20\x01(\tR\x08rateFlag\x12\x16\n\x06branch\x18\x0e\x20\x01(\tR\x06bran\
    ch\x12\x1f\n\x0bcustomer_id\x18\x0f\x20\x01(\tR\ncustomerId\x12#\n\rcust\
    omer_type\x18\x10\x20\x01(\tR\x0ccustomerType\x12!\n\x0cproduct_code\x18\
    \x11\x20\x01(\tR\x0bproductCode\x12\x14\n\x05group\x18\x12\x20\x01(\tR\
    \x05group\x12\x1d\n\nacc_branch\x18\x13\x20\x01(\tR\taccBranch\x12\x1d\n\
    \nacc_number\x18\x14\x20\x01(\tR\taccNumber\x12\x1d\n\nacc_suffix\x18\
    \x15\x20\x01(\tR\taccSuffix\x12\x19\n\x08acc_type\x18\x16\x20\x01(\tR\
    \x07accType\x12\x1b\n\tdeal_type\x18\x17\x20\x01(\tR\x08dealType\x12/\n\
    \x13repricing_frequency\x18\x18\x20\x01(\tR\x12repricingFrequency\x12$\n\
    \x0elast_repr_date\x18\x19\x20\x01(\x03R\x0clastReprDate\x12$\n\x0enext_\
    repr_date\x18\x1a\x20\x01(\x03R\x0cnextReprDate\x12:\n\x19int_compoundin\
    g_frequency\x18\x1b\x20\x01(\tR\x17intCompoundingFrequency\x126\n\x17int\
    _repayment_frequency\x18\x1c\x20\x01(\tR\x15intRepaymentFrequency\x12\
    \x1f\n\x0bmargin_rate\x18\x1d\x20\x01(\tR\nmarginRate\x12\x12\n\x04cpas\
    \x18\x1e\x20\x01(\tR\x04cpas\x124\n\x16cust_constitution_code\x18\x1f\
    \x20\x01(\tR\x14custConstitutionCode\x12'\n\x0fcustomer_rating\x18\x20\
    \x20\x01(\tR\x0ecustomerRating\x12\x0e\n\x02p2\x18!\x20\x01(\tR\x02p2\
    \x12#\n\ranalysis_code\x18\"\x20\x01(\tR\x0canalysisCode\x120\n\x14sundr\
    y_analysis_code\x18#\x20\x01(\tR\x12sundryAnalysisCode\x122\n\x15numeric\
    _analysis_code\x18$\x20\x01(\tR\x13numericAnalysisCode\x12$\n\x0ebase_ra\
    te_code\x18%\x20\x01(\tR\x0cbaseRateCode\x124\n\x16differential_rate_cod\
    e\x18&\x20\x01(\tR\x14differentialRateCode\x12&\n\x0faccrued_int_amt\x18\
    '\x20\x01(\x01R\raccruedIntAmt\x12,\n\x12next_rollover_date\x18(\x20\x01\
    (\x03R\x10nextRolloverDate\x12\x19\n\x08npa_flag\x18)\x20\x01(\tR\x07npa\
    Flag\x12\x19\n\x08npa_type\x18*\x20\x01(\tR\x07npaType\x12\x0e\n\x02rm\
    \x18+\x20\x01(\tR\x02rm\x12#\n\rcustomer_name\x18,\x20\x01(\tR\x0ccustom\
    erName\x12&\n\x0fmonthly_avg_bal\x18-\x20\x01(\x01R\rmonthlyAvgBal\x120\
    \n\x14pension_account_flag\x18.\x20\x01(\tR\x12pensionAccountFlag\x12\
    \x1f\n\x0bwaiver_flag\x18/\x20\x01(\tR\nwaiverFlag\x12\x12\n\x04aorl\x18\
    0\x20\x01(\tR\x04aorl\x12\x10\n\x03rl1\x181\x20\x01(\x05R\x03rl1\x12\x10\
    \n\x03rl2\x182\x20\x01(\x05R\x03rl2\x12\x10\n\x03rl3\x183\x20\x01(\x05R\
    \x03rl3\x122\n\x15total_interest_amount\x184\x20\x01(\x01R\x13totalInter\
    estAmount\x124\n\x16total_principal_amount\x185\x20\x01(\x01R\x14totalPr\
    incipalAmount\x12'\n\tcashflows\x186\x20\x03(\x0b2\t.CashflowR\tcashflow\
    sb\x06proto3\
";
