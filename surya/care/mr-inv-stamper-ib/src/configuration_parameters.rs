...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "extra_file_path: {}", self.extra_file_path());
        ...
        info!(
            logger,
            "default_hft_charge_prcnt: {}",
            self.default_hft_charge_prcnt()
        );
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        let input_file_path = matches
            ...
            .to_string();
        let extra_file_path = matches
            .value_of("extra_file_path")
            .expect("Error getting `extra_file_path`.")
            .to_string();
        ...
        let default_hft_charge_prcnt: i32 = matches
            .value_of("default_hft_charge_prcnt")
            .expect("Error getting `default_hft_charge_prcnt`.")
            .parse()
            .expect("Cannot parse default_hft_charge_prcnt");
...
impl ConfigurationParameters {
    ...
    pub fn extra_file_path(&self) -> &str {
        &self.extra_file_path
    }
    ...
    pub fn default_hft_charge_prcnt(&self) -> &i32 {
        &self.default_hft_charge_prcnt
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("default_hft_charge_prcnt")
                .long("default-hft-charge-prcnt")
                .value_name("DEFAULT HFT CHARGE PERCENTAGE")
                .help("The default hft charge prcnt")
                .required(true)
        )
        .arg(
        ...
        .arg(
            Arg::with_name("extra_file_path")
                .long("extra-file-path")
                .value_name("Extra File Path")
                .help("Path to Extra File Path.")
                .required(true)
        )
        .arg(
