...
pub struct AccountWithCashflows {
    ...
    pub cmne: ::std::string::String,
    pub sn: ::std::string::String,
    pub c_type: ::std::string::String,
    pub start_date: i64,
    pub maturity_date: i64,
    pub repo_rate: f64,
    pub int_calc_type: ::std::string::String,
    pub spread: f64,
...
impl AccountWithCashflows {
    ...
    pub fn clear_cmne(&mut self) {
        self.cmne.clear();
    }

    // Param is passed by value, moved
    pub fn set_cmne(&mut self, v: ::std::string::String) {
        self.cmne = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_cmne(&mut self) -> &mut ::std::string::String {
        &mut self.cmne
    }

    // Take field
    pub fn take_cmne(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.cmne, ::std::string::String::new())
    }

    pub fn get_cmne(&self) -> &str {
        &self.cmne
    }
    ...
    // Param is passed by value, moved
    pub fn set_sn(&mut self, v: ::std::string::String) {
        self.sn = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sn(&mut self) -> &mut ::std::string::String {
        &mut self.sn
    }

    // Take field
    pub fn take_sn(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.sn, ::std::string::String::new())
    }
    ...
    pub fn clear_c_type(&mut self) {
        self.c_type.clear();
    }

    // Param is passed by value, moved
    pub fn set_c_type(&mut self, v: ::std::string::String) {
        self.c_type = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_c_type(&mut self) -> &mut ::std::string::String {
        &mut self.c_type
    }

    // Take field
    pub fn take_c_type(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.c_type, ::std::string::String::new())
    }

    pub fn get_c_type(&self) -> &str {
        &self.c_type
    }
    ...
    // string int_calc_type = 14;

    pub fn clear_int_calc_type(&mut self) {
        self.int_calc_type.clear();
    }

    // Param is passed by value, moved
    pub fn set_int_calc_type(&mut self, v: ::std::string::String) {
        self.int_calc_type = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_int_calc_type(&mut self) -> &mut ::std::string::String {
        &mut self.int_calc_type
    }

    // Take field
    pub fn take_int_calc_type(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.int_calc_type, ::std::string::String::new())
    }

    pub fn get_int_calc_type(&self) -> &str {
        &self.int_calc_type
    }
    ...
    // double total_interest_amount = 33;
    ...
    // double total_principal_amount = 34;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.sec_id)?;
                },
                3 => {
                ...
                8 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cmne)?;
                },
                9 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.sn)?;
                },
                10 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.c_type)?;
                },
                11 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                14 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.int_calc_type)?;
                },
                15 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.product.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.product);
        }
        if !self.product_type.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.product_type);
        }
        if self.face_amt != 0. {
            my_size += 9;
        }
        ...
        if !self.cmne.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.cmne);
        }
        if !self.sn.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.sn);
        }
        if !self.c_type.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.c_type);
        }
        ...
        if !self.int_calc_type.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.int_calc_type);
        }
        if self.spread != 0. {
            my_size += 9;
        }
        ...
        if self.last_repr_date != 0 {
            my_size += ::protobuf::rt::value_size(17, self.last_repr_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.next_repr_date != 0 {
            my_size += ::protobuf::rt::value_size(18, self.next_repr_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.int_rate != 0. {
            my_size += 10;
        }
        if !self.rate_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(20, &self.rate_flag);
        }
        if !self.product_code.is_empty() {
            my_size += ::protobuf::rt::string_size(21, &self.product_code);
        }
        if !self.customer_id.is_empty() {
            my_size += ::protobuf::rt::string_size(22, &self.customer_id);
        }
        ...
        if !self.department.is_empty() {
            my_size += ::protobuf::rt::string_size(25, &self.department);
        }
        if !self.gl.is_empty() {
            my_size += ::protobuf::rt::string_size(26, &self.gl);
        }
        if !self.customer_name.is_empty() {
            my_size += ::protobuf::rt::string_size(27, &self.customer_name);
        }
        if !self.monthly_avg_bal.is_empty() {
            my_size += ::protobuf::rt::string_size(28, &self.monthly_avg_bal);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.product.is_empty() {
            os.write_string(3, &self.product)?;
        }
        if !self.product_type.is_empty() {
            os.write_string(4, &self.product_type)?;
        }
        if self.face_amt != 0. {
            os.write_double(5, self.face_amt)?;
        }
        if self.outstanding_bal != 0. {
            os.write_double(6, self.outstanding_bal)?;
        }
        if !self.currency.is_empty() {
            os.write_string(7, &self.currency)?;
        }
        if !self.cmne.is_empty() {
            os.write_string(8, &self.cmne)?;
        }
        if !self.sn.is_empty() {
            os.write_string(9, &self.sn)?;
        }
        if !self.c_type.is_empty() {
            os.write_string(10, &self.c_type)?;
        }
        if self.start_date != 0 {
        ...
        if self.repo_rate != 0. {
            os.write_double(13, self.repo_rate)?;
        }
        if !self.int_calc_type.is_empty() {
            os.write_string(14, &self.int_calc_type)?;
        }
        if self.spread != 0. {
        ...
        if self.last_repr_date != 0 {
            os.write_int64(17, self.last_repr_date)?;
        }
        if self.next_repr_date != 0 {
            os.write_int64(18, self.next_repr_date)?;
        }
        if self.int_rate != 0. {
            os.write_double(19, self.int_rate)?;
        }
        if !self.rate_flag.is_empty() {
            os.write_string(20, &self.rate_flag)?;
        }
        if !self.product_code.is_empty() {
            os.write_string(21, &self.product_code)?;
        }
        if !self.customer_id.is_empty() {
            os.write_string(22, &self.customer_id)?;
        }
        if !self.branch.is_empty() {
        ...
        if !self.department.is_empty() {
            os.write_string(25, &self.department)?;
        }
        if !self.gl.is_empty() {
            os.write_string(26, &self.gl)?;
        }
        if !self.customer_name.is_empty() {
            os.write_string(27, &self.customer_name)?;
        }
        if !self.monthly_avg_bal.is_empty() {
            os.write_string(28, &self.monthly_avg_bal)?;
        }
        if !self.aorl.is_empty() {
            os.write_string(29, &self.aorl)?;
        }
        if self.rl1 != 0 {
            os.write_int32(30, self.rl1)?;
        }
        if self.rl2 != 0 {
            os.write_int32(31, self.rl2)?;
        }
        if self.rl3 != 0 {
            os.write_int32(32, self.rl3)?;
        }
        if self.total_interest_amount != 0. {
            os.write_double(33, self.total_interest_amount)?;
        }
        if self.total_principal_amount != 0. {
            os.write_double(34, self.total_principal_amount)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "cmne",
                    |m: &AccountWithCashflows| { &m.cmne },
                    |m: &mut AccountWithCashflows| { &mut m.cmne },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "sn",
                    |m: &AccountWithCashflows| { &m.sn },
                    |m: &mut AccountWithCashflows| { &mut m.sn },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "c_type",
                    |m: &AccountWithCashflows| { &m.c_type },
                    |m: &mut AccountWithCashflows| { &mut m.c_type },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "start_date",
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "int_calc_type",
                    |m: &AccountWithCashflows| { &m.int_calc_type },
                    |m: &mut AccountWithCashflows| { &mut m.int_calc_type },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "spread",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xa9\x08\n\x14AccountW\
    ithCashflows\x12\x1d\n\naccount_id\x18\x01\x20\x01(\tR\taccountId\x12\
    \x15\n\x06sec_id\x18\x02\x20\x01(\tR\x05secId\x12\x18\n\x07product\x18\
    \x03\x20\x01(\tR\x07product\x12!\n\x0cproduct_type\x18\x04\x20\x01(\tR\
    \x0bproductType\x12\x19\n\x08face_amt\x18\x05\x20\x01(\x01R\x07faceAmt\
    \x12'\n\x0foutstanding_bal\x18\x06\x20\x01(\x01R\x0eoutstandingBal\x12\
    \x1a\n\x08currency\x18\x07\x20\x01(\tR\x08currency\x12\x12\n\x04cmne\x18\
    \x08\x20\x01(\tR\x04cmne\x12\x0e\n\x02sn\x18\t\x20\x01(\tR\x02sn\x12\x15\
    \n\x06c_type\x18\n\x20\x01(\tR\x05cType\x12\x1d\n\nstart_date\x18\x0b\
    \x20\x01(\x03R\tstartDate\x12#\n\rmaturity_date\x18\x0c\x20\x01(\x03R\
    \x0cmaturityDate\x12\x1b\n\trepo_rate\x18\r\x20\x01(\x01R\x08repoRate\
    \x12\"\n\rint_calc_type\x18\x0e\x20\x01(\tR\x0bintCalcType\x12\x16\n\x06\
    spread\x18\x0f\x20\x01(\x01R\x06spread\x12\x1c\n\tbenchmark\x18\x10\x20\
    \x01(\tR\tbenchmark\x12$\n\x0elast_repr_date\x18\x11\x20\x01(\x03R\x0cla\
    stReprDate\x12$\n\x0enext_repr_date\x18\x12\x20\x01(\x03R\x0cnextReprDat\
    e\x12\x19\n\x08int_rate\x18\x13\x20\x01(\x01R\x07intRate\x12\x1b\n\trate\
    _flag\x18\x14\x20\x01(\tR\x08rateFlag\x12!\n\x0cproduct_code\x18\x15\x20\
    \x01(\tR\x0bproductCode\x12\x1f\n\x0bcustomer_id\x18\x16\x20\x01(\tR\ncu\
    stomerId\x12\x16\n\x06branch\x18\x17\x20\x01(\tR\x06branch\x12\x0e\n\x02\
    rm\x18\x18\x20\x01(\tR\x02rm\x12\x1e\n\ndepartment\x18\x19\x20\x01(\tR\n\
    department\x12\x0e\n\x02gl\x18\x1a\x20\x01(\tR\x02gl\x12#\n\rcustomer_na\
    me\x18\x1b\x20\x01(\tR\x0ccustomerName\x12&\n\x0fmonthly_avg_bal\x18\x1c\
    \x20\x01(\tR\rmonthlyAvgBal\x12\x12\n\x04aorl\x18\x1d\x20\x01(\tR\x04aor\
    l\x12\x10\n\x03rl1\x18\x1e\x20\x01(\x05R\x03rl1\x12\x10\n\x03rl2\x18\x1f\
    \x20\x01(\x05R\x03rl2\x12\x10\n\x03rl3\x18\x20\x20\x01(\x05R\x03rl3\x122\
    \n\x15total_interest_amount\x18!\x20\x01(\x01R\x13totalInterestAmount\
    \x124\n\x16total_principal_amount\x18\"\x20\x01(\x01R\x14totalPrincipalA\
