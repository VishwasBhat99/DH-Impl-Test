...
impl CurrencyConverter {
    ...
    pub fn convert(&self, ccy: &str, data: &Data, is_consolidated: bool, logger: &Logger) -> Data {
        let target_currency;
        if is_consolidated {
        ...
        conv_data.values_multiplied_by(conversion_rate, is_consolidated);
