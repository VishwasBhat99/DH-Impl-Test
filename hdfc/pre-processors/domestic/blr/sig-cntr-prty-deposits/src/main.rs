...
fn main() {
    ...
    let app_name = "significant_counterparty_deposits";
    ...
    info!(
        diagnostics_log,
        "Start of processing data for significant counterparty deposits."
    );
    processing::process(&config_param, &log, &diagnostics_log);
    info!(
        diagnostics_log,
        "End of processing data for significant counterparty deposits."
    );
    ...
    info!(
        log,
        "Total duration taken for significant counterparty deposits: {:?}", total_duration
    );
    println!(
        "Total duration taken for significant counterparty deposits: {:?}",
        total_duration
    );
}
