...
//! Generated file from `cf-loans-ib.proto`
...
impl Account {
    ...
    pub fn get_store_rate(&self) -> i32 {
        self.store_rate
    }
    ...
    // Param is passed by value, moved
    pub fn set_store_rate(&mut self, v: i32) {
        self.store_rate = v;
    }
...
impl ::protobuf::Message for Account {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.store_rate != 0 {
            my_size += ::protobuf::rt::value_size(28, self.store_rate, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.store_rate != 0 {
            os.write_int32(28, self.store_rate)?;
        }
        if !self.cr_rating.is_empty() {
