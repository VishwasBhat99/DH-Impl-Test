...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "log_level: {}", self.is_nd());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let is_nd = matches
            .value_of("is_nd")
            .expect("Error getting `is_nd`.")
            .parse::<bool>()
            .expect("Cannot parse `is_nd` as bool.");
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Cashflow generator for Bonds FRA.")
        .arg(
            Arg::new("input_file")
                .long("input-file")
        ...
        .arg(
            Arg::new("entity")
                .long("entity")
                .value_name("Entity")
                .help("This field is used to process records for particular country.")
                .required(true)
        )
        .arg(
            Arg::new("log_file")
