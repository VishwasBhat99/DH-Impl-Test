...
pub struct ConfigurationParameters {
    ...
    rate_bucket_file_path: String,
    psl_map_file_path: String,
    rate_bucket_sheet_name: String,
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) -> () {
        ...
        info!(
            logger,
            "rate_bucket_sheet_name: {}",
            self.rate_bucket_sheet_name()
        );
        ...
        info!(
            logger,
            "rate_bucket_file_path: {}",
            self.rate_bucket_file_path()
        );
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let as_on_date = date_parser.parse(
            matches
                .value_of("as_on_date")
                .unwrap_or("this string will convert into date"),
        );
        ...
        let log_level = matches
            ...
            .to_string();
        let base_ccy = matches.value_of("base_ccy").unwrap().to_string();
        ...
        let rate_bucket_sheet_name = matches
            .value_of("rate_bucket_sheet_name")
            .unwrap()
            .to_string();
        let rate_bucket_file_path = matches
            .value_of("rate_bucket_file_path")
            .unwrap()
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn rate_bucket_file_path(&self) -> &str {
        return &self.rate_bucket_file_path;
    }
    pub fn rate_bucket_sheet_name(&self) -> &str {
        return &self.rate_bucket_sheet_name;
    }
}

fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This program generates output for Advance MIS Benchmark!")
        .version("1.5.5334")
        ...
        .arg(
            Arg::with_name("rate_bucket_sheet_name")
                .short("rate")
                .long("rate-bucket-sheet-name")
                .value_name("SHEET")
                .help("rate_bucket_sheet_name")
                .required(true),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("rate_bucket_file_path")
                .short("rt")
                .long("rate-bucket-file-path")
                .value_name("FILE")
                .help("Path to the Rate bucket map")
                .required(true),
        )
        .get_matches()
}
