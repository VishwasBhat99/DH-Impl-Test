...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.cntrct_usage.is_empty() {
            my_size += ::protobuf::rt::string_size(75, &self.cntrct_usage);
        }
        if !self.non_idx_flw_curr.is_empty() {
            my_size += ::protobuf::rt::string_size(76, &self.non_idx_flw_curr);
        }
        if self.non_idx_cf_amt != 0. {
            my_size += 10;
        }
        if self.indexation_dt != 0 {
            my_size += ::protobuf::rt::value_size(78, self.indexation_dt, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.cntrct_usage.is_empty() {
            os.write_string(75, &self.cntrct_usage)?;
        }
        if !self.non_idx_flw_curr.is_empty() {
            os.write_string(76, &self.non_idx_flw_curr)?;
        }
        if self.non_idx_cf_amt != 0. {
            os.write_double(77, self.non_idx_cf_amt)?;
        }
        if self.indexation_dt != 0 {
            os.write_int64(78, self.indexation_dt)?;
        }
        if self.tot_int_amt != 0. {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "non_idx_flw_curr",
                |m: &AccountWithCashflows| { &m.non_idx_flw_curr },
                |m: &mut AccountWithCashflows| { &mut m.non_idx_flw_curr },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "non_idx_cf_amt",
                |m: &AccountWithCashflows| { &m.non_idx_cf_amt },
                |m: &mut AccountWithCashflows| { &mut m.non_idx_cf_amt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "indexation_dt",
                |m: &AccountWithCashflows| { &m.indexation_dt },
                |m: &mut AccountWithCashflows| { &mut m.indexation_dt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "tot_int_amt",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\x8a\x16\n\x14AccountW\
    ...
    R\x05intRt\x12!\n\x0ccntrct_usage\x18K\x20\x01(\tR\x0bcntrctUsage\x12'\n\
    \x10non_idx_flw_curr\x18L\x20\x01(\tR\rnonIdxFlwCurr\x12#\n\x0enon_idx_c\
    f_amt\x18M\x20\x01(\x01R\x0bnonIdxCfAmt\x12#\n\rindexation_dt\x18N\x20\
    \x01(\x03R\x0cindexationDt\x12\x1e\n\x0btot_int_amt\x18O\x20\x01(\x01R\t\
    totIntAmt\x12\x20\n\x0ctot_prin_amt\x18P\x20\x01(\x01R\ntotPrinAmt\x12'\
    \n\tcashflows\x18Q\x20\x03(\x0b2\t.CashflowR\tcashflowsb\x06proto3\
";
