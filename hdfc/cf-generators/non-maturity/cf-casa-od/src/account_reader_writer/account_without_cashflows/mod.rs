...
impl ::protobuf::Message for OutputAccount {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.casa_acc_no)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.casa_prod_cd)?;
                },
                3 => {
                ...
                9 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cust_shrt_name)?;
                },
                10 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                25 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.int_index_name)?;
                },
                26 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.acc_br_cd != 0 {
            my_size += ::protobuf::rt::value_size(3, self.acc_br_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.branch_cd != 0 {
            my_size += ::protobuf::rt::value_size(4, self.branch_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.book_bal != 0. {
            my_size += 9;
        }
        if self.flex_cube_cust_id != 0 {
            my_size += ::protobuf::rt::value_size(6, self.flex_cube_cust_id, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.tot_od_limit != 0. {
            my_size += 9;
        }
        if self.acc_open_dt != 0 {
            my_size += ::protobuf::rt::value_size(8, self.acc_open_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.cust_shrt_name.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.cust_shrt_name);
        }
        if self.cust_id != 0 {
            my_size += ::protobuf::rt::value_size(10, self.cust_id, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.cbr_num_1 != 0 {
            my_size += ::protobuf::rt::value_size(11, self.cbr_num_1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.cbr_num_2 != 0 {
            my_size += ::protobuf::rt::value_size(12, self.cbr_num_2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.cbr_num_3 != 0 {
            my_size += ::protobuf::rt::value_size(13, self.cbr_num_3, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.cr_rt != 0. {
            my_size += 9;
        }
...
impl ::protobuf::Clear for OutputAccount {
    fn clear(&mut self) {
        self.clear_casa_acc_no();
        self.clear_casa_prod_cd();
        self.clear_acc_br_cd();
        self.clear_branch_cd();
        self.clear_book_bal();
        self.clear_flex_cube_cust_id();
        self.clear_tot_od_limit();
        self.clear_acc_open_dt();
        self.clear_cust_shrt_name();
        self.clear_cust_id();
        self.clear_cbr_num_1();
        self.clear_cbr_num_2();
        self.clear_cbr_num_3();
        self.clear_cr_rt();
        self.clear_dr_rt();
        ...
        self.clear_rt_flg();
        self.clear_inst();
        self.clear_crnt_book_bal();
        self.clear_div();
        self.clear_alm_line();
        self.clear_ia_llg();
        self.clear_balm_llg();
        self.clear_int_index_name();
        self.clear_npa_flg();
        self.clear_int_rt();
        self.clear_country();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    t\x12\x18\n\x07country\x18\x1c\x20\x01(\tR\x07countryb\x06proto3\
";
