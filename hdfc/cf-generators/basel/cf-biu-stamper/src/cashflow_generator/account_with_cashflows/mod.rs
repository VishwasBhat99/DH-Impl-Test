...
impl ::protobuf::Message for Account {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                11 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.is_nwd)?;
                },
                12 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.is_nwd_final)?;
                },
                13 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                19 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.text_desc)?;
                },
                20 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.text_desc_flag)?;
                },
                21 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.res_days != 0 {
            my_size += ::protobuf::rt::value_size(10, self.res_days, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.bkt_id != 0 {
            my_size += ::protobuf::rt::value_size(13, self.bkt_id, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.t1.is_empty() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "t1",
                |m: &Account| { &m.t1 },
                |m: &mut Account| { &mut m.t1 },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "t2",
                |m: &Account| { &m.t2 },
                |m: &mut Account| { &mut m.t2 },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "t3",
                |m: &Account| { &m.t3 },
                |m: &mut Account| { &mut m.t3 },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "t4",
                |m: &Account| { &m.t4 },
                |m: &mut Account| { &mut m.t4 },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "total_deposits",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x12non-maturity.proto\"\xc3\x04\n\x07Account\x12\x15\n\x06acc_no\x18\
    \x01\x20\x01(\tR\x05accNo\x12\x17\n\x07cust_id\x18\x02\x20\x01(\tR\x06cu\
    stId\x12\x1b\n\tprod_code\x18\x03\x20\x01(\tR\x08prodCode\x12\x1a\n\x08c\
    urrency\x18\x04\x20\x01(\tR\x08currency\x12\x10\n\x03mis\x18\x05\x20\x01\
    (\tR\x03mis\x12\x19\n\x08mat_date\x18\x06\x20\x01(\x03R\x07matDate\x12\
    \x16\n\x06amount\x18\x07\x20\x01(\x01R\x06amount\x12\x1d\n\nlcy_amount\
    \x18\x08\x20\x01(\x01R\tlcyAmount\x12\x1b\n\tcust_type\x18\t\x20\x01(\tR\
    \x08custType\x12\x19\n\x08res_days\x18\n\x20\x01(\x03R\x07resDays\x12\
    \x15\n\x06is_nwd\x18\x0b\x20\x01(\tR\x05isNwd\x12\x20\n\x0cis_nwd_final\
    \x18\x0c\x20\x01(\tR\nisNwdFinal\x12\x15\n\x06bkt_id\x18\r\x20\x01(\x03R\
    \x05bktId\x12\x0e\n\x02t1\x18\x0e\x20\x01(\tR\x02t1\x12\x0e\n\x02t2\x18\
    \x0f\x20\x01(\tR\x02t2\x12\x0e\n\x02t3\x18\x10\x20\x01(\tR\x02t3\x12\x0e\
    \n\x02t4\x18\x11\x20\x01(\tR\x02t4\x12%\n\x0etotal_deposits\x18\x12\x20\
    \x01(\x01R\rtotalDeposits\x12\x1b\n\ttext_desc\x18\x13\x20\x01(\tR\x08te\
    xtDesc\x12$\n\x0etext_desc_flag\x18\x14\x20\x01(\tR\x0ctextDescFlag\x12\
    \x10\n\x03nob\x18\x15\x20\x01(\tR\x03nob\x12\x10\n\x03div\x18\x16\x20\
    \x01(\tR\x03div\x12\x15\n\x06int_rt\x18\x17\x20\x01(\x01R\x05intRtb\x06p\
    roto3\
";
