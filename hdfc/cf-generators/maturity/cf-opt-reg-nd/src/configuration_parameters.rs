...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "req_field_file: {}", self.entity());
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Cashflow derivation for Option Register ND.")
        .arg(
            Arg::new("input_file")
                .long("input-file")
        ...
        .arg(
            Arg::new("req_field_file")
                .long("req-field-file")
                .value_name("req field file")
                .help("File having required fields.")
                .required(true)
        )
        .arg(
