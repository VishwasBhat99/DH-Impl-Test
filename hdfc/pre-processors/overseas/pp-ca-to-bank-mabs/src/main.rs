...
fn main() {
    ...
    let app_name = "pp-ca-to-bank-mabs";
    ...
    info!(
        log,
        "Total Duration taken by Overseas Deposits Pre-processor: {:?}", total_duration
    );
    println!(
        "Total Duration taken by Overseas Deposits Pre-processor: {:?}",
        total_duration
    );
}
