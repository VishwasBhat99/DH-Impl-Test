...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let master_sheet_name = matches
            ...
            .expect("Error getting `master_sheet_name` value.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app generates pre-processor output of stamp-mat-date for CSB")
        .version("1.0.4499")
        ...
        .arg(
            Arg::with_name("master_sheet_name")
                ...
                .help("Sheet Name of Master file if file is in excel file formate")
                .required(false)
        )
        .arg(
