...
//! Generated file from `new2.proto`
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.is_cf_overdue.is_empty() {
            my_size += ::protobuf::rt::string_size(45, &self.is_cf_overdue);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.is_cf_overdue.is_empty() {
            os.write_string(45, &self.is_cf_overdue)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \"\xe3\x0c\n\x14AccountWithCashflows\x12\x12\n\x04acid\x18\x01\x20\x01(\
    \tR\x04acid\x12\x18\n\x07foracid\x18\x02\x20\x01(\tR\x07foracid\x12\x15\
    \n\x06sol_id\x18\x03\x20\x01(\tR\x05solId\x12\"\n\racct_opn_date\x18\x04\
    \x20\x01(\x03R\x0bacctOpnDate\x12'\n\x10gl_sub_head_code\x18\x05\x20\x01\
    (\tR\rglSubHeadCode\x12\x1b\n\tschm_code\x18\x06\x20\x01(\tR\x08schmCode\
    \x12\x1b\n\tschm_type\x18\x07\x20\x01(\tR\x08schmType\x12&\n\x0facct_crn\
    cy_code\x18\x08\x20\x01(\tR\racctCrncyCode\x12\x20\n\x0crep_shdl_num\x18\
    \t\x20\x01(\x03R\nrepShdlNum\x12\"\n\rrep_shdl_date\x18\n\x20\x01(\x03R\
    \x0brepShdlDate\x12\x20\n\x0cdis_shdl_num\x18\x0b\x20\x01(\x03R\ndisShdl\
    Num\x12\"\n\rdis_shdl_date\x18\x0c\x20\x01(\x03R\x0bdisShdlDate\x12\x17\
    \n\x07dis_amt\x18\r\x20\x01(\x01R\x06disAmt\x12\x1e\n\x0bclr_bal_amt\x18\
    \x0e\x20\x01(\x01R\tclrBalAmt\x12\x1b\n\tsanct_lim\x18\x0f\x20\x01(\x01R\
    \x08sanctLim\x123\n\x15rephasement_principal\x18\x10\x20\x01(\x01R\x14re\
    phasementPrincipal\x12'\n\x10ei_perd_end_date\x18\x11\x20\x01(\x03R\reiP\
    erdEndDate\x12\x17\n\x07cust_id\x18\x12\x20\x01(\tR\x06custId\x12\x1b\n\
    \tcust_name\x18\x13\x20\x01(\tR\x08custName\x12\x1e\n\x0bei_schm_flg\x18\
    \x14\x20\x01(\tR\teiSchmFlg\x12\x1b\n\tint_basis\x18\x15\x20\x01(\tR\x08\
    intBasis\x12$\n\x0eei_formula_flg\x18\x16\x20\x01(\tR\x0ceiFormulaFlg\
    \x12&\n\x0fei_intcalc_freq\x18\x17\x20\x01(\tR\reiIntcalcFreq\x12\x1b\n\
    \tei_method\x18\x18\x20\x01(\tR\x08eiMethod\x12\x19\n\x08int_rate\x18\
    \x19\x20\x01(\x01R\x07intRate\x12\x19\n\x08int_type\x18\x1a\x20\x01(\tR\
    \x07intType\x12.\n\x13next_repricing_date\x18\x1b\x20\x01(\x03R\x11nextR\
    epricingDate\x12.\n\x13last_repricing_date\x18\x1c\x20\x01(\x03R\x11last\
    RepricingDate\x12%\n\x0erepricing_freq\x18\x1d\x20\x01(\tR\rrepricingFre\
    q\x120\n\x14float_rate_benchmark\x18\x1e\x20\x01(\tR\x12floatRateBenchma\
    rk\x12\x16\n\x06spread\x18\x1f\x20\x01(\x01R\x06spread\x12\x17\n\x07npa_\
    flg\x18\x20\x20\x01(\tR\x06npaFlg\x12-\n\x12npa_classification\x18!\x20\
    \x01(\tR\x11npaClassification\x12\x17\n\x07npa_amt\x18\"\x20\x01(\x01R\
    \x06npaAmt\x12&\n\x0fcust_country_id\x18#\x20\x01(\tR\rcustCountryId\x12\
    ,\n\x12cust_credit_rating\x18$\x20\x01(\tR\x10custCreditRating\x12$\n\
    \x0ecust_sector_cd\x18%\x20\x01(\tR\x0ccustSectorCd\x12(\n\x10cust_indus\
    try_cd\x18&\x20\x01(\tR\x0ecustIndustryCd\x12\x1e\n\nexchangert\x18'\x20\
    \x01(\x01R\nexchangert\x12:\n\x19contractual_maturity_days\x18(\x20\x01(\
    \x03R\x17contractualMaturityDays\x124\n\x16residual_maturity_days\x18)\
    \x20\x01(\x03R\x14residualMaturityDays\x12\x18\n\x07custom1\x18*\x20\x01\
    (\tR\x07custom1\x12\x18\n\x07custom2\x18+\x20\x01(\tR\x07custom2\x12\x18\
    \n\x07custom3\x18,\x20\x01(\tR\x07custom3\x12\"\n\ris_cf_overdue\x18-\
    \x20\x01(\tR\x0bisCfOverdue\x12'\n\tcashflows\x18.\x20\x03(\x0b2\t.Cashf\
    lowR\tcashflowsb\x06proto3\
";
