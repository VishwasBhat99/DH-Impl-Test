...
#[derive(Debug)]
pub struct AggRulesAdj {
    ord_rules: Vec<Rule>,
}

impl AggRulesAdj {
    pub fn new_from_path(path: &str, reader: &Reader) -> AggRulesAdj {
        AggRulesBuilder::new_from_path(path, reader)
    }
    ...
    pub fn llg_for_acc(
        ...
        result_count: i32,
    ) -> Vec<Option<RuleYieldDescriptor>> {
        let mut i: i32 = 0;
...
impl AggRulesBuilder {
    fn new_from_path(path: &str, reader: &Reader) -> AggRulesAdj {
