...
fn main() {
    let app_name = "super-aggregator-1.0.3603";
    ...
    let report = aggregator::aggregate_cashflows(&config_params, &log, &diagnostics_log);

    report.serialise_to_path(config_params.output_file_path());
}
