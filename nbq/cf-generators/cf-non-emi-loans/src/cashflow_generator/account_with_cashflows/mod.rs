...
//! Generated file from `hdfcltd_ind_loans.proto`
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.tot_prin_amt != 0. {
            os.write_double(63, self.tot_prin_amt)?;
        }
        if self.tot_int_amt != 0. {
            os.write_double(64, self.tot_int_amt)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17hdfcltd_ind_loans.proto\"R\n\x08Cashflow\x12\x17\n\x07int_amt\x18\
    \x01\x20\x01(\x01R\x06intAmt\x12\x19\n\x08prin_amt\x18\x02\x20\x01(\x01R\
    \x07prinAmt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xe6\x11\n\
    \x14AccountWithCashflows\x12\x15\n\x06acc_no\x18\x01\x20\x01(\tR\x05accN\
    o\x12#\n\rdisbursed_amt\x18\x02\x20\x01(\x01R\x0cdisbursedAmt\x12%\n\x0f\
    os_loan_bal_lcy\x18\x03\x20\x01(\x01R\x0cosLoanBalLcy\x12\x19\n\x08int_r\
    ate\x18\x04\x20\x01(\x01R\x07intRate\x12\x1e\n\x0bei_amt_crnt\x18\x05\
    \x20\x01(\x01R\teiAmtCrnt\x12\x19\n\x08int_type\x18\x06\x20\x01(\tR\x07i\
    ntType\x121\n\x16os_p_bal_due_local_ccy\x18\x07\x20\x01(\x01R\x11osPBalD\
    ueLocalCcy\x121\n\x16os_i_bal_due_local_ccy\x18\x08\x20\x01(\x01R\x11osI\
    BalDueLocalCcy\x12,\n\x13ei_amt_paid_adv_lcy\x18\t\x20\x01(\x01R\x0feiAm\
    tPaidAdvLcy\x12#\n\x0epre_ei_bal_lcy\x18\n\x20\x01(\x01R\x0bpreEiBalLcy\
    \x12-\n\x13acc_open_value_date\x18\x0b\x20\x01(\x03R\x10accOpenValueDate\
    \x12#\n\rmaturity_date\x18\x0c\x20\x01(\x03R\x0cmaturityDate\x12+\n\x12e\
    i_start_date_crnt\x18\r\x20\x01(\x03R\x0feiStartDateCrnt\x12'\n\x10ei_en\
    d_date_crnt\x18\x0e\x20\x01(\x03R\reiEndDateCrnt\x12'\n\x10ei_pay_freq_c\
    rnt\x18\x0f\x20\x01(\tR\reiPayFreqCrnt\x124\n\x17emi_last_paid_date_crnt\
    ...
    ue_type\x18>\x20\x01(\tR\x0boverdueType\x12\x20\n\x0ctot_prin_amt\x18?\
    \x20\x01(\x01R\ntotPrinAmt\x12\x1e\n\x0btot_int_amt\x18@\x20\x01(\x01R\t\
    totIntAmt\x12'\n\tcashflows\x18A\x20\x03(\x0b2\t.CashflowR\tcashflowsb\
    \x06proto3\
";
