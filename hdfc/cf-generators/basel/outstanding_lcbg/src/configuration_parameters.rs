...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "slab_file_path: {}", self.input_file_path());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let slab_file_path = matches
            .value_of("slab_file_path")
            .expect("Error getting `slab_file_path`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn slab_file_path(&self) -> &str {
        &self.slab_file_path
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("slab_file_path")
                .long("slab-file-path")
                .value_name("SLAB FILE File")
                .help("Path to slab file.")
                .required(true)
        )
        .arg(
