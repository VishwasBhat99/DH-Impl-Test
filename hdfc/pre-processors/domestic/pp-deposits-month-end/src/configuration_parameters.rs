...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "r1_sheet_name: {}", self.r1_sheet_name());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let alm_master_sheet_name = matches
            ...
            .to_string();
        let r1_sheet_name = matches
            .value_of("r1_sheet_name")
            .expect("Error getting `r1_sheet_name` value.")
            .to_string();
    ...
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("ref_file_4")
                ...
                .help("Path to the reference file: Ora_GL_Master.xlsx.")
                .required(true)
        )
        .arg(
            Arg::with_name("ref_file_5")
                ...
                .help("Path to the reference file: MIS1_Desc.xlsx.")
                .required(true)
        )
        .arg(
        ...
        .arg(
            Arg::with_name("r1_sheet_name")
                .long("r1-sheet-name")
                .value_name("r1_sheet_name")
                .help("R1 File Sheet Name.")
