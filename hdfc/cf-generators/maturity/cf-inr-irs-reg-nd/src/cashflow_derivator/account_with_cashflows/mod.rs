...
//! Generated file from `inr_irs_reg_nd.proto`
...
pub struct AccountWithCashflows {
    ...
    pub cont_usage: ::std::string::String,
    pub non_idx_fwcurcy: ::std::string::String,
...
impl AccountWithCashflows {
    ...
    // string cont_usage = 41;


    pub fn get_cont_usage(&self) -> &str {
        &self.cont_usage
    }
    pub fn clear_cont_usage(&mut self) {
        self.cont_usage.clear();
    }

    // Param is passed by value, moved
    pub fn set_cont_usage(&mut self, v: ::std::string::String) {
        self.cont_usage = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_cont_usage(&mut self) -> &mut ::std::string::String {
        &mut self.cont_usage
    }

    // Take field
    pub fn take_cont_usage(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.cont_usage, ::std::string::String::new())
    }

    // string non_idx_fwcurcy = 42;


    pub fn get_non_idx_fwcurcy(&self) -> &str {
        &self.non_idx_fwcurcy
    }
    pub fn clear_non_idx_fwcurcy(&mut self) {
        self.non_idx_fwcurcy.clear();
    }

    // Param is passed by value, moved
    pub fn set_non_idx_fwcurcy(&mut self, v: ::std::string::String) {
        self.non_idx_fwcurcy = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_non_idx_fwcurcy(&mut self) -> &mut ::std::string::String {
        &mut self.non_idx_fwcurcy
    }

    // Take field
    pub fn take_non_idx_fwcurcy(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.non_idx_fwcurcy, ::std::string::String::new())
    }

    // double non_idx_fwamt = 43;


    pub fn get_non_idx_fwamt(&self) -> f64 {
        self.non_idx_fwamt
    }
    pub fn clear_non_idx_fwamt(&mut self) {
        self.non_idx_fwamt = 0.;
    }

    // Param is passed by value, moved
    pub fn set_non_idx_fwamt(&mut self, v: f64) {
        self.non_idx_fwamt = v;
    }

    // int64 indxn_dt = 44;


    pub fn get_indxn_dt(&self) -> i64 {
        self.indxn_dt
    }
    pub fn clear_indxn_dt(&mut self) {
        self.indxn_dt = 0;
    }

    // Param is passed by value, moved
    pub fn set_indxn_dt(&mut self, v: i64) {
        self.indxn_dt = v;
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                41 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cont_usage)?;
                },
                42 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.non_idx_fwcurcy)?;
                },
                43 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.cont_usage.is_empty() {
            my_size += ::protobuf::rt::string_size(41, &self.cont_usage);
        }
        if !self.non_idx_fwcurcy.is_empty() {
            my_size += ::protobuf::rt::string_size(42, &self.non_idx_fwcurcy);
        }
        if self.non_idx_fwamt != 0. {
            my_size += 10;
        }
        if self.indxn_dt != 0 {
            my_size += ::protobuf::rt::value_size(44, self.indxn_dt, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.cont_usage.is_empty() {
            os.write_string(41, &self.cont_usage)?;
        }
        if !self.non_idx_fwcurcy.is_empty() {
            os.write_string(42, &self.non_idx_fwcurcy)?;
        }
        if self.non_idx_fwamt != 0. {
            os.write_double(43, self.non_idx_fwamt)?;
        }
        if self.indxn_dt != 0 {
            os.write_int64(44, self.indxn_dt)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "cont_usage",
                |m: &AccountWithCashflows| { &m.cont_usage },
                |m: &mut AccountWithCashflows| { &mut m.cont_usage },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "non_idx_fwcurcy",
                |m: &AccountWithCashflows| { &m.non_idx_fwcurcy },
                |m: &mut AccountWithCashflows| { &mut m.non_idx_fwcurcy },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "non_idx_fwamt",
                |m: &AccountWithCashflows| { &m.non_idx_fwamt },
                |m: &mut AccountWithCashflows| { &mut m.non_idx_fwamt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "indxn_dt",
                |m: &AccountWithCashflows| { &m.indxn_dt },
                |m: &mut AccountWithCashflows| { &mut m.indxn_dt },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\tR\x06entity\x12\x19\n\x08trade_id\x18\x02\x20\x01(\tR\x07\
    tradeId\x12\x1f\n\x0bcontract_id\x18\x03\x20\x01(\x01R\ncontractId\x12\
    \x16\n\x06folder\x18\x04\x20\x01(\tR\x06folder\x12'\n\x0ftrading_banking\
    \x18\x05\x20\x01(\tR\x0etradingBanking\x12#\n\rintrnl_extrnl\x18\x06\x20\
    \x01(\tR\x0cintrnlExtrnl\x12$\n\x0ecntr_prty_name\x18\x07\x20\x01(\tR\
    \x0ccntrPrtyName\x12\x19\n\x08trade_dt\x18\x08\x20\x01(\x03R\x07tradeDt\
    \x12\x13\n\x05st_dt\x18\t\x20\x01(\x03R\x04stDt\x12\x19\n\x08deal_ccy\
    \x18\n\x20\x01(\tR\x07dealCcy\x12!\n\x0corg_notional\x18\x0b\x20\x01(\
    \x01R\x0borgNotional\x12\x1c\n\npay_int_rt\x18\x0c\x20\x01(\x01R\x08payI\
    ntRt\x12\x1c\n\nrec_int_rt\x18\r\x20\x01(\x01R\x08recIntRt\x12\x1b\n\tex\
    chng_rt\x18\x0e\x20\x01(\x01R\x08exchngRt\x12\x20\n\x0cpay_reset_dt\x18\
    \x0f\x20\x01(\x03R\npayResetDt\x12\x20\n\x0crec_reset_dt\x18\x10\x20\x01\
    (\x03R\nrecResetDt\x12$\n\x0epay_payment_dt\x18\x11\x20\x01(\x03R\x0cpay\
    PaymentDt\x12$\n\x0erec_payment_dt\x18\x12\x20\x01(\x03R\x0crecPaymentDt\
    \x12(\n\x10pay_payment_freq\x18\x13\x20\x01(\tR\x0epayPaymentFreq\x12(\n\
    \x10rec_payment_freq\x18\x14\x20\x01(\tR\x0erecPaymentFreq\x12\x1d\n\nde\
    al_stats\x18\x15\x20\x01(\tR\tdealStats\x12\x15\n\x06inp_id\x18\x16\x20\
    \x01(\tR\x05inpId\x12\x1d\n\ntrade_bank\x18\x17\x20\x01(\tR\ttradeBank\
    \x12\x15\n\x06m_bank\x18\x18\x20\x01(\tR\x05mBank\x12\x19\n\x08flow_typ\
    \x18\x19\x20\x01(\tR\x07flowTyp\x12\x1b\n\tflow_typ1\x18\x1a\x20\x01(\tR\
    \x08flowTyp1\x12\x1b\n\tflow_typ2\x18\x1b\x20\x01(\tR\x08flowTyp2\x12\
    \x1b\n\tflow_typ3\x18\x1c\x20\x01(\tR\x08flowTyp3\x12\x1b\n\tflow_typ4\
    \x18\x1d\x20\x01(\tR\x08flowTyp4\x12\x19\n\x08flow_amt\x18\x1e\x20\x01(\
    \x01R\x07flowAmt\x12\x13\n\x05cf_dt\x18\x1f\x20\x01(\x03R\x04cfDt\x12\
    \x19\n\x08flow_ccy\x18\x20\x20\x01(\tR\x07flowCcy\x12\x15\n\x06hkd_rt\
    \x18!\x20\x01(\x01R\x05hkdRt\x12\x17\n\x07hkd_amt\x18\"\x20\x01(\x01R\
    \x06hkdAmt\x12\x1d\n\x0bm_h_rep_dt2\x18#\x20\x01(\x03R\x08mHRepDt2\x12\
    \x17\n\x07inr_amt\x18$\x20\x01(\x01R\x06inrAmt\x12\x15\n\x06inr_rt\x18%\
    \x20\x01(\x01R\x05inrRt\x12\x15\n\x06int_rt\x18&\x20\x01(\x01R\x05intRt\
    \x12\x1e\n\x0btot_int_amt\x18'\x20\x01(\x01R\ttotIntAmt\x12\x20\n\x0ctot\
    _prin_amt\x18(\x20\x01(\x01R\ntotPrinAmt\x12\x1d\n\ncont_usage\x18)\x20\
    \x01(\tR\tcontUsage\x12&\n\x0fnon_idx_fwcurcy\x18*\x20\x01(\tR\rnonIdxFw\
    curcy\x12\"\n\rnon_idx_fwamt\x18+\x20\x01(\x01R\x0bnonIdxFwamt\x12\x19\n\
    \x08indxn_dt\x18,\x20\x01(\x03R\x07indxnDt\x12'\n\tcashflows\x18-\x20\
