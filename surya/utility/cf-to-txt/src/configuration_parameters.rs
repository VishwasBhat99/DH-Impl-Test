...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "req_header: {}", self.req_header());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let req_header = matches
            .value_of("req_header")
            .expect("Error getting `req_header`.")
            .parse::<bool>()
            .expect("Cannot parse `req_header` as bool.");
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("req_header")
                .long("req-header")
                .value_name("Header In Output File")
                .help("Header In Output File.")
                .default_value("true")
                .required(true)
        )
        .arg(
