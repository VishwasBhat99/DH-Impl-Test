...
fn main() {
    ...
    info!(
        log,
        "Total Duration of Repo lending and borrowing Cashflow derivator: {:?}", total_duration
    );
    println!(
        "Total Duration of Repo lending and borrowing Cashflow derivator: {:?}",
        total_duration
    );
}
