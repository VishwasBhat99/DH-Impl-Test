...
#[derive(PartialEq,Clone,Default)]
pub struct OuputAccount {
    // message fields
    pub llg_id: ::std::string::String,
    pub currency: ::std::string::String,
    pub int_rate: f64,
    pub mabs_field: ::std::string::String,
...
impl OuputAccount {
    ...
    pub fn clear_mabs_field(&mut self) {
        self.mabs_field.clear();
    }

    // Param is passed by value, moved
    pub fn set_mabs_field(&mut self, v: ::std::string::String) {
        self.mabs_field = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_mabs_field(&mut self) -> &mut ::std::string::String {
        &mut self.mabs_field
    }

    // Take field
    pub fn take_mabs_field(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.mabs_field, ::std::string::String::new())
    }

    pub fn get_mabs_field(&self) -> &str {
        &self.mabs_field
    }
...
impl ::protobuf::Message for OuputAccount {
    fn is_initialized(&self) -> bool {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.mabs_field)?;
                },
                5 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.mabs_field.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.mabs_field);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.mabs_field.is_empty() {
            os.write_string(4, &self.mabs_field)?;
        }
        for v in &self.cashflows {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "llg_id",
                    |m: &OuputAccount| { &m.llg_id },
                    |m: &mut OuputAccount| { &mut m.llg_id },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "currency",
                    |m: &OuputAccount| { &m.currency },
                    |m: &mut OuputAccount| { &mut m.currency },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "int_rate",
                    |m: &OuputAccount| { &m.int_rate },
                    |m: &mut OuputAccount| { &mut m.int_rate },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "mabs_field",
                    |m: &OuputAccount| { &m.mabs_field },
                    |m: &mut OuputAccount| { &mut m.mabs_field },
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Cashflow>>(
                    "cashflows",
                    |m: &OuputAccount| { &m.cashflows },
                    |m: &mut OuputAccount| { &mut m.cashflows },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<OuputAccount>(
                    "OuputAccount",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static OuputAccount {
        static mut instance: ::protobuf::lazy::Lazy<OuputAccount> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const OuputAccount,
        };
        unsafe {
            instance.get(OuputAccount::new)
        }
    }
}

impl ::protobuf::Clear for OuputAccount {
    fn clear(&mut self) {
        self.clear_llg_id();
        self.clear_currency();
        self.clear_int_rate();
        self.clear_mabs_field();
        self.clear_cashflows();
        self.unknown_fields.clear();
    }
}

impl ::std::fmt::Debug for OuputAccount {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for OuputAccount {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04date\"\xa4\x01\n\x0cOuputAccount\x12\x15\n\x06llg_id\x18\x01\x20\x01\
    (\tR\x05llgId\x12\x1a\n\x08currency\x18\x02\x20\x01(\tR\x08currency\x12\
    \x19\n\x08int_rate\x18\x03\x20\x01(\x01R\x07intRate\x12\x1d\n\nmabs_fiel\
    d\x18\x04\x20\x01(\tR\tmabsField\x12'\n\tcashflows\x18\x05\x20\x03(\x0b2\
