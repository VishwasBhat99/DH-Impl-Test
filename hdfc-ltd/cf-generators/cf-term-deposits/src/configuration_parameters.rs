...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        let input_file_path = matches
            ...
            .to_string();
        let product_code_file_path = matches
            .value_of("product_code_file_path")
            .expect("Error getting `product_code_file_path`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn product_code_file_path(&self) -> &str {
        &self.product_code_file_path
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("product_code_file_path")
                .long("product-code-file-path")
                .value_name("Product Code File Path")
                .help("Path to the product code file path.")
                .required(true)
        )
        .arg(
