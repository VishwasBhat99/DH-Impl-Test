...
pub struct ConfigurationParameters {
    ...
    pub io_config_file_path: String,
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let log_level = matches
            ...
            .to_string();
        let io_config_file_path = matches
            .value_of("io_config_file")
            .expect("Error getting `io_config_file_path`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn io_config_file_path(&self) -> &str {
        &self.io_config_file_path
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    Command::new(app_name)
        .about("Input UCIC Mapping program")
        ...
        .arg(
            Arg::new("io_config_file")
                .long("io-config-file")
                .value_name("Config File Path")
                .help("Path to read Input Output Config File.")
                .required(true)
        )
        .arg(
