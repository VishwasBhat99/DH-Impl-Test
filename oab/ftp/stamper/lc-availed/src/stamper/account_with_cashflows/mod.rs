...
impl AccountWithCashflows {
    ...
    // double total_interest_amount = 9;
    ...
    // double total_principal_amount = 10;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.customer_type.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.customer_type);
        }
        ...
        if self.rl1 != 0 {
            my_size += ::protobuf::rt::value_size(12, self.rl1, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.customer_type.is_empty() {
            os.write_string(8, &self.customer_type)?;
        }
        if self.total_interest_amount != 0. {
            os.write_double(9, self.total_interest_amount)?;
        }
        if self.total_principal_amount != 0. {
            os.write_double(10, self.total_principal_amount)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xc5\x03\n\x14AccountW\
    ...
    \x12\x1d\n\nlcy_amount\x18\x07\x20\x01(\x01R\tlcyAmount\x12#\n\rcustomer\
    _type\x18\x08\x20\x01(\tR\x0ccustomerType\x122\n\x15total_interest_amoun\
    t\x18\t\x20\x01(\x01R\x13totalInterestAmount\x124\n\x16total_principal_a\
    mount\x18\n\x20\x01(\x01R\x14totalPrincipalAmount\x12'\n\tcashflows\x18\
    \x0b\x20\x03(\x0b2\t.CashflowR\tcashflows\x12\x10\n\x03rl1\x18\x0c\x20\
    \x01(\x05R\x03rl1b\x06proto3\
";
