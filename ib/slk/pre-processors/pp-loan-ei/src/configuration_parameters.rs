...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let repricing_master_file_path = matches
            .value_of("repricing_master_file_path")
            .expect("Error getting `repricing_master_file_path`")
            .to_string();
        let repricing_sheet_name = matches
            .value_of("repricing_sheet_name")
            .expect("Error getting `repricing_sheet_name`")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    Command::new(app_name)
        .about("Pre Processor for Loans EMI for SriLanka")
        ...
        .arg(
        Arg::new("repricing_master_file_path")
        .long("rep-master-file")
        .value_name("REP_FILE")
        .help("path for repricing master file")
        .required(true)
       )
   .arg(
