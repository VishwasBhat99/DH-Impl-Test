...
pub fn create_account_with_cashflows(
    ...
    out_acc.principal = if account.field_type == "P" {
    ...
    out_acc.interest = if account.field_type == "I" {
        tot_int_amt += account.cf_principal_amount;
        account.cf_principal_amount
    } else {
        DEFAULT_FLOAT
    };
    ...
    out_acc.starting_balance = account.starting_balance;
    out_acc.wpa = account.wpa;
    out_acc.tenor = account.tenor;
    out_acc.dbr = account.dbr;
    out_acc.value_dt = account.value_dt;
    out_acc.ltv = account.ltv;
    out_acc.collateral_type = out_acc.collateral_type;
    out_acc.loan_size = account.loan_size;
    out_acc.c2r_rating = account.c2r_rating;
    out_acc.collateral_value = account.collateral_value;
    out_acc.passthrough_1 = account.passthrough_1;
    out_acc.passthrough_2 = account.passthrough_2;
    out_acc.passthrough_3 = account.passthrough_3;
