...
pub struct AccountWithCashflows {
    ...
    pub pre_emi_ovd_amt: ::std::string::String,
    pub exc_pre_emi_amt: ::std::string::String,
    pub emi_ovd_amt: ::std::string::String,
    pub exc_emi_amt: ::std::string::String,
    ...
    pub ncd_type: ::std::string::String,
    pub holder_type: ::std::string::String,
...
impl AccountWithCashflows {
    ...
    // string pre_emi_ovd_amt = 37;


    pub fn get_pre_emi_ovd_amt(&self) -> &str {
        &self.pre_emi_ovd_amt
    }
    pub fn clear_pre_emi_ovd_amt(&mut self) {
        self.pre_emi_ovd_amt.clear();
    }

    // Param is passed by value, moved
    pub fn set_pre_emi_ovd_amt(&mut self, v: ::std::string::String) {
        self.pre_emi_ovd_amt = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pre_emi_ovd_amt(&mut self) -> &mut ::std::string::String {
        &mut self.pre_emi_ovd_amt
    }

    // Take field
    pub fn take_pre_emi_ovd_amt(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.pre_emi_ovd_amt, ::std::string::String::new())
    }

    // string exc_pre_emi_amt = 38;


    pub fn get_exc_pre_emi_amt(&self) -> &str {
        &self.exc_pre_emi_amt
    }
    pub fn clear_exc_pre_emi_amt(&mut self) {
        self.exc_pre_emi_amt.clear();
    }

    // Param is passed by value, moved
    pub fn set_exc_pre_emi_amt(&mut self, v: ::std::string::String) {
        self.exc_pre_emi_amt = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_exc_pre_emi_amt(&mut self) -> &mut ::std::string::String {
        &mut self.exc_pre_emi_amt
    }

    // Take field
    pub fn take_exc_pre_emi_amt(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.exc_pre_emi_amt, ::std::string::String::new())
    }

    // string emi_ovd_amt = 39;


    pub fn get_emi_ovd_amt(&self) -> &str {
        &self.emi_ovd_amt
    }
    pub fn clear_emi_ovd_amt(&mut self) {
        self.emi_ovd_amt.clear();
    }

    // Param is passed by value, moved
    pub fn set_emi_ovd_amt(&mut self, v: ::std::string::String) {
        self.emi_ovd_amt = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_emi_ovd_amt(&mut self) -> &mut ::std::string::String {
        &mut self.emi_ovd_amt
    }

    // Take field
    pub fn take_emi_ovd_amt(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.emi_ovd_amt, ::std::string::String::new())
    }

    // string exc_emi_amt = 40;


    pub fn get_exc_emi_amt(&self) -> &str {
        &self.exc_emi_amt
    }
    pub fn clear_exc_emi_amt(&mut self) {
        self.exc_emi_amt.clear();
    }

    // Param is passed by value, moved
    pub fn set_exc_emi_amt(&mut self, v: ::std::string::String) {
        self.exc_emi_amt = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_exc_emi_amt(&mut self) -> &mut ::std::string::String {
        &mut self.exc_emi_amt
    }

    // Take field
    pub fn take_exc_emi_amt(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.exc_emi_amt, ::std::string::String::new())
    }

    // int32 pre_emi_ovd_gl_cd = 41;


    pub fn get_pre_emi_ovd_gl_cd(&self) -> i32 {
        self.pre_emi_ovd_gl_cd
    }
    pub fn clear_pre_emi_ovd_gl_cd(&mut self) {
        self.pre_emi_ovd_gl_cd = 0;
    }

    // Param is passed by value, moved
    pub fn set_pre_emi_ovd_gl_cd(&mut self, v: i32) {
        self.pre_emi_ovd_gl_cd = v;
    }

    // int32 exc_pre_emi_gl_cd = 42;


    pub fn get_exc_pre_emi_gl_cd(&self) -> i32 {
        self.exc_pre_emi_gl_cd
    }
    pub fn clear_exc_pre_emi_gl_cd(&mut self) {
        self.exc_pre_emi_gl_cd = 0;
    }

    // Param is passed by value, moved
    pub fn set_exc_pre_emi_gl_cd(&mut self, v: i32) {
        self.exc_pre_emi_gl_cd = v;
    }

    // int32 emi_ovd_gl_cd = 43;


    pub fn get_emi_ovd_gl_cd(&self) -> i32 {
        self.emi_ovd_gl_cd
    }
    pub fn clear_emi_ovd_gl_cd(&mut self) {
        self.emi_ovd_gl_cd = 0;
    }

    // Param is passed by value, moved
    pub fn set_emi_ovd_gl_cd(&mut self, v: i32) {
        self.emi_ovd_gl_cd = v;
    }

    // int32 exc_emi_gl_cd = 44;


    pub fn get_exc_emi_gl_cd(&self) -> i32 {
        self.exc_emi_gl_cd
    }
    pub fn clear_exc_emi_gl_cd(&mut self) {
        self.exc_emi_gl_cd = 0;
    }

    // Param is passed by value, moved
    pub fn set_exc_emi_gl_cd(&mut self, v: i32) {
        self.exc_emi_gl_cd = v;
    }
    ...
    pub fn get_ncd_type(&self) -> &str {
        &self.ncd_type
    }
    pub fn clear_ncd_type(&mut self) {
        self.ncd_type.clear();
    }

    // Param is passed by value, moved
    pub fn set_ncd_type(&mut self, v: ::std::string::String) {
        self.ncd_type = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ncd_type(&mut self) -> &mut ::std::string::String {
        &mut self.ncd_type
    }

    // Take field
    pub fn take_ncd_type(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.ncd_type, ::std::string::String::new())
    }

    // string holder_type = 47;


    pub fn get_holder_type(&self) -> &str {
        &self.holder_type
    }
    pub fn clear_holder_type(&mut self) {
        self.holder_type.clear();
    }

    // Param is passed by value, moved
    pub fn set_holder_type(&mut self, v: ::std::string::String) {
        self.holder_type = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_holder_type(&mut self) -> &mut ::std::string::String {
        &mut self.holder_type
    }

    // Take field
    pub fn take_holder_type(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.holder_type, ::std::string::String::new())
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                37 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.pre_emi_ovd_amt)?;
                },
                38 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.exc_pre_emi_amt)?;
                },
                39 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.emi_ovd_amt)?;
                },
                40 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.exc_emi_amt)?;
                },
                41 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                44 => {
                    ...
                    let tmp = is.read_int32()?;
                    self.exc_emi_gl_cd = tmp;
                },
                45 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.security)?;
                },
                46 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.ncd_type)?;
                },
                47 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.holder_type)?;
                },
                48 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.pre_emi_ovd_amt.is_empty() {
            my_size += ::protobuf::rt::string_size(37, &self.pre_emi_ovd_amt);
        }
        if !self.exc_pre_emi_amt.is_empty() {
            my_size += ::protobuf::rt::string_size(38, &self.exc_pre_emi_amt);
        }
        if !self.emi_ovd_amt.is_empty() {
            my_size += ::protobuf::rt::string_size(39, &self.emi_ovd_amt);
        }
        if !self.exc_emi_amt.is_empty() {
            my_size += ::protobuf::rt::string_size(40, &self.exc_emi_amt);
        }
        if self.pre_emi_ovd_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(41, self.pre_emi_ovd_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.exc_pre_emi_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(42, self.exc_pre_emi_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.emi_ovd_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(43, self.emi_ovd_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.exc_emi_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(44, self.exc_emi_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.security.is_empty() {
            my_size += ::protobuf::rt::string_size(45, &self.security);
        }
        if !self.ncd_type.is_empty() {
            my_size += ::protobuf::rt::string_size(46, &self.ncd_type);
        }
        if !self.holder_type.is_empty() {
            my_size += ::protobuf::rt::string_size(47, &self.holder_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.pre_emi_ovd_amt.is_empty() {
            os.write_string(37, &self.pre_emi_ovd_amt)?;
        }
        if !self.exc_pre_emi_amt.is_empty() {
            os.write_string(38, &self.exc_pre_emi_amt)?;
        }
        if !self.emi_ovd_amt.is_empty() {
            os.write_string(39, &self.emi_ovd_amt)?;
        }
        if !self.exc_emi_amt.is_empty() {
            os.write_string(40, &self.exc_emi_amt)?;
        }
        if self.pre_emi_ovd_gl_cd != 0 {
            os.write_int32(41, self.pre_emi_ovd_gl_cd)?;
        }
        if self.exc_pre_emi_gl_cd != 0 {
            os.write_int32(42, self.exc_pre_emi_gl_cd)?;
        }
        if self.emi_ovd_gl_cd != 0 {
            os.write_int32(43, self.emi_ovd_gl_cd)?;
        }
        if self.exc_emi_gl_cd != 0 {
            os.write_int32(44, self.exc_emi_gl_cd)?;
        }
        if !self.security.is_empty() {
            os.write_string(45, &self.security)?;
        }
        if !self.ncd_type.is_empty() {
            os.write_string(46, &self.ncd_type)?;
        }
        if !self.holder_type.is_empty() {
            os.write_string(47, &self.holder_type)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "pre_emi_ovd_amt",
                |m: &AccountWithCashflows| { &m.pre_emi_ovd_amt },
                |m: &mut AccountWithCashflows| { &mut m.pre_emi_ovd_amt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "exc_pre_emi_amt",
                |m: &AccountWithCashflows| { &m.exc_pre_emi_amt },
                |m: &mut AccountWithCashflows| { &mut m.exc_pre_emi_amt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "emi_ovd_amt",
                |m: &AccountWithCashflows| { &m.emi_ovd_amt },
                |m: &mut AccountWithCashflows| { &mut m.emi_ovd_amt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "exc_emi_amt",
                |m: &AccountWithCashflows| { &m.exc_emi_amt },
                |m: &mut AccountWithCashflows| { &mut m.exc_emi_amt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "pre_emi_ovd_gl_cd",
                |m: &AccountWithCashflows| { &m.pre_emi_ovd_gl_cd },
                |m: &mut AccountWithCashflows| { &mut m.pre_emi_ovd_gl_cd },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "exc_pre_emi_gl_cd",
                |m: &AccountWithCashflows| { &m.exc_pre_emi_gl_cd },
                |m: &mut AccountWithCashflows| { &mut m.exc_pre_emi_gl_cd },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "emi_ovd_gl_cd",
                |m: &AccountWithCashflows| { &m.emi_ovd_gl_cd },
                |m: &mut AccountWithCashflows| { &mut m.emi_ovd_gl_cd },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "exc_emi_gl_cd",
                |m: &AccountWithCashflows| { &m.exc_emi_gl_cd },
                |m: &mut AccountWithCashflows| { &mut m.exc_emi_gl_cd },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "security",
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "ncd_type",
                |m: &AccountWithCashflows| { &m.ncd_type },
                |m: &mut AccountWithCashflows| { &mut m.ncd_type },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "holder_type",
                |m: &AccountWithCashflows| { &m.holder_type },
                |m: &mut AccountWithCashflows| { &mut m.holder_type },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Amt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xf6\x0b\n\x14Accou\
    ...
    \x12%\n\x0fpre_emi_ovd_amt\x18%\x20\x01(\tR\x0cpreEmiOvdAmt\x12%\n\x0fex\
    c_pre_emi_amt\x18&\x20\x01(\tR\x0cexcPreEmiAmt\x12\x1e\n\x0bemi_ovd_amt\
    \x18'\x20\x01(\tR\temiOvdAmt\x12\x1e\n\x0bexc_emi_amt\x18(\x20\x01(\tR\t\
    excEmiAmt\x12(\n\x11pre_emi_ovd_gl_cd\x18)\x20\x01(\x05R\rpreEmiOvdGlCd\
    \x12(\n\x11exc_pre_emi_gl_cd\x18*\x20\x01(\x05R\rexcPreEmiGlCd\x12!\n\re\
    mi_ovd_gl_cd\x18+\x20\x01(\x05R\nemiOvdGlCd\x12!\n\rexc_emi_gl_cd\x18,\
    \x20\x01(\x05R\nexcEmiGlCd\x12\x1a\n\x08security\x18-\x20\x01(\tR\x08sec\
    urity\x12\x19\n\x08ncd_type\x18.\x20\x01(\tR\x07ncdType\x12\x1f\n\x0bhol\
    der_type\x18/\x20\x01(\tR\nholderType\x12'\n\tcashflows\x180\x20\x03(\
