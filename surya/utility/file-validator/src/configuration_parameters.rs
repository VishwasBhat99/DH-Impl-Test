...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let config_sheet_name = matches
            ...
            .expect("Error getting `config_sheet_name`.")
            .to_string();
        ...
        let as_on_date = date_parser.parse(
            matches
                .value_of("as_on_date")
                .expect("Error getting as on date as DDMMYYYY."),
        );
...
impl ConfigurationParameters {
    ...
    pub fn as_on_date(&self) -> String {
        self.as_on_date.format("%d%m%Y").to_string()
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Validates if a file and the older dated file have same number of records.")
        .arg(
        ...
        .arg(
            Arg::with_name("config_sheet_name")
                ...
                .help("Sheet name of config xlsx file.")
