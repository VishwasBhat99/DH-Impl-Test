...
pub fn process(config_param: ConfigurationParameters, log: &Logger, diag_log: &Logger) {
    ...
    let header = "cust_no|reference|cust_name|branch_cd|norm_int_rt|acurl_freq|book_dt|val_dt|mat_dt|due_dt|user_def_stats|prod_cd|gl|curr|prin_ost_bal|componentamt_due|amt_setld|cf_amt|spread|compmis1|compmis2|compmis3|old_rt_cd|old_rt_typ|old_benchmark|nxt_reset_dt|last_reset_dt|rt_flag_new|rt_cd_new|division|concat|alm_line|ia_llg|balm_llg|repricing_freq|nxt_repricing_dt|lst_repricing_dt|as_on_dt|int_basis|int_calc_typ|cust_typ|npa_typ|bmid|cntr_party|lcy_amount|raw_benchmark\n";
