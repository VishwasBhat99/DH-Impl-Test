...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "input_cf_file: {}", self.input_cf_file());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        let input_master_file = matches
            ...
            .to_string();
        let input_cf_file = matches
            .value_of("input_cf_file")
            .expect("Error getting `input_cf_file`.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Pre Process Borrowings Program!!")
        .arg(
        ...
        .arg(
            Arg::with_name("input_cf_file")
                .long("input-cf-file")
                .value_name("Input CF File")
                .help("Input CF file path.")
                .required(true)
        )
        .arg(
