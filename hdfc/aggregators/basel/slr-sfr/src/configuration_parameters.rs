...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "NDTL amount column: {}", self.ndtl_amt_col());
        ...
        info!(logger, "ndtl_output_file: {}", self.ndtl_output_file_path());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let output_file_path = matches
            ...
            .to_string();
        let ndtl_output_file_path = matches
            .value_of("ndtl_output_file")
            .expect("Error getting `ndtl_output_file_path`.")
            .to_string();
        ...
        let ndtl_amt_col = matches
            .value_of("ndtl_amt_col")
            .expect("Error getting `ndtl_amt_col`.")
            .parse::<usize>()
            .expect("Invalid amount column id.");
...
impl ConfigurationParameters {
    ...
    pub fn ndtl_output_file_path(&self) -> &str {
        &self.ndtl_output_file_path
    }
    ...
    pub fn ndtl_amt_col(&self) -> usize {
        self.ndtl_amt_col
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("ndtl_amt_col")
                .long("ndtl-amt-col")
                .value_name("NDTL Amount Column")
                .help("NDTL Amount column of sfr sheet.")
                .required(true)
        )
        .arg(
        ...
        .arg(
            Arg::with_name("ndtl_output_file")
                .long("ndtl-output-file")
                .value_name("NDTL Output File")
                .help("Path to the ndtl output file.")
                .required(true)
        )
        .arg(
