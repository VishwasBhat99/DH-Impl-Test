...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "sign_factor: {}", self.sign_factor());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let sign_factor: i32 = matches
            .value_of("sign_factor")
            .expect("Error getting `sign_factor`.")
            .parse()
            .expect("Error parsing `sign_factor` as integer-i32.");
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("Program to generate CAP SCH report!!")
        .arg(
        ...
        .arg(
            Arg::with_name("sign_factor")
                .long("sign-factor")
                .value_name("Sign Factor")
                .help("Sign Factor.")
                .required(true)
        )
        .get_matches()
