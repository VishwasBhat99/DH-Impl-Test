...
pub fn create_account_without_cashflows(key: AggrKey, data: LCR, _log: &Logger) -> OutputAccount {
    ...
    out_acc.nwd_stable_b1 = data.nwd_stable_b1;
    out_acc.nwd_stable_b2 = data.nwd_stable_b2;
    out_acc.nwd_stable_b3 = data.nwd_stable_b3;
    out_acc.nwd_less_stable_b1 = data.nwd_less_stable_b1;
    out_acc.nwd_less_stable_b2 = data.nwd_less_stable_b2;
    out_acc.nwd_less_stable_b3 = data.nwd_less_stable_b3;
    out_acc.ca_wt_int_rate = data.ca_wt_int_rate;
    out_acc.sa_wt_int_rate = data.sa_wt_int_rate;
    out_acc.td_wd_wt_int_rate = data.td_wd_wt_int_rate;
    out_acc.td_nwd_wt_int_rate = data.td_nwd_wt_int_rate;
    out_acc.rd_wt_int_rate = data.rd_wt_int_rate;
    out_acc.lien_amt = data.lien_amt;
    out_acc.bal_before_lien = data.bal_before_lien;
    out_acc.bal_after_lien = data.bal_after_lien;
