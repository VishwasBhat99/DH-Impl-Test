...
pub struct AccountWithCashflows {
    ...
    pub contract_usage: ::std::string::String,
    pub non_index_flow_currency: ::std::string::String,
...
impl AccountWithCashflows {
    ...
    // string contract_usage = 81;

    pub fn clear_contract_usage(&mut self) {
        self.contract_usage.clear();
    }

    // Param is passed by value, moved
    pub fn set_contract_usage(&mut self, v: ::std::string::String) {
        self.contract_usage = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_contract_usage(&mut self) -> &mut ::std::string::String {
        &mut self.contract_usage
    }

    // Take field
    pub fn take_contract_usage(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.contract_usage, ::std::string::String::new())
    }

    pub fn get_contract_usage(&self) -> &str {
        &self.contract_usage
    }

    // string non_index_flow_currency = 82;

    pub fn clear_non_index_flow_currency(&mut self) {
        self.non_index_flow_currency.clear();
    }

    // Param is passed by value, moved
    pub fn set_non_index_flow_currency(&mut self, v: ::std::string::String) {
        self.non_index_flow_currency = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_non_index_flow_currency(&mut self) -> &mut ::std::string::String {
        &mut self.non_index_flow_currency
    }

    // Take field
    pub fn take_non_index_flow_currency(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.non_index_flow_currency, ::std::string::String::new())
    }

    pub fn get_non_index_flow_currency(&self) -> &str {
        &self.non_index_flow_currency
    }

    // double non_index_cf_amt = 83;

    pub fn clear_non_index_cf_amt(&mut self) {
        self.non_index_cf_amt = 0.;
    }

    // Param is passed by value, moved
    pub fn set_non_index_cf_amt(&mut self, v: f64) {
        self.non_index_cf_amt = v;
    }

    pub fn get_non_index_cf_amt(&self) -> f64 {
        self.non_index_cf_amt
    }

    // int64 indexation_dt = 84;
    ...
    // repeated .Cashflow cashflows = 85;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                81 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.contract_usage)?;
                },
                82 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.non_index_flow_currency)?;
                },
                83 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.contract_usage.is_empty() {
            my_size += ::protobuf::rt::string_size(81, &self.contract_usage);
        }
        if !self.non_index_flow_currency.is_empty() {
            my_size += ::protobuf::rt::string_size(82, &self.non_index_flow_currency);
        }
        if self.non_index_cf_amt != 0. {
            my_size += 10;
        }
        if self.indexation_dt != 0 {
            my_size += ::protobuf::rt::value_size(84, self.indexation_dt, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.contract_usage.is_empty() {
            os.write_string(81, &self.contract_usage)?;
        }
        if !self.non_index_flow_currency.is_empty() {
            os.write_string(82, &self.non_index_flow_currency)?;
        }
        if self.non_index_cf_amt != 0. {
            os.write_double(83, self.non_index_cf_amt)?;
        }
        if self.indexation_dt != 0 {
            os.write_int64(84, self.indexation_dt)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "contract_usage",
                    |m: &AccountWithCashflows| { &m.contract_usage },
                    |m: &mut AccountWithCashflows| { &mut m.contract_usage },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "non_index_flow_currency",
                    |m: &AccountWithCashflows| { &m.non_index_flow_currency },
                    |m: &mut AccountWithCashflows| { &mut m.non_index_flow_currency },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "non_index_cf_amt",
                    |m: &AccountWithCashflows| { &m.non_index_cf_amt },
                    |m: &mut AccountWithCashflows| { &mut m.non_index_cf_amt },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "indexation_dt",
...
impl ::protobuf::Clear for AccountWithCashflows {
    fn clear(&mut self) {
        ...
        self.clear_contract_usage();
        self.clear_non_index_flow_currency();
        self.clear_non_index_cf_amt();
        self.clear_indexation_dt();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fproto/mod.proto\"R\n\x08Cashflow\x12\x17\n\x07int_amt\x18\x01\x20\
    \x01(\x01R\x06intAmt\x12\x19\n\x08prin_amt\x18\x02\x20\x01(\x01R\x07prin\
    Amt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\x91\x19\n\x14Accou\
    ntWithCashflows\x12\x16\n\x06entity\x18\x01\x20\x01(\tR\x06entity\x12\
    \x19\n\x08trade_id\x18\x02\x20\x01(\tR\x07tradeId\x12\x1f\n\x0bcontract_\
    id\x18\x03\x20\x01(\x03R\ncontractId\x12)\n\x11struct_id_link_id\x18\x04\
    \x20\x01(\x03R\x0estructIdLinkId\x12#\n\rcomp_typology\x18\x05\x20\x01(\
    \tR\x0ccompTypology\x12!\n\x0cpkg_typology\x18\x06\x20\x01(\tR\x0bpkgTyp\
    ology\x12'\n\x0fcntrct_typology\x18\x07\x20\x01(\tR\x0ecntrctTypology\
    \x12\x12\n\x04desk\x18\x08\x20\x01(\tR\x04desk\x12\x12\n\x04book\x18\t\
    \x20\x01(\tR\x04book\x12\x16\n\x06folder\x18\n\x20\x01(\tR\x06folder\x12\
    '\n\x0ftrading_banking\x18\x0b\x20\x01(\tR\x0etradingBanking\x12'\n\x10c\
    ntr_prty_grp_cd\x18\x0c\x20\x01(\tR\rcntrPrtyGrpCd\x12)\n\x11cntr_prty_c\
    hld_cd\x18\r\x20\x01(\tR\x0ecntrPrtyChldCd\x12$\n\x0ecntr_prty_name\x18\
    \x0e\x20\x01(\tR\x0ccntrPrtyName\x12#\n\rintrnl_extrnl\x18\x0f\x20\x01(\
    \tR\x0cintrnlExtrnl\x12\x19\n\x08trade_dt\x18\x10\x20\x01(\x03R\x07trade\
    Dt\x12\x13\n\x05st_dt\x18\x11\x20\x01(\x03R\x04stDt\x12\x13\n\x05ed_dt\
    \x18\x12\x20\x01(\x03R\x04edDt\x12\x19\n\x08ccy_pair\x18\x13\x20\x01(\tR\
    \x07ccyPair\x12\x1e\n\x0brec_leg_ccy\x18\x14\x20\x01(\tR\trecLegCcy\x12/\
    \n\x14org_notional_rec_leg\x18\x15\x20\x01(\x01R\x11orgNotionalRecLeg\
    \x126\n\x18org_notional_rec_leg_inr\x18\x16\x20\x01(\x01R\x14orgNotional\
    RecLegInr\x12/\n\x14ost_notional_rec_leg\x18\x17\x20\x01(\x01R\x11ostNot\
    ionalRecLeg\x126\n\x18ost_notional_rec_leg_inr\x18\x18\x20\x01(\x01R\x14\
    ostNotionalRecLegInr\x12\x1e\n\x0bpay_leg_ccy\x18\x19\x20\x01(\tR\tpayLe\
    gCcy\x12/\n\x14org_notional_pay_leg\x18\x1a\x20\x01(\x01R\x11orgNotional\
    PayLeg\x126\n\x18org_notional_pay_leg_inr\x18\x1b\x20\x01(\x01R\x14orgNo\
    tionalPayLegInr\x12/\n\x14ost_notional_pay_leg\x18\x1c\x20\x01(\x01R\x11\
    ostNotionalPayLeg\x126\n\x18ost_notional_pay_leg_inr\x18\x1d\x20\x01(\
    \x01R\x14ostNotionalPayLegInr\x12\x1b\n\tdeal_side\x18\x1e\x20\x01(\tR\
    \x08dealSide\x12\x1e\n\x0bpay_leg_idx\x18\x1f\x20\x01(\tR\tpayLegIdx\x12\
    \x1c\n\npay_int_rt\x18\x20\x20\x01(\x01R\x08payIntRt\x12$\n\x0espread_pa\
    y_leg\x18!\x20\x01(\x01R\x0cspreadPayLeg\x12\x1e\n\x0brec_leg_idx\x18\"\
    \x20\x01(\tR\trecLegIdx\x12\x1c\n\nrec_int_rt\x18#\x20\x01(\x01R\x08recI\
    ntRt\x12$\n\x0espread_rec_leg\x18$\x20\x01(\x01R\x0cspreadRecLeg\x12)\n\
    \x11rec_side_acrl_inr\x18%\x20\x01(\x01R\x0erecSideAcrlInr\x12'\n\x10rec\
    _side_mtm_inr\x18&\x20\x01(\x01R\rrecSideMtmInr\x127\n\x18future_cash_pr\
    oceeds_ccy\x18'\x20\x01(\tR\x15futureCashProceedsCcy\x127\n\x18future_ca\
    sh_proceeds_inr\x18(\x20\x01(\x01R\x15futureCashProceedsInr\x12*\n\x11mr\
    kt_val_financed\x18)\x20\x01(\x01R\x0fmrktValFinanced\x12\x1e\n\x0bnet_m\
    tm_usd\x18*\x20\x01(\x01R\tnetMtmUsd\x12\x1e\n\x0bnet_mtm_inr\x18+\x20\
    \x01(\x01R\tnetMtmInr\x12)\n\x11pay_side_pv01_inr\x18,\x20\x01(\x01R\x0e\
    paySidePv01Inr\x12)\n\x11rec_side_pv01_inr\x18-\x20\x01(\x01R\x0erecSide\
    Pv01Inr\x12\x20\n\x0cnet_pv01_inr\x18.\x20\x01(\x01R\nnetPv01Inr\x12;\n\
    \x1apay_side_modified_duration\x18/\x20\x01(\x01R\x17paySideModifiedDura\
    tion\x12C\n\x1ereceive_side_modified_duration\x180\x20\x01(\x01R\x1brece\
    iveSideModifiedDuration\x124\n\x16modified_duration_deal\x181\x20\x01(\
    \x01R\x14modifiedDurationDeal\x12-\n\x13pay_leg_exchange_rt\x182\x20\x01\
    (\x01R\x10payLegExchangeRt\x12-\n\x13rec_leg_exchange_rt\x183\x20\x01(\
    \x01R\x10recLegExchangeRt\x12\x20\n\x0cpay_reset_dt\x184\x20\x01(\x03R\n\
    payResetDt\x12\x20\n\x0crec_reset_dt\x185\x20\x01(\x03R\nrecResetDt\x12$\
    \n\x0epay_payment_dt\x186\x20\x01(\x03R\x0cpayPaymentDt\x12$\n\x0erec_pa\
    yment_dt\x187\x20\x01(\x03R\x0crecPaymentDt\x12\"\n\rindex_rec_leg\x188\
    ...
    _usage\x18Q\x20\x01(\tR\rcontractUsage\x125\n\x17non_index_flow_currency\
    \x18R\x20\x01(\tR\x14nonIndexFlowCurrency\x12'\n\x10non_index_cf_amt\x18\
    S\x20\x01(\x01R\rnonIndexCfAmt\x12#\n\rindexation_dt\x18T\x20\x01(\x03R\
    \x0cindexationDt\x12'\n\tcashflows\x18U\x20\x03(\x0b2\t.CashflowR\tcashf\
    lowsb\x06proto3\
";
