...
impl OutputAccount {
    ...
    pub fn set_gl_item(&mut self, v: ::std::string::String) {
        self.gl_item = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_gl_item(&mut self) -> &mut ::std::string::String {
        &mut self.gl_item
    }

    // Take field
    pub fn take_gl_item(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.gl_item, ::std::string::String::new())
    }

    pub fn get_gl_item(&self) -> &str {
        &self.gl_item
    }
...
impl ::protobuf::Message for OutputAccount {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.gl_item)?;
                },
                2 => {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if !self.gl_item.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.gl_item);
        }
        if self.branch != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if !self.gl_item.is_empty() {
            os.write_string(1, &self.gl_item)?;
        }
        if self.branch != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19proto/cf_gl_balance.proto\"\xcd\x01\n\rOutputAccount\x12\x17\n\x07\
    gl_item\x18\x01\x20\x01(\tR\x06glItem\x12\x16\n\x06branch\x18\x02\x20\
    \x01(\x03R\x06branch\x12\x14\n\x05basic\x18\x03\x20\x01(\x03R\x05basic\
    \x12\x16\n\x06suffix\x18\x04\x20\x01(\x03R\x06suffix\x12\x1a\n\x08curren\
    cy\x18\x05\x20\x01(\tR\x08currency\x12\x1b\n\tcf_amount\x18\x06\x20\x01(\
    \x01R\x08cfAmount\x12$\n\x0ebalance_in_omr\x18\x07\x20\x01(\x01R\x0cbala\
    nceInOmrb\x06proto3\
";
