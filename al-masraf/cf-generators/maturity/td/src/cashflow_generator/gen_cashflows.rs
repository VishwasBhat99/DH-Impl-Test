...
pub fn generate_cashflows(
    ...
    if account.int_compounding_frequency > 0
        && account.int_compounding_frequency < account.int_repayment_frequency
    {
...
fn generate_compounding_interest_cfs(
    ...
    let compound_interest_advance_by_months = a.int_compounding_frequency as usize;
    let pay_cf_advance_by_months = a.int_repayment_frequency;
    let i_r = a.int_rate;
    ...
    let mut last_pay_date = get_last_pay_date(start_date, as_on_date, a.int_repayment_frequency);
    for cashflow_date in cf_date_iterator {
    ...
    cashflows
        ...
        .principal_amount = a.outstanding_bal;
...
fn generate_bullet_cf(a: &InputAccount, convention: &Conventions) -> Cashflow {
    ...
    if a.int_compounding_frequency <= 0 {
