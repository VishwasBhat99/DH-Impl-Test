...
fn main() {
    ...
    let app_name = "et_borr_hmm3025_pp";
    ...
    info!(
        log,
        "Total Duration taken by Etreasury borrowings HMM3025 Preprocessor: {:?}", total_duration
    );
    println!(
        "Total Duration taken by Etreasury borrowings HMM3025 Preprocessor: {:?}",
        total_duration
    );
}
