...
impl AccountWithCashflows {
    ...
    // double total_interest_amount = 46;
    ...
    // double total_principal_amount = 47;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.rl1 != 0 {
            my_size +=
                ::protobuf::rt::value_size(43, self.rl1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.rl2 != 0 {
            my_size +=
                ::protobuf::rt::value_size(44, self.rl2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.rl3 != 0 {
            my_size +=
                ::protobuf::rt::value_size(45, self.rl3, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(
        ...
        if self.total_interest_amount != 0. {
            os.write_double(46, self.total_interest_amount)?;
        }
        if self.total_principal_amount != 0. {
            os.write_double(47, self.total_principal_amount)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xc5\r\n\x14AccountWit\
    hCashflows\x12\x1d\n\naccount_id\x18\x01\x20\x01(\tR\taccountId\x12\x1a\
    \n\x08currency\x18\x02\x20\x01(\tR\x08currency\x12\x19\n\x08int_rate\x18\
    \x03\x20\x01(\x01R\x07intRate\x12'\n\x0foutstanding_bal\x18\x04\x20\x01(\
    \x01R\x0eoutstandingBal\x12\x0e\n\x02gl\x18\x05\x20\x01(\tR\x02gl\x12\
    \x1d\n\nstart_date\x18\x06\x20\x01(\x03R\tstartDate\x12#\n\rmaturity_dat\
    e\x18\x07\x20\x01(\x03R\x0cmaturityDate\x12\x1b\n\trate_flag\x18\x08\x20\
    \x01(\tR\x08rateFlag\x12\x16\n\x06branch\x18\t\x20\x01(\tR\x06branch\x12\
    \x1f\n\x0bcustomer_id\x18\n\x20\x01(\tR\ncustomerId\x12#\n\rcustomer_typ\
    e\x18\x0b\x20\x01(\tR\x0ccustomerType\x12!\n\x0cproduct_code\x18\x0c\x20\
    \x01(\tR\x0bproductCode\x12\x14\n\x05group\x18\r\x20\x01(\tR\x05group\
    \x12\x1d\n\nacc_branch\x18\x0e\x20\x01(\tR\taccBranch\x12\x1d\n\nacc_num\
    ber\x18\x0f\x20\x01(\tR\taccNumber\x12\x1d\n\nacc_suffix\x18\x10\x20\x01\
    (\tR\taccSuffix\x12\x19\n\x08acc_type\x18\x11\x20\x01(\tR\x07accType\x12\
    \x1b\n\tdeal_type\x18\x12\x20\x01(\tR\x08dealType\x12/\n\x13repricing_fr\
    equency\x18\x13\x20\x01(\tR\x12repricingFrequency\x12$\n\x0elast_repr_da\
    te\x18\x14\x20\x01(\x03R\x0clastReprDate\x12$\n\x0enext_repr_date\x18\
    \x15\x20\x01(\x03R\x0cnextReprDate\x12:\n\x19int_compounding_frequency\
    \x18\x16\x20\x01(\x03R\x17intCompoundingFrequency\x126\n\x17int_repaymen\
    t_frequency\x18\x17\x20\x01(\x03R\x15intRepaymentFrequency\x12\x1f\n\x0b\
    margin_rate\x18\x18\x20\x01(\tR\nmarginRate\x12\x12\n\x04cpas\x18\x19\
    \x20\x01(\tR\x04cpas\x124\n\x16cust_constitution_code\x18\x1a\x20\x01(\t\
    R\x14custConstitutionCode\x12'\n\x0fcustomer_rating\x18\x1b\x20\x01(\tR\
    \x0ecustomerRating\x12\x0e\n\x02p2\x18\x1c\x20\x01(\tR\x02p2\x12#\n\rana\
    lysis_code\x18\x1d\x20\x01(\tR\x0canalysisCode\x120\n\x14sundry_analysis\
    _code\x18\x1e\x20\x01(\tR\x12sundryAnalysisCode\x122\n\x15numeric_analys\
    is_code\x18\x1f\x20\x01(\tR\x13numericAnalysisCode\x12$\n\x0ebase_rate_c\
    ode\x18\x20\x20\x01(\tR\x0cbaseRateCode\x124\n\x16differential_rate_code\
    \x18!\x20\x01(\tR\x14differentialRateCode\x12&\n\x0faccrued_int_amt\x18\
    \"\x20\x01(\x01R\raccruedIntAmt\x12,\n\x12next_rollover_date\x18#\x20\
    \x01(\x03R\x10nextRolloverDate\x12:\n\x19interest_computation_type\x18$\
    \x20\x01(\tR\x17interestComputationType\x12\x0e\n\x02rm\x18%\x20\x01(\tR\
    \x02rm\x12#\n\rcustomer_name\x18&\x20\x01(\tR\x0ccustomerName\x12&\n\x0f\
    monthly_avg_bal\x18'\x20\x01(\x01R\rmonthlyAvgBal\x12(\n\x10pension_acc_\
    flag\x18(\x20\x01(\tR\x0epensionAccFlag\x12\x1f\n\x0bwaiver_flag\x18)\
    \x20\x01(\tR\nwaiverFlag\x12\x12\n\x04aorl\x18*\x20\x01(\tR\x04aorl\x12\
    ...
    l_principal_amount\x18/\x20\x01(\x01R\x14totalPrincipalAmount\x12'\n\tca\
    shflows\x180\x20\x03(\x0b2\t.CashflowR\tcashflowsb\x06proto3\
";
