...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.rep_freq.is_empty() {
            my_size += ::protobuf::rt::string_size(24, &self.rep_freq);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.rep_freq.is_empty() {
            os.write_string(24, &self.rep_freq)?;
        }
        if self.no_ei_structures != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x12cf_ind_loans.proto\"R\n\x08Cashflow\x12\x17\n\x07int_amt\x18\x01\
    \x20\x01(\x01R\x06intAmt\x12\x19\n\x08prin_amt\x18\x02\x20\x01(\x01R\x07\
    prinAmt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xd8\x14\n\x14A\
    ccountWithCashflows\x12\x15\n\x06acc_no\x18\x01\x20\x01(\tR\x05accNo\x12\
    #\n\rdisbursed_amt\x18\x02\x20\x01(\x01R\x0cdisbursedAmt\x12%\n\x0fos_lo\
    an_bal_lcy\x18\x03\x20\x01(\x01R\x0cosLoanBalLcy\x12\x19\n\x08int_rate\
    \x18\x04\x20\x01(\x01R\x07intRate\x12\x1e\n\x0bei_amt_crnt\x18\x05\x20\
    \x01(\x01R\teiAmtCrnt\x12\x19\n\x08int_type\x18\x06\x20\x01(\tR\x07intTy\
    pe\x121\n\x16os_p_bal_due_local_ccy\x18\x07\x20\x01(\x01R\x11osPBalDueLo\
    calCcy\x121\n\x16os_i_bal_due_local_ccy\x18\x08\x20\x01(\x01R\x11osIBalD\
    ueLocalCcy\x12,\n\x13ei_amt_paid_adv_lcy\x18\t\x20\x01(\x01R\x0feiAmtPai\
    dAdvLcy\x12#\n\x0epre_ei_bal_lcy\x18\n\x20\x01(\x01R\x0bpreEiBalLcy\x12-\
    \n\x13acc_open_value_date\x18\x0b\x20\x01(\x03R\x10accOpenValueDate\x12#\
    \n\rmaturity_date\x18\x0c\x20\x01(\x03R\x0cmaturityDate\x12+\n\x12ei_sta\
    rt_date_crnt\x18\r\x20\x01(\x03R\x0feiStartDateCrnt\x12'\n\x10ei_end_dat\
    e_crnt\x18\x0e\x20\x01(\x03R\reiEndDateCrnt\x12'\n\x10ei_pay_freq_crnt\
    \x18\x0f\x20\x01(\tR\reiPayFreqCrnt\x124\n\x17emi_last_paid_date_crnt\
    \x18\x10\x20\x01(\x03R\x13emiLastPaidDateCrnt\x12\x1c\n\nei_pay_day\x18\
    \x11\x20\x01(\x03R\x08eiPayDay\x12&\n\x0fei_orginal_term\x18\x12\x20\x01\
    (\x03R\reiOrginalTerm\x12\x1e\n\x0bei_bal_term\x18\x13\x20\x01(\x03R\tei\
    BalTerm\x12\x15\n\x06rep_bm\x18\x14\x20\x01(\tR\x05repBm\x12\x16\n\x06sp\
    read\x18\x15\x20\x01(\tR\x06spread\x12\"\n\rlast_rep_date\x18\x16\x20\
    \x01(\x03R\x0blastRepDate\x12\"\n\rnext_rep_date\x18\x17\x20\x01(\x03R\
    \x0bnextRepDate\x12\x19\n\x08rep_freq\x18\x18\x20\x01(\tR\x07repFreq\x12\
    (\n\x10no_ei_structures\x18\x19\x20\x01(\x03R\x0enoEiStructures\x12\x1b\
    \n\tnpa_class\x18\x1a\x20\x01(\tR\x08npaClass\x12\x16\n\x06remark\x18\
    \x1b\x20\x01(\tR\x06remark\x12$\n\x0emonths_os_comb\x18\x1c\x20\x01(\tR\
    \x0cmonthsOsComb\x12\x19\n\x08mor_type\x18\x1d\x20\x01(\tR\x07morType\
    \x12\"\n\rfrom_mor_date\x18\x1e\x20\x01(\x03R\x0bfromMorDate\x12\x1e\n\
    \x0bto_mor_date\x18\x1f\x20\x01(\x03R\ttoMorDate\x12+\n\x12recalc_ei_amt\
    _flag\x18\x20\x20\x01(\tR\x0frecalcEiAmtFlag\x12\x20\n\x0cmor_int_calc\
    \x18!\x20\x01(\tR\nmorIntCalc\x12&\n\x0fbullet_pay_flag\x18\"\x20\x01(\t\
    R\rbulletPayFlag\x12!\n\x0crestrct_flag\x18#\x20\x01(\tR\x0brestrctFlag\
    \x121\n\x14residential_mortgage\x18$\x20\x01(\tR\x13residentialMortgage\
    \x12\x1f\n\x0brisk_weight\x18%\x20\x01(\tR\nriskWeight\x12'\n\x0finterna\
    l_rating\x18&\x20\x01(\tR\x0einternalRating\x12'\n\x0fexternal_rating\
    \x18'\x20\x01(\tR\x0eexternalRating\x12+\n\x11contractual_tenor\x18(\x20\
    \x01(\x03R\x10contractualTenor\x12%\n\x0eresidual_tenor\x18)\x20\x01(\
    \x03R\rresidualTenor\x124\n\x16cust_constitution_code\x18*\x20\x01(\tR\
    \x14custConstitutionCode\x12\x1b\n\tprod_code\x18+\x20\x01(\tR\x08prodCo\
    de\x12\x1a\n\tp_gl_code\x18,\x20\x01(\tR\x07pGlCode\x12\x1d\n\nm_npaclas\
    s\x18-\x20\x01(\tR\tmNpaclass\x12\x19\n\x08acrd_int\x18.\x20\x01(\x01R\
    \x07acrdInt\x12\x17\n\x07cust_id\x18/\x20\x01(\tR\x06custId\x12\x1b\n\tc\
    ust_name\x180\x20\x01(\tR\x08custName\x12\x19\n\x08group_id\x181\x20\x01\
    (\tR\x07groupId\x12\x1d\n\ngroup_name\x182\x20\x01(\tR\tgroupName\x12\
    \x1f\n\x0bbranch_code\x183\x20\x01(\tR\nbranchCode\x12\x16\n\x06sector\
    \x184\x20\x01(\tR\x06sector\x12\x1a\n\x08industry\x185\x20\x01(\tR\x08in\
    dustry\x12\x10\n\x03ltv\x186\x20\x01(\tR\x03ltv\x12\x1f\n\x0boverdue_acc\
    \x187\x20\x01(\tR\noverdueAcc\x12\x1d\n\nexcess_acc\x188\x20\x01(\tR\tex\
    cessAcc\x12\x1b\n\tloan_type\x189\x20\x01(\tR\x08loanType\x12\x1b\n\tres\
    id_int\x18:\x20\x01(\x01R\x08residInt\x12\x10\n\x03ccy\x18;\x20\x01(\tR\
    \x03ccy\x12(\n\x10hdfc_ltd_percent\x18<\x20\x01(\x01R\x0ehdfcLtdPercent\
    \x12\x1f\n\x0bsec_percent\x18=\x20\x01(\x01R\nsecPercent\x12!\n\x0coverd\
    ue_type\x18>\x20\x01(\tR\x0boverdueType\x12\x19\n\x08alm_line\x18?\x20\
    \x01(\tR\x07almLine\x12)\n\x10structure_number\x18@\x20\x01(\tR\x0fstruc\
    tureNumber\x12\x12\n\x04memi\x18A\x20\x01(\x01R\x04memi\x12\x17\n\x07ost\
    _bal\x18B\x20\x01(\x01R\x06ostBal\x12\x10\n\x03roi\x18C\x20\x01(\x01R\
    \x03roi\x12\x1a\n\x08asondate\x18D\x20\x01(\x03R\x08asondate\x12)\n\x11e\
    mi_overdue_gl_cd\x18E\x20\x01(\x03R\x0eemiOverdueGlCd\x120\n\x15pre_emi_\
    overdue_gl_cd\x18F\x20\x01(\x03R\x11preEmiOverdueGlCd\x12'\n\x10excess_e\
    mi_gl_cd\x18G\x20\x01(\x03R\rexcessEmiGlCd\x12.\n\x14excess_pre_emi_gl_c\
    d\x18H\x20\x01(\x03R\x10excessPreEmiGlCd\x12\x20\n\x0ctot_prin_amt\x18I\
    \x20\x01(\x01R\ntotPrinAmt\x12\x1e\n\x0btot_int_amt\x18J\x20\x01(\x01R\t\
    totIntAmt\x12\x19\n\x08sma_flag\x18K\x20\x01(\tR\x07smaFlag\x12'\n\tcash\
    flows\x18L\x20\x03(\x0b2\t.CashflowR\tcashflowsb\x06proto3\
";
