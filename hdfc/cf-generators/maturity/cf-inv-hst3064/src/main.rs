...
fn main() {
    ...
    let app_name = "et-inv-hst3064-cf";
    ...
    info!(
        log,
        "Total Duration of Etreasury-Inv-HST3064-Cashflow generator: {:?}", total_duration
    );
    println!(
        "Total Duration of Etreasury-Inv-HST3064-Cashflow generator: {:?}",
        total_duration
    );
}
