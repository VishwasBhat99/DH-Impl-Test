...
impl AccountWithCashflows {
    ...
    // double lcy_out_amt_usd = 35;

    pub fn clear_lcy_out_amt_usd(&mut self) {
        self.lcy_out_amt_usd = 0.;
    }

    // Param is passed by value, moved
    pub fn set_lcy_out_amt_usd(&mut self, v: f64) {
        self.lcy_out_amt_usd = v;
    }

    pub fn get_lcy_out_amt_usd(&self) -> f64 {
        self.lcy_out_amt_usd
    }

    // double lcy_int_amt_usd = 36;

    pub fn clear_lcy_int_amt_usd(&mut self) {
        self.lcy_int_amt_usd = 0.;
    }

    // Param is passed by value, moved
    pub fn set_lcy_int_amt_usd(&mut self, v: f64) {
        self.lcy_int_amt_usd = v;
    }

    pub fn get_lcy_int_amt_usd(&self) -> f64 {
        self.lcy_int_amt_usd
    }

    // double penalty_amt_usd = 37;

    pub fn clear_penalty_amt_usd(&mut self) {
        self.penalty_amt_usd = 0.;
    }

    // Param is passed by value, moved
    pub fn set_penalty_amt_usd(&mut self, v: f64) {
        self.penalty_amt_usd = v;
    }

    pub fn get_penalty_amt_usd(&self) -> f64 {
        self.penalty_amt_usd
    }
    ...
    // int64 int_payout_dt = 39;

    pub fn clear_int_payout_dt(&mut self) {
        self.int_payout_dt = 0;
    }

    // Param is passed by value, moved
    pub fn set_int_payout_dt(&mut self, v: i64) {
        self.int_payout_dt = v;
    }

    pub fn get_int_payout_dt(&self) -> i64 {
        self.int_payout_dt
    }

    // double total_interest_amount = 40;
    ...
    // double total_principal_amount = 41;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.lcy_out_amt_usd != 0. {
            my_size += 10;
        }
        if self.lcy_int_amt_usd != 0. {
            my_size += 10;
        }
        if self.penalty_amt_usd != 0. {
            my_size += 10;
        }
        if self.int_rate != 0. {
            my_size += 10;
        }
        if self.int_payout_dt != 0 {
            my_size += ::protobuf::rt::value_size(39, self.int_payout_dt, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.lcy_out_amt_usd != 0. {
            os.write_double(35, self.lcy_out_amt_usd)?;
        }
        if self.lcy_int_amt_usd != 0. {
            os.write_double(36, self.lcy_int_amt_usd)?;
        }
        if self.penalty_amt_usd != 0. {
            os.write_double(37, self.penalty_amt_usd)?;
        }
        if self.int_rate != 0. {
            os.write_double(38, self.int_rate)?;
        }
        if self.int_payout_dt != 0 {
            os.write_int64(39, self.int_payout_dt)?;
        }
        if self.total_interest_amount != 0. {
            os.write_double(40, self.total_interest_amount)?;
        }
        if self.total_principal_amount != 0. {
            os.write_double(41, self.total_principal_amount)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "lcy_out_amt_usd",
                    |m: &AccountWithCashflows| { &m.lcy_out_amt_usd },
                    |m: &mut AccountWithCashflows| { &mut m.lcy_out_amt_usd },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "lcy_int_amt_usd",
                    |m: &AccountWithCashflows| { &m.lcy_int_amt_usd },
                    |m: &mut AccountWithCashflows| { &mut m.lcy_int_amt_usd },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "penalty_amt_usd",
                    |m: &AccountWithCashflows| { &m.penalty_amt_usd },
                    |m: &mut AccountWithCashflows| { &mut m.penalty_amt_usd },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                    "int_rate",
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "int_payout_dt",
                    |m: &AccountWithCashflows| { &m.int_payout_dt },
                    |m: &mut AccountWithCashflows| { &mut m.int_payout_dt },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
...
impl ::protobuf::Clear for AccountWithCashflows {
    fn clear(&mut self) {
        ...
        self.clear_lcy_out_amt_usd();
        self.clear_lcy_int_amt_usd();
        self.clear_penalty_amt_usd();
        self.clear_int_rate();
        self.clear_int_payout_dt();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0flcy_out_amt_usd\x18#\x20\x01(\x01R\x0clcyOutAmtUsd\x12%\n\x0flcy_int\
    _amt_usd\x18$\x20\x01(\x01R\x0clcyIntAmtUsd\x12&\n\x0fpenalty_amt_usd\
    \x18%\x20\x01(\x01R\rpenaltyAmtUsd\x12\x19\n\x08int_rate\x18&\x20\x01(\
    \x01R\x07intRate\x12\"\n\rint_payout_dt\x18'\x20\x01(\x03R\x0bintPayoutD\
    t\x122\n\x15total_interest_amount\x18(\x20\x01(\x01R\x13totalInterestAmo\
    unt\x124\n\x16total_principal_amount\x18)\x20\x01(\x01R\x14totalPrincipa\
