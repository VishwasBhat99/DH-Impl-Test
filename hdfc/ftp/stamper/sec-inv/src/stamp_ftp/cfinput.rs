...
impl AccFieldNames {
    pub fn get_input_fields_names() -> AccFieldNames {
        AccFieldNames {
            fc_ubs_acc: "fc_ubs_acc".to_string(),
            ...
            txn_mis2: "txn_mis2".to_string(),
            old_fc_ubs_acc: "old_fc_ubs_acc".to_string(),
            deal_name: "deal_name".to_string(),
            cf_start_date: "cf_start_date".to_string(),
            total_interest_amount: "total_interest_amount".to_string(),
            total_principal_amount: "total_principal_amount".to_string(),
            ubs_acct_num: "ubs_acct_num".to_string(),
