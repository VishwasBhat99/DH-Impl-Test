...
pub struct AccountWithCashflows {
    ...
    pub as_on_date: i64,
    pub revised_mat_dt: i64,
    pub days_passed_due: i64,
...
impl AccountWithCashflows {
    ...
    // int64 revised_mat_dt = 32;

    pub fn clear_revised_mat_dt(&mut self) {
        self.revised_mat_dt = 0;
    }

    // Param is passed by value, moved
    pub fn set_revised_mat_dt(&mut self, v: i64) {
        self.revised_mat_dt = v;
    }

    pub fn get_revised_mat_dt(&self) -> i64 {
        self.revised_mat_dt
    }

    // int64 days_passed_due = 33;

    pub fn clear_days_passed_due(&mut self) {
        self.days_passed_due = 0;
    }

    // Param is passed by value, moved
    pub fn set_days_passed_due(&mut self, v: i64) {
        self.days_passed_due = v;
    }

    pub fn get_days_passed_due(&self) -> i64 {
        self.days_passed_due
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.as_on_date != 0 {
            my_size += ::protobuf::rt::value_size(31, self.as_on_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.revised_mat_dt != 0 {
            my_size += ::protobuf::rt::value_size(32, self.revised_mat_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.days_passed_due != 0 {
            my_size += ::protobuf::rt::value_size(33, self.days_passed_due, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.as_on_date != 0 {
            os.write_int64(31, self.as_on_date)?;
        }
        if self.revised_mat_dt != 0 {
            os.write_int64(32, self.revised_mat_dt)?;
        }
        if self.days_passed_due != 0 {
            os.write_int64(33, self.days_passed_due)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "revised_mat_dt",
                    |m: &AccountWithCashflows| { &m.revised_mat_dt },
                    |m: &mut AccountWithCashflows| { &mut m.revised_mat_dt },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "days_passed_due",
                    |m: &AccountWithCashflows| { &m.days_passed_due },
                    |m: &mut AccountWithCashflows| { &mut m.days_passed_due },
                ));
...
impl ::protobuf::Clear for AccountWithCashflows {
    fn clear(&mut self) {
        ...
        self.clear_revised_mat_dt();
        self.clear_days_passed_due();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x07custom2\x18\x1e\x20\x01(\tR\x07custom2\x12\x1c\n\nas_on_date\x18\
    \x1f\x20\x01(\x03R\x08asOnDate\x12$\n\x0erevised_mat_dt\x18\x20\x20\x01(\
    \x03R\x0crevisedMatDt\x12&\n\x0fdays_passed_due\x18!\x20\x01(\x03R\rdays\
