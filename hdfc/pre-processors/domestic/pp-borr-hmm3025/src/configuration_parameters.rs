...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "as_on_dt: {}", self.as_on_date());
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app modifies data to conform with the input requirements of Etreasury borrowing HMM3025 CFGen!")
        .arg(
        ...
        .arg(
            Arg::with_name("as_on_date")
                ...
                .long("as-on-date")
                .value_name("DATE")
                .help("The date for which program runs.")
                .required(true)
        )
        .arg(
            Arg::with_name("sheet_name")
                ...
                .long("sheet-name")
                .value_name("Name")
                .help("Name of excel sheet which should get processed.")
                .required(true)
        )
        .get_matches()
}
