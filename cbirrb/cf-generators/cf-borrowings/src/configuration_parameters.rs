...
fn get_eligible_arguments_for_command(command_name: &str) -> clap::ArgMatches {
    Command::new(command_name)
        .about("This Program generates borrowings cashflows!")
        .version("1.0.4166")
        ...
        .arg(
            Arg::new("input_date_format")
                ...
                .possible_values(&["ddmmyyyy","ddmmmyyyy","ddmmyy","yymmdd","dd-mm-yyyy","dd-mmm-yyyy", "yyyymmdd","yyyymmmdd","yyyy-mm-dd","yyyy-mmm-dd","dd-mmm-yy","dd-mm-yy","yy-mmm-dd","yy-mm-dd","dd/mm/yyyy","dd/mmm/yyyy","yyyy/mm/dd","yyyy/mmm/dd","dd/mmm/yy","dd/mm/yy","yy/mmm/dd","yy/mm/dd"])
