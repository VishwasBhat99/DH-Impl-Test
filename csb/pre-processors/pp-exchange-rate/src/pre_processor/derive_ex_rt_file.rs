...
pub fn get_ex_rt_lines(ccy: &CurrencyConverter, config_params: &ConfigurationParameters) -> String {
...
pub fn append_ccy(lines: &mut String, config_params: &ConfigurationParameters) {
