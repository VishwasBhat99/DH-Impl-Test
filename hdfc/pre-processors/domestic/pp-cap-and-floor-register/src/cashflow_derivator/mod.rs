...
pub fn derive(config_params: ConfigurationParameters, log: &Logger, diag_log: &Logger) {
    ...
    loop {
        ...
        let cf_amt = input_account.flow_amount.clone();
        ...
        let cashflows = log_measurements!(
            ...
            [format!(
                ...
                input_account.trade_id, input_account.cashflow_date, input_account.flow_currency
            )],
