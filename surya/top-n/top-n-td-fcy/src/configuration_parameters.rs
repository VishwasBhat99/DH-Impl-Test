...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "top_n_int_rate: {}", self.top_n_int_rate());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let country_id = matches
            .value_of("country_id")
            .expect("Error getting `country_id` value.")
            .to_string();
        let top_n_int_rate = matches
            .value_of("top_n_int_rate")
            .expect("Error getting `top_n_int_rate` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn top_n_int_rate(&self) -> &str {
        &self.top_n_int_rate
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app processes the data for Top N TD FCY.")
        .version("1.0.5038")
        ...
        .arg(
            Arg::with_name("base_currency")
                ...
                .help("This will be taken as base Currency.")
                .required(true)
        )
        .arg(
            Arg::with_name("country_id")
                ...
                .help("This will be taken as country id.")
                .required(true)
        )
        .arg(
            Arg::with_name("top_n_int_rate")
                .long("top-n-int-rate-file")
                .value_name("top_n_int_rate")
                .help("Path to top n int rate file that needs to be processed.")
                .required(true)
        )
        .arg(
