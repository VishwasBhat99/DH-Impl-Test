...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app modifies data to conform with the input requirements of Etreasury investment HST3066 CFGen!")
        .arg(
        ...
        .arg(
            Arg::with_name("diagnostics_log_file")
                ...
                .value_name("FILE")
                .help("Path to diagnostics log file")
                .required(true)
        )
        .arg(
        ...
        .arg(
         ...
         .arg(
            Arg::with_name("sheet_name")
                ...
                .long("sheet-name")
                .value_name("Name")
                .help("Name of the excel sheet which should get processed.")
                .required(true)
        )
        .get_matches()
}
