...
pub fn create_account_with_cashflows(
    ...
    out_acc.contract_usage = account.contract_usage;
    out_acc.non_index_flow_currency = account.non_index_flow_currency;
    out_acc.non_index_cf_amt = account.non_index_cf_amt;
