...
impl ::protobuf::Message for cap_floor {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.tot_int_amt != 0. {
            os.write_double(37, self.tot_int_amt)?;
        }
        if self.tot_prin_amt != 0. {
            os.write_double(38, self.tot_prin_amt)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<cap_floor>(
                    "cap_floor",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static cap_floor {
        static mut instance: ::protobuf::lazy::Lazy<cap_floor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const cap_floor,
        };
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04date\"\x94\x0c\n\tcap_floor\x12\x16\n\x06entity\x18\x01\x20\x01(\tR\
    \x06entity\x12\x19\n\x08trade_id\x18\x02\x20\x01(\tR\x07tradeId\x12*\n\
    \x11structure_id_link\x18\x03\x20\x01(\x01R\x0fstructureIdLink\x12%\n\
    \x0ecomponent_typo\x18\x04\x20\x01(\tR\rcomponentTypo\x12#\n\rcontract_t\
    ype\x18\x05\x20\x01(\tR\x0ccontractType\x12!\n\x0cpackage_typo\x18\x06\
    \x20\x01(\tR\x0bpackageTypo\x12\x12\n\x04desk\x18\x07\x20\x01(\tR\x04des\
    k\x12\x12\n\x04book\x18\x08\x20\x01(\tR\x04book\x12\x16\n\x06folder\x18\
    \t\x20\x01(\tR\x06folder\x12'\n\x0ftrading_banking\x18\n\x20\x01(\tR\x0e\
    tradingBanking\x12+\n\x11internal_external\x18\x0b\x20\x01(\tR\x10intern\
    alExternal\x126\n\x17counterparty_group_code\x18\x0c\x20\x01(\tR\x15coun\
    terpartyGroupCode\x128\n\x18counterparty_parent_code\x18\r\x20\x01(\tR\
    \x16counterpartyParentCode\x126\n\x17counterparty_child_code\x18\x0e\x20\
    \x01(\tR\x15counterpartyChildCode\x12\"\n\rbank_non_bank\x18\x0f\x20\x01\
    (\tR\x0bbankNonBank\x12\x1d\n\ntrade_date\x18\x10\x20\x01(\x03R\ttradeDa\
    te\x12#\n\rmaturity_date\x18\x11\x20\x01(\x03R\x0cmaturityDate\x12\x19\n\
    \x08buy_sale\x18\x12\x20\x01(\tR\x07buySale\x12)\n\x10underlying_index\
    \x18\x13\x20\x01(\tR\x0funderlyingIndex\x12+\n\x11notional_currency\x18\
    \x14\x20\x01(\tR\x10notionalCurrency\x128\n\x18original_notional_amount\
    \x18\x15\x20\x01(\x01R\x16originalNotionalAmount\x12\x1c\n\nmtm_in_inr\
    \x18\x16\x20\x01(\x01R\x08mtmInInr\x12%\n\x0fnet_pv01_in_inr\x18\x17\x20\
    \x01(\x01R\x0cnetPv01InInr\x12@\n\x1dmodified_duration_of_the_deal\x18\
    \x18\x20\x01(\x01R\x19modifiedDurationOfTheDeal\x12'\n\x0freset_frequenc\
    y\x18\x19\x20\x01(\tR\x0eresetFrequency\x12&\n\x0fnext_reset_date\x18\
    \x1a\x20\x01(\x03R\rnextResetDate\x12#\n\runderlying_pp\x18\x1b\x20\x01(\
    \tR\x0cunderlyingPp\x12\x1f\n\x0bdeal_status\x18\x1c\x20\x01(\tR\ndealSt\
    atus\x125\n\x16counterparty_category1\x18\x1d\x20\x01(\tR\x15counterpart\
    yCategory1\x125\n\x16counterparty_category2\x18\x1e\x20\x01(\tR\x15count\
    erpartyCategory2\x125\n\x16counterparty_category3\x18\x1f\x20\x01(\tR\
    \x15counterpartyCategory3\x12-\n\x12accounting_section\x18\x20\x20\x01(\
    \tR\x11accountingSection\x12\x1c\n\tflowtype4\x18!\x20\x01(\tR\tflowtype\
    4\x12\x1f\n\x0bflow_amount\x18\"\x20\x01(\x01R\nflowAmount\x12#\n\rcashf\
    low_date\x18#\x20\x01(\x03R\x0ccashflowDate\x12#\n\rflow_currency\x18$\
    \x20\x01(\tR\x0cflowCurrency\x12\x1e\n\x0btot_int_amt\x18%\x20\x01(\x01R\
