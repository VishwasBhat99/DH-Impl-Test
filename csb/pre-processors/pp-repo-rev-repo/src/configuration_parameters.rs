...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "treas_gl_master: {}", self.treas_gl_master());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let cust_master = matches
            ...
            .to_string();
        let treas_gl_master = matches
            .value_of("treas_gl_master")
            .expect("Error getting `treas_gl_master` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn treas_gl_master(&self) -> &str {
        &self.treas_gl_master
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app modifies data to conform with the input requirements of Repo Rev Repo CFGen!")
        .arg(
        ...
        .arg(
            Arg::with_name("treas_gl_master")
                .long("treas-gl-master")
                .value_name("Treasury GL Code Master File")
                .help("Treasury GL Code Master FileName.")
                .required(true)
        )
        .arg(
