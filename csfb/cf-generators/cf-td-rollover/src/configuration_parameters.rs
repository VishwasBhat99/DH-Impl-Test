...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "rollover: {}", self.rollover());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let rollover = matches
            .value_of("rollover")
            .expect("Error getting `rollover`.")
            .parse::<i32>()
            .expect("Unable to parse `rollover` value to `i32`.");
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .about("This program generates the Term Deposit rollover cashflows")
        .arg(
        ...
        .arg(
            Arg::with_name("rollover")
                .long("rollover")
                .value_name("Rollover")
                .help("Number of rollove cashflows to be generated.")
                .required(true)
        )
        .arg(
