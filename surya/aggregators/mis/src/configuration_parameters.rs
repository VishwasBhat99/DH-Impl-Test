...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let is_act_open_dt_flag = matches
            .value_of("is_act_open_dt_flag")
            .expect("Error getting `is_act_open_dt_flag`.")
            .parse::<bool>()
            .expect("Cannot parse `is_act_open_dt_flag` as bool.");
...
impl ConfigurationParameters {
    ...
    pub fn is_act_open_dt_flag(&self) -> bool {
        self.is_act_open_dt_flag
    }
}
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("MIS")
        .author("shashank676 <shashank.p@surya-soft.com>")
        .version("1.2.4534")
        .arg(
        ...
        .arg(
            Arg::with_name("is_act_open_dt_flag")
            .long("is-act-open-dt-flag")
            .help("This flag that decides whether bucketing is happening based on Account Open date Flag or As On Date")
            .value_name("Decides bucketing sequence")
            .possible_values(&["true", "false"])
            .default_value("false")
            .required(false)
        )
