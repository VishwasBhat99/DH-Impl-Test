...
fn main() {
    ...
    let app_name = "retail-fields-appender";
    ...
    info!(
        log,
        "Total Duration for Retail appender: {:?}", total_duration
    );
    println!("Total Duration for Retail appender: {:?}", total_duration);
}
