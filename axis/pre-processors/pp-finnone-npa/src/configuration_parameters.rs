...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "cif_report: {}", self.cif_report());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let npa_live_file_path = matches
            ...
            .to_string();
        let cif_report = matches
            .value_of("cif_report")
            .expect("Error getting `cif_report` value.")
            .to_string();
        ...
        let req_fields_file_path = matches
            ...
            .expect("Error getting `req_fields_file_path` value.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app generates derives the NPA attributes for finnacle source.")
        .version("1.0.2952")
        ...
        .arg(
            Arg::with_name("cif_report")
                .long("cif-report")
                .value_name("CIF REPORT")
                .help("Path to CIF Report")
                .required(true)
        )
        .arg(
