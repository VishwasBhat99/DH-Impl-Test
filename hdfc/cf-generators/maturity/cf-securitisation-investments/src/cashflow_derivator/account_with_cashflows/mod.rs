...
pub struct AccountWithCashflows {
    ...
    pub ubs_acct_number: ::std::string::String,
...
impl AccountWithCashflows {
    ...
    // string ubs_acct_number = 37;


    pub fn get_ubs_acct_number(&self) -> &str {
        &self.ubs_acct_number
    }
    pub fn clear_ubs_acct_number(&mut self) {
        self.ubs_acct_number.clear();
    }

    // Param is passed by value, moved
    pub fn set_ubs_acct_number(&mut self, v: ::std::string::String) {
        self.ubs_acct_number = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ubs_acct_number(&mut self) -> &mut ::std::string::String {
        &mut self.ubs_acct_number
    }

    // Take field
    pub fn take_ubs_acct_number(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.ubs_acct_number, ::std::string::String::new())
    }
    ...
    // repeated .Cashflow cashflows = 39;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                37 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.ubs_acct_number)?;
                },
                38 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.mis1 != 0 {
            my_size += ::protobuf::rt::value_size(14, self.mis1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.mis2 != 0 {
            my_size += ::protobuf::rt::value_size(15, self.mis2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.mis3 != 0 {
            my_size += ::protobuf::rt::value_size(16, self.mis3, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.ccy.is_empty() {
            my_size += ::protobuf::rt::string_size(17, &self.ccy);
        }
        if !self.ratings.is_empty() {
            my_size += ::protobuf::rt::string_size(18, &self.ratings);
        }
        if !self.rating_agency.is_empty() {
            my_size += ::protobuf::rt::string_size(19, &self.rating_agency);
        }
        if !self.asset_class.is_empty() {
            my_size += ::protobuf::rt::string_size(20, &self.asset_class);
        }
        if !self.div.is_empty() {
            my_size += ::protobuf::rt::string_size(21, &self.div);
        }
        if !self.typ.is_empty() {
            my_size += ::protobuf::rt::string_size(22, &self.typ);
        }
        if !self.originator.is_empty() {
            my_size += ::protobuf::rt::string_size(23, &self.originator);
        }
        if self.as_on_dt != 0 {
            my_size += ::protobuf::rt::value_size(24, self.as_on_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.rep_freq.is_empty() {
            my_size += ::protobuf::rt::string_size(25, &self.rep_freq);
        }
        if self.nxt_rep_dt != 0 {
            my_size += ::protobuf::rt::value_size(26, self.nxt_rep_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.portfolio.is_empty() {
            my_size += ::protobuf::rt::string_size(27, &self.portfolio);
        }
        if !self.alm_line.is_empty() {
            my_size += ::protobuf::rt::string_size(28, &self.alm_line);
        }
        if self.txn_mis2 != 0 {
            my_size += ::protobuf::rt::value_size(29, self.txn_mis2, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.old_fc_ubs_acc.is_empty() {
            my_size += ::protobuf::rt::string_size(30, &self.old_fc_ubs_acc);
        }
        if !self.deal_name.is_empty() {
            my_size += ::protobuf::rt::string_size(31, &self.deal_name);
        }
        if self.cf_start_date != 0 {
            my_size += ::protobuf::rt::value_size(32, self.cf_start_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.org_tenor != 0 {
            my_size += ::protobuf::rt::value_size(33, self.org_tenor, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.resid_tenor != 0 {
            my_size += ::protobuf::rt::value_size(34, self.resid_tenor, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if !self.ubs_acct_number.is_empty() {
            my_size += ::protobuf::rt::string_size(37, &self.ubs_acct_number);
        }
        if !self.sma_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(38, &self.sma_flag);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.mis1 != 0 {
            os.write_int64(14, self.mis1)?;
        }
        if self.mis2 != 0 {
            os.write_int64(15, self.mis2)?;
        }
        if self.mis3 != 0 {
            os.write_int64(16, self.mis3)?;
        }
        if !self.ccy.is_empty() {
            os.write_string(17, &self.ccy)?;
        }
        if !self.ratings.is_empty() {
            os.write_string(18, &self.ratings)?;
        }
        if !self.rating_agency.is_empty() {
            os.write_string(19, &self.rating_agency)?;
        }
        if !self.asset_class.is_empty() {
            os.write_string(20, &self.asset_class)?;
        }
        if !self.div.is_empty() {
            os.write_string(21, &self.div)?;
        }
        if !self.typ.is_empty() {
            os.write_string(22, &self.typ)?;
        }
        if !self.originator.is_empty() {
            os.write_string(23, &self.originator)?;
        }
        if self.as_on_dt != 0 {
            os.write_int64(24, self.as_on_dt)?;
        }
        if !self.rep_freq.is_empty() {
            os.write_string(25, &self.rep_freq)?;
        }
        if self.nxt_rep_dt != 0 {
            os.write_int64(26, self.nxt_rep_dt)?;
        }
        if !self.portfolio.is_empty() {
            os.write_string(27, &self.portfolio)?;
        }
        if !self.alm_line.is_empty() {
            os.write_string(28, &self.alm_line)?;
        }
        if self.txn_mis2 != 0 {
            os.write_int64(29, self.txn_mis2)?;
        }
        if !self.old_fc_ubs_acc.is_empty() {
            os.write_string(30, &self.old_fc_ubs_acc)?;
        }
        if !self.deal_name.is_empty() {
            os.write_string(31, &self.deal_name)?;
        }
        if self.cf_start_date != 0 {
            os.write_int64(32, self.cf_start_date)?;
        }
        if self.org_tenor != 0 {
            os.write_int64(33, self.org_tenor)?;
        }
        if self.resid_tenor != 0 {
            os.write_int64(34, self.resid_tenor)?;
        }
        if self.total_interest_amount != 0. {
        ...
        if !self.ubs_acct_number.is_empty() {
            os.write_string(37, &self.ubs_acct_number)?;
        }
        if !self.sma_flag.is_empty() {
            os.write_string(38, &self.sma_flag)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "ubs_acct_number",
                |m: &AccountWithCashflows| { &m.ubs_acct_number },
                |m: &mut AccountWithCashflows| { &mut m.ubs_acct_number },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "sma_flag",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fsec_invst.proto\"R\n\x08Cashflow\x12\x17\n\x07int_amt\x18\x01\x20\
    \x01(\x01R\x06intAmt\x12\x19\n\x08prin_amt\x18\x02\x20\x01(\x01R\x07prin\
    Amt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xf2\x08\n\x14Accou\
    ntWithCashflows\x12\x1c\n\nfc_ubs_acc\x18\x01\x20\x01(\tR\x08fcUbsAcc\
    \x12\x1b\n\tcust_name\x18\x02\x20\x01(\tR\x08custName\x12\x19\n\x08pout_\
    bal\x18\x03\x20\x01(\x01R\x07poutBal\x12\x17\n\x07acc_int\x18\x04\x20\
    \x01(\x01R\x06accInt\x12\x13\n\x05st_dt\x18\x05\x20\x01(\x03R\x04stDt\
    \x12\x11\n\x04c_dt\x18\x06\x20\x01(\x03R\x03cDt\x12\x13\n\x05gl_cd\x18\
    \x07\x20\x01(\tR\x04glCd\x12\x15\n\x06int_rt\x18\x08\x20\x01(\x01R\x05in\
    tRt\x12\x17\n\x07int_typ\x18\t\x20\x01(\tR\x06intTyp\x12\x1b\n\tint_bmar\
    k\x18\n\x20\x01(\tR\x08intBmark\x12\x17\n\x07rt_flag\x18\x0b\x20\x01(\tR\
    \x06rtFlag\x12\x17\n\x07prod_cd\x18\x0c\x20\x01(\tR\x06prodCd\x12\x1c\n\
    \nnxt_pay_dt\x18\r\x20\x01(\x03R\x08nxtPayDt\x12\x12\n\x04mis1\x18\x0e\
    \x20\x01(\x03R\x04mis1\x12\x12\n\x04mis2\x18\x0f\x20\x01(\x03R\x04mis2\
    \x12\x12\n\x04mis3\x18\x10\x20\x01(\x03R\x04mis3\x12\x10\n\x03ccy\x18\
    \x11\x20\x01(\tR\x03ccy\x12\x18\n\x07ratings\x18\x12\x20\x01(\tR\x07rati\
    ngs\x12#\n\rrating_agency\x18\x13\x20\x01(\tR\x0cratingAgency\x12\x1f\n\
    \x0basset_class\x18\x14\x20\x01(\tR\nassetClass\x12\x10\n\x03div\x18\x15\
    \x20\x01(\tR\x03div\x12\x10\n\x03typ\x18\x16\x20\x01(\tR\x03typ\x12\x1e\
    \n\noriginator\x18\x17\x20\x01(\tR\noriginator\x12\x18\n\x08as_on_dt\x18\
    \x18\x20\x01(\x03R\x06asOnDt\x12\x19\n\x08rep_freq\x18\x19\x20\x01(\tR\
    \x07repFreq\x12\x1c\n\nnxt_rep_dt\x18\x1a\x20\x01(\x03R\x08nxtRepDt\x12\
    \x1c\n\tportfolio\x18\x1b\x20\x01(\tR\tportfolio\x12\x19\n\x08alm_line\
    \x18\x1c\x20\x01(\tR\x07almLine\x12\x19\n\x08txn_mis2\x18\x1d\x20\x01(\
    \x03R\x07txnMis2\x12#\n\x0eold_fc_ubs_acc\x18\x1e\x20\x01(\tR\x0boldFcUb\
    sAcc\x12\x1b\n\tdeal_name\x18\x1f\x20\x01(\tR\x08dealName\x12\"\n\rcf_st\
    art_date\x18\x20\x20\x01(\x03R\x0bcfStartDate\x12\x1b\n\torg_tenor\x18!\
    ...
    talPrincipalAmount\x12&\n\x0fubs_acct_number\x18%\x20\x01(\tR\rubsAcctNu\
    mber\x12\x19\n\x08sma_flag\x18&\x20\x01(\tR\x07smaFlag\x12'\n\tcashflows\
