...
fn main() {
    ...
    let app_name = "over-bills-pp-hk-1.0.1";
    ...
    info!(
        log,
        "Total Duration taken by Overseas Bills Pre-processor: {:?}", total_duration
    );
    println!(
        "Total Duration taken by Overseas Bills Pre-processor: {:?}",
        total_duration
    );
}
