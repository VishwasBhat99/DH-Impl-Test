...
pub fn generate(config_params: ConfigurationParameters, log: &Logger, diag_log: &Logger) {
    ...
    loop {
        ...
        let acc_data = LCR {
            ...
            nwd_stable_b1: input_account.nwd_stable_b1,
            nwd_stable_b2: input_account.nwd_stable_b2,
            nwd_stable_b3: input_account.nwd_stable_b3,
            nwd_less_stable_b1: input_account.nwd_less_stable_b1,
            nwd_less_stable_b2: input_account.nwd_less_stable_b2,
            nwd_less_stable_b3: input_account.nwd_less_stable_b3,
            ca_wt_int_rate: input_account.ca_wt_int_rate,
            sa_wt_int_rate: input_account.sa_wt_int_rate,
            td_wd_wt_int_rate: input_account.td_wd_wt_int_rate,
            td_nwd_wt_int_rate: input_account.td_nwd_wt_int_rate,
            rd_wt_int_rate: input_account.rd_wt_int_rate,
            lien_amt: input_account.lien_amt,
            bal_before_lien: input_account.bal_before_lien,
            bal_after_lien: input_account.bal_after_lien,
        };
        summary_data
            .entry(grp_key)
            .and_modify(|data| {
                ...
                data.nwd_stable_b1 += input_account.nwd_stable_b1;
                data.nwd_stable_b2 += input_account.nwd_stable_b2;
                data.nwd_stable_b3 += input_account.nwd_stable_b3;
                data.nwd_less_stable_b1 += input_account.nwd_less_stable_b1;
                data.nwd_less_stable_b2 += input_account.nwd_less_stable_b2;
                data.nwd_less_stable_b3 += input_account.nwd_less_stable_b3;
                data.ca_wt_int_rate += input_account.ca_wt_int_rate;
                data.sa_wt_int_rate += input_account.sa_wt_int_rate;
                data.td_wd_wt_int_rate += input_account.td_wd_wt_int_rate;
                data.td_nwd_wt_int_rate += input_account.td_nwd_wt_int_rate;
                data.rd_wt_int_rate += input_account.rd_wt_int_rate;
                data.lien_amt += input_account.lien_amt;
                data.bal_before_lien += input_account.bal_before_lien;
                data.bal_after_lien += input_account.bal_after_lien;
            })
            .or_insert(acc_data);
    }
