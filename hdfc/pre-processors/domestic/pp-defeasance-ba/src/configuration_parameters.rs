...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "trade_source: {}", self.trade_src());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let output_file_path = matches
            ...
            .to_string();
        let trade_src = matches
            .value_of("trade_src")
            .expect("Error getting `trade_source` value.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This program generates a text file from excel file.")
        .arg(
        ...
        .arg(
            Arg::with_name("trade_src")
                .long("trade-source")
                .value_name("TRADE SOURCE")
        ...
        .arg(
            Arg::with_name("diagnostics_log_file")
                ...
                .value_name("DIAGNOSTIC_LOG_FILE")
        ...
        .arg(
            Arg::with_name("input_sheet_name")
                ...
                .help("The sheet name of Input XLSX file.")
