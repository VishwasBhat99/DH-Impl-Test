...
pub fn get_op_data(
    ...
    let prov_amt = 0.0;
    let rw_out_bal_ccy = rw_out_bal_lcy / exchange_rate;
    OutputData {
        ...
        final_rw: risk_weight,
        tot_col_amt_lcy: tot_col_amt_lcy.to_string(),
        crm_amt_lcy: crm_amt_lcy.to_string(),
...
pub fn get_claim_info(input_file_path: &str) -> String {
    let file_det: Vec<&str> = input_file_path.split('/').collect();
