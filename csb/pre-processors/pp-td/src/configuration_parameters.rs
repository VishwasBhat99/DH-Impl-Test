...
pub struct ConfigurationParameters {
    ...
    pub overdue_acc_file_path: String,
}
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "overdue_acc_file: {}", self.overdue_acc_file_path());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let alm_master_sheet_name = matches
            ...
            .to_string();
        let overdue_acc_file_path = matches
            .value_of("overdue_acc_file")
            .expect("Error getting `overdue_acc_file` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn overdue_acc_file_path(&self) -> &str {
        &self.overdue_acc_file_path
    }
}

fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app modifies data to conform with the input requirements of TD CFGen!")
        .arg(
        ...
        .arg(
            Arg::with_name("diagnostics_log_file")
                ...
                .value_name("Diadnostics Log File")
        ...
        .arg(
            Arg::with_name("overdue_acc_file")
                .long("overdue-acc-file")
                .value_name("Overdue Acc File")
                .help("Path to overdue acc file.")
                .required(true)
        )
        .get_matches()
}
