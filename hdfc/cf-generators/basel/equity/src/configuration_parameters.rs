...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "index_file_path: {}", self.index_file_path());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        let input_file_path = matches
            ...
            .to_string();
        let index_file_path = matches
            .value_of("index_file")
            .expect("Error getting `index_file_value`.")
            .to_string();
    ...
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("index_file")
                .long("index-file")
                .value_name("Index File")
                .help("Path to the index file with combined Nifty and BSE data.")
                .required(true)
        )
        .arg(
