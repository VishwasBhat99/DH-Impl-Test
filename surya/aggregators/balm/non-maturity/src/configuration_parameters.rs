...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "is_aggr_amt_abs: {}", self.is_aggr_amt_abs());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let is_aggr_amt_abs = matches
            .value_of("is_aggr_amt_abs")
            .expect("Error getting `is_aggr_amt_abs`.")
            .parse::<bool>()
            .expect("Cannot parse `is_aggr_amt_abs` as bool.");
...
impl ConfigurationParameters {
    ...
    pub fn is_aggr_amt_abs(&self) -> bool {
        self.is_aggr_amt_abs
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("is_aggr_amt_abs")
                .long("is-aggr-amt-abs")
                .value_name("is_aggr_amt_abs")
                .possible_values(&["true", "false"])
                .help("The flag that decides whether aggr amount should be taken as absolute or not.")
                .default_value("false")
                .required(false)
        )
        .arg(
