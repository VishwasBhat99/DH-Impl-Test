...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.tot_int_amt != 0. {
            os.write_double(57, self.tot_int_amt)?;
        }
        if self.tot_prin_amt != 0. {
            os.write_double(58, self.tot_prin_amt)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Amt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xef\r\n\x14Account\
    WithCashflows\x12\x13\n\x05key_1\x18\x01\x20\x01(\tR\x04key1\x12\x1b\n\t\
    ...
    ate\x12\x1e\n\x0btot_int_amt\x189\x20\x01(\x01R\ttotIntAmt\x12\x20\n\x0c\
