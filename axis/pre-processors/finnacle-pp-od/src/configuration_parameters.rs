...
pub struct ConfigurationParameters {
    ...
    pub benchmark_file_path: String,
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "benchmark_file: {}", self.benchmark_file_path());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let npa_file_path = matches
            ...
            .to_string();
        let benchmark_file_path = matches
            .value_of("benchmark_file")
            .expect("Error getting `benchmark_file` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn benchmark_file_path(&self) -> &str {
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app generates preprocessor output for finnacle-OD.")
        .version("1.0.2958")
        ...
        .arg(
            Arg::with_name("benchmark_file")
                .short("bm")
                .long("benchmark-file")
                .value_name("BENCHMARK_FILE")
                .help("Path to benchmark file file that needs to be processed.")
                .required(true)
        )
        .arg(
