...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn write_to_with_cached_sizes(
        ...
        if self.Method != 0 {
            os.write_int32(36, self.Method)?;
        }
        if self.BaseCurve != 0 {
            os.write_int32(37, self.BaseCurve)?;
        }
        if self.ftp_runid != 0 {
            os.write_int64(38, self.ftp_runid)?;
        }
        if self.from_date != 0 {
            os.write_int32(39, self.from_date)?;
        }
        if self.to_date != 0 {
            os.write_int32(40, self.to_date)?;
        }
        if self.total_balance != 0. {
            os.write_double(41, self.total_balance)?;
        }
        if self.total_interest_ftp != 0. {
            os.write_double(42, self.total_interest_ftp)?;
        }
        if self.total_ftp != 0. {
            os.write_double(43, self.total_ftp)?;
        }
        if self.FTP_Rate != 0. {
            os.write_double(44, self.FTP_Rate)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x01R\x0eadj6RateAmount\"\xbe\x0c\n\x14AccountWithCashflows\x12%\n\
    \x0eaccount_number\x18\x01\x20\x01(\tR\raccountNumber\x12)\n\x10accrued_\
    interest\x18\x02\x20\x01(\x01R\x0faccruedInterest\x12!\n\x0cdeposit_type\
    \x18\x03\x20\x01(\tR\x0bdepositType\x12#\n\rmaturity_date\x18\x04\x20\
    \x01(\x03R\x0cmaturityDate\x12\x20\n\x0crat_acct_int\x18\x05\x20\x01(\
    \x01R\nratAcctInt\x12'\n\x10rat_acct_int_var\x18\x06\x20\x01(\x01R\rratA\
    cctIntVar\x12,\n\x12next_compound_date\x18\x07\x20\x01(\x03R\x10nextComp\
    oundDate\x12*\n\x11next_payment_date\x18\x08\x20\x01(\x03R\x0fnextPaymen\
    tDate\x12,\n\x12account_start_date\x18\t\x20\x01(\x03R\x10accountStartDa\
    te\x12#\n\rcurrency_code\x18\n\x20\x01(\x03R\x0ccurrencyCode\x12\x1f\n\
    \x0bcustomer_id\x18\x0b\x20\x01(\x03R\ncustomerId\x12)\n\x10original_bal\
    ance\x18\x0c\x20\x01(\x01R\x0foriginalBalance\x12)\n\x10origination_date\
    \x18\r\x20\x01(\x03R\x0foriginationDate\x125\n\x17previous_roll_over_dat\
    e\x18\x0e\x20\x01(\x03R\x14previousRollOverDate\x12\x20\n\x0bdescription\
    \x18\x0f\x20\x01(\tR\x0bdescription\x12\x1f\n\x0bclient_name\x18\x10\x20\
    \x01(\tR\nclientName\x12\x14\n\x05tname\x18\x11\x20\x01(\tR\x05tname\x12\
    \x1c\n\nas_on_date\x18\x12\x20\x01(\tR\x08asOnDate\x12\x19\n\x08bank_num\
    \x18\x13\x20\x01(\tR\x07bankNum\x12\x16\n\x06branch\x18\x14\x20\x01(\tR\
    \x06branch\x12\x1b\n\trate_flag\x18\x15\x20\x01(\tR\x08rateFlag\x12&\n\
    \x0fcost_centre_ftp\x18\x16\x20\x01(\tR\rcostCentreFtp\x12\x20\n\x0cint_\
    pay_freq\x18\x17\x20\x01(\x03R\nintPayFreq\x12\x20\n\x0binstitution\x18\
    \x18\x20\x01(\tR\x0binstitution\x12\x15\n\x06new_gl\x18\x19\x20\x01(\tR\
    \x05newGl\x12\x19\n\x08int_rate\x18\x1a\x20\x01(\x01R\x07intRate\x12\x16\
    \n\x06concat\x18\x1b\x20\x01(\tR\x06concat\x12\x15\n\x06ia_llg\x18\x1c\
    \x20\x01(\tR\x05iaLlg\x12\x19\n\x08balm_llg\x18\x1d\x20\x01(\tR\x07balmL\
    lg\x120\n\x14current_book_balance\x18\x1e\x20\x01(\x01R\x12currentBookBa\
    lance\x12\x1f\n\x0bcost_center\x18\x1f\x20\x01(\tR\ncostCenter\x12\x1b\n\
    \tcomp_freq\x18\x20\x20\x01(\x03R\x08compFreq\x12\x20\n\x0cfin_cost_ftp\
    \x18!\x20\x01(\tR\nfinCostFtp\x124\n\x16total_principal_amount\x18\"\x20\
    \x01(\x01R\x14totalPrincipalAmount\x122\n\x15total_interest_amount\x18#\
    \x20\x01(\x01R\x13totalInterestAmount\x12\x16\n\x06Method\x18$\x20\x01(\
    \x05R\x06Method\x12\x1c\n\tBaseCurve\x18%\x20\x01(\x05R\tBaseCurve\x12\
    \x1b\n\tftp_runid\x18&\x20\x01(\x03R\x08ftpRunid\x12\x1b\n\tfrom_date\
    \x18'\x20\x01(\x05R\x08fromDate\x12\x17\n\x07to_date\x18(\x20\x01(\x05R\
    \x06toDate\x12#\n\rtotal_balance\x18)\x20\x01(\x01R\x0ctotalBalance\x12,\
    \n\x12total_interest_ftp\x18*\x20\x01(\x01R\x10totalInterestFtp\x12\x1b\
    \n\ttotal_ftp\x18+\x20\x01(\x01R\x08totalFtp\x12\x19\n\x08FTP_Rate\x18,\
    \x20\x01(\x01R\x07FTPRate\x12'\n\tcashflows\x18-\x20\x03(\x0b2\t.Cashflo\
