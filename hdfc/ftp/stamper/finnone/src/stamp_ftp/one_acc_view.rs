...
//! Generated file from `ftp_one_acc_view_fn.proto`
...
impl<'a> ::std::default::Default for &'a One_acc_view {
    fn default() -> &'a One_acc_view {
        <One_acc_view as ::protobuf::Message>::default_instance()
    }
}
...
impl ::protobuf::Message for One_acc_view {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.branch.is_empty() {
            my_size += ::protobuf::rt::string_size(18, &self.branch);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.branch.is_empty() {
            os.write_string(18, &self.branch)?;
        }
        if !self.source_file_name.is_empty() {
        ...
        if self.orig_bal != 0. {
            os.write_double(26, self.orig_bal)?;
        }
        if self.outstanding_bal != 0. {
    ...
    fn default_instance() -> &'static One_acc_view {
        static mut instance: ::protobuf::lazy::Lazy<One_acc_view> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19ftp_one_acc_view_fn.proto\"\xd7\x0b\n\x0cOne_acc_view\x12%\n\x0eac\
    count_number\x18\x01\x20\x01(\tR\raccountNumber\x12\x1b\n\tcust_name\x18\
    \x02\x20\x01(\tR\x08custName\x12'\n\x0faverage_balance\x18\x03\x20\x01(\
    ...
    \x16\n\x06branch\x18\x12\x20\x01(\tR\x06branch\x12(\n\x10source_file_nam\
    e\x18\x13\x20\x01(\tR\x0esourceFileName\x12\x10\n\x03ccy\x18\x14\x20\x01\
    (\tR\x03ccy\x12\x0e\n\x02gl\x18\x15\x20\x01(\tR\x02gl\x12\x17\n\x07cust_\
    id\x18\x16\x20\x01(\tR\x06custId\x12\"\n\rfinal_ftp_amt\x18\x17\x20\x01(\
    \x01R\x0bfinalFtpAmt\x12\x19\n\x08alm_line\x18\x18\x20\x01(\tR\x07almLin\
    e\x12\x19\n\x08trade_dt\x18\x19\x20\x01(\tR\x07tradeDt\x12\x19\n\x08orig\
    _bal\x18\x1a\x20\x01(\x01R\x07origBal\x12'\n\x0foutstanding_bal\x18\x1b\
    \x20\x01(\x01R\x0eoutstandingBal\x12\x12\n\x04adj1\x18\x1c\x20\x01(\x01R\
    \x04adj1\x12\x12\n\x04adj2\x18\x1d\x20\x01(\x01R\x04adj2\x12\x12\n\x04ad\
    j3\x18\x1e\x20\x01(\x01R\x04adj3\x12\x12\n\x04adj4\x18\x1f\x20\x01(\x01R\
    \x04adj4\x12\x12\n\x04adj5\x18\x20\x20\x01(\x01R\x04adj5\x12\x12\n\x04ad\
    j6\x18!\x20\x01(\x01R\x04adj6\x12'\n\x0finput_benchmark\x18\"\x20\x01(\t\
    R\x0einputBenchmark\x12\x10\n\x03pdo\x18#\x20\x01(\tR\x03pdo\x12\x10\n\
    \x03npa\x18$\x20\x01(\tR\x03npa\x12\x16\n\x06method\x18%\x20\x01(\tR\x06\
    method\x12\x1d\n\nrate_curve\x18&\x20\x01(\tR\trateCurve\x12\x1b\n\torg_\
    tenor\x18'\x20\x01(\x03R\x08orgTenor\x12\x1b\n\trep_tenor\x18(\x20\x01(\
    \x03R\x08repTenor\x12\x1b\n\tfx_spread\x18)\x20\x01(\x01R\x08fxSpread\
    \x12\x1d\n\nvar_spread\x18*\x20\x01(\x01R\tvarSpread\x12\x1b\n\tfirst_ft\
    p\x18+\x20\x01(\x01R\x08firstFtp\x12!\n\rbc_as_on_rule\x18,\x20\x01(\x03\
    ...
    \x127\n\x18tenor_start_date_applied\x180\x20\x01(\x03R\x15tenorStartDate\
    Applied\x123\n\x16tenor_end_date_applied\x181\x20\x01(\x03R\x13tenorEndD\
    ateAppliedb\x06proto3\
";
