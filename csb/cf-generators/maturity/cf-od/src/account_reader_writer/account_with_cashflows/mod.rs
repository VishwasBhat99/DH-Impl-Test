...
impl OutputAccount {
    ...
    // repeated .Cashflow cashflows = 116;
...
impl ::protobuf::Message for OutputAccount {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.acnts_brn_code)?;
                },
                4 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.acnts_client_num)?;
                },
                5 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.ucic)?;
                },
                6 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.acnts_curr_code)?;
                },
                7 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.acnts_prod_code)?;
                },
                8 => {
                ...
                18 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.reset_no_of_months)?;
                },
                19 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.npa_dt != 0 {
            my_size += ::protobuf::rt::value_size(55, self.npa_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.written_off_dt != 0 {
            my_size += ::protobuf::rt::value_size(58, self.written_off_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.primary_valuation_dt != 0 {
            my_size += ::protobuf::rt::value_size(69, self.primary_valuation_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.collateral_valuation_dt != 0 {
            my_size += ::protobuf::rt::value_size(70, self.collateral_valuation_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.sanc_dt != 0 {
            my_size += ::protobuf::rt::value_size(84, self.sanc_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.restruct_dt != 0 {
            my_size += ::protobuf::rt::value_size(89, self.restruct_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.pt_i64_1 != 0 {
            my_size += ::protobuf::rt::value_size(101, self.pt_i64_1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pt_i64_2 != 0 {
            my_size += ::protobuf::rt::value_size(102, self.pt_i64_2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pt_i64_3 != 0 {
            my_size += ::protobuf::rt::value_size(103, self.pt_i64_3, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pt_i64_4 != 0 {
            my_size += ::protobuf::rt::value_size(104, self.pt_i64_4, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pt_i64_5 != 0 {
            my_size += ::protobuf::rt::value_size(105, self.pt_i64_5, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pt_f64_1 != 0. {
            my_size += 10;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04date\"\xe7\x1e\n\rOutputAccount\x12\x15\n\x06acc_no\x18\x01\x20\x01(\
    \tR\x05accNo\x120\n\x14acnts_internal_acnum\x18\x02\x20\x01(\tR\x12acnts\
    InternalAcnum\x12$\n\x0eacnts_brn_code\x18\x03\x20\x01(\tR\x0cacntsBrnCo\
    de\x12(\n\x10acnts_client_num\x18\x04\x20\x01(\tR\x0eacntsClientNum\x12\
    \x12\n\x04ucic\x18\x05\x20\x01(\tR\x04ucic\x12&\n\x0facnts_curr_code\x18\
    \x06\x20\x01(\tR\racntsCurrCode\x12&\n\x0facnts_prod_code\x18\x07\x20\
    \x01(\tR\racntsProdCode\x12\x13\n\x05gl_cd\x18\x08\x20\x01(\tR\x04glCd\
    \x12\x1e\n\x0bacc_open_dt\x18\t\x20\x01(\x03R\taccOpenDt\x12\x10\n\x03ba\
    l\x18\n\x20\x01(\x01R\x03bal\x12\x16\n\x06balccy\x18\x0b\x20\x01(\x01R\
    \x06balccy\x12\x19\n\x08int_rate\x18\x0c\x20\x01(\x01R\x07intRate\x12\
    \x19\n\x08int_type\x18\r\x20\x01(\tR\x07intType\x12\x1b\n\tint_bench\x18\
    \x0e\x20\x01(\tR\x08intBench\x12\x1d\n\nint_spread\x18\x0f\x20\x01(\tR\t\
    intSpread\x12\"\n\rlast_reset_dt\x18\x10\x20\x01(\x03R\x0blastResetDt\
    \x12\"\n\rnext_reset_dt\x18\x11\x20\x01(\x03R\x0bnextResetDt\x12+\n\x12r\
    eset_no_of_months\x18\x12\x20\x01(\tR\x0fresetNoOfMonths\x12&\n\x0fint_a\
    ccrued_amt\x18\x13\x20\x01(\x01R\rintAccruedAmt\x12\x1a\n\x08constitn\
    \x18\x14\x20\x01(\tR\x08constitn\x12\x15\n\x06lm_exp\x18\x15\x20\x01(\
    ...
    \x20\x01(\tR\x06ptStr4\x12\x18\n\x08pt_str_5\x18s\x20\x01(\tR\x06ptStr5\
