...
impl AccountWithCashflows {
    ...
    // repeated .Cashflow cashflows = 41;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.sma_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(40, &self.sma_flag);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.sma_flag.is_empty() {
            os.write_string(40, &self.sma_flag)?;
        }
        for v in &self.cashflows {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\tR\raccountNumber\x12\x1b\n\tcurr_code\x18\x02\x20\x01(\tR\
    \x08currCode\x12\x1b\n\tintt_rate\x18\x03\x20\x01(\x01R\x08inttRate\x12!\
    \n\x0cproduct_code\x18\x04\x20\x01(\tR\x0bproductCode\x12\x19\n\x08mat_d\
    ate\x18\x05\x20\x01(\x03R\x07matDate\x12\x1b\n\trate_flag\x18\x06\x20\
    \x01(\tR\x08rateFlag\x12'\n\x0frepricing_index\x18\x07\x20\x01(\tR\x0ere\
    pricingIndex\x12\x10\n\x03psl\x18\x08\x20\x01(\tR\x03psl\x12\x10\n\x03np\
    a\x18\t\x20\x01(\tR\x03npa\x12$\n\x0eindv_corp_flag\x18\n\x20\x01(\tR\
    ...
    \x0e\x20\x01(\tR\x08prodType\x12$\n\x0efinal_int_rate\x18\x0f\x20\x01(\
    \x01R\x0cfinalIntRate\x12\x1f\n\x0bcost_centre\x18\x10\x20\x01(\x03R\nco\
    stCentre\x12\x19\n\x08alm_line\x18\x11\x20\x01(\tR\x07almLine\x12\x10\n\
    \x03coa\x18\x12\x20\x01(\tR\x03coa\x12\x1a\n\x08division\x18\x13\x20\x01\
    (\tR\x08division\x12\x19\n\x08rep_freq\x18\x14\x20\x01(\tR\x07repFreq\
    \x12.\n\x13next_repricing_date\x18\x15\x20\x01(\x03R\x11nextRepricingDat\
    e\x12.\n\x13last_repricing_date\x18\x16\x20\x01(\x03R\x11lastRepricingDa\
