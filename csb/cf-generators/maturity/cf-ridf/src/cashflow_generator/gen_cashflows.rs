...
pub fn generate_cashflows(
    ...
    // Case: cf_dt < as_on_dt
    if cf_dt < as_on_dt {
        log_error!(log, "`overdue` for account: `{}`.", account.deposit_number,);
    }
