...
use cashflow_derivator::account_with_cashflows_writer::account_indices::Index;
use macros;
...
impl AccountWithCashflowsWriter {
    pub fn write(&mut self, record: money_market) {
        // Write the account
        ...
        self.account_index.set_key(record.deal_id);
