...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "amt_field_for: {}", self.amt_field_for());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let base_ccy = matches
            ...
            .to_string();
        let amt_field_for = matches
            .value_of("amt_field_for")
            .expect("Error getting `amt_field_for`.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about(".cf file generator for Undrawn")
        .arg(
        ...
        .arg(
            Arg::with_name("amt_field_for")
                .long("amt-field-for")
                .value_name("Amount Field")
                .possible_values(&["LCR", "NSFR", "NIL"])
                .help("This value determines the cashflow amount to be considered for LCR/NSFR.")
                .required(true)
        )
        .arg(
