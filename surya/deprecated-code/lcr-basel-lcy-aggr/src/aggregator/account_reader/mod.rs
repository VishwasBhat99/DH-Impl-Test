use aggregator::account_reader::input_account::InputAccount;
use aggregator::account_reader::input_account_reader_report::InputAccountReaderReport;
use macros;
        ...
        while !correct_record_found {
            ...
            if let Some(line) = line_opt {
                ...
                if let Ok(underlying_string) = line {
                    ...
                    let parse_result = InputAccount::new_from_line(underlying_string);
                    ...
                    if parse_result.is_err() {
                        ...
                        log_error!(
                            ...
                            parse_result.err().expect("Unknown Error.")
                        );
                        continue;
                    }

                    next_account = Some(parse_result.expect("Error while getting record."));
