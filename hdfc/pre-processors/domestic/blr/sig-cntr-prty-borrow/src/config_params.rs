...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "tot_bal_file: {}", self.tot_bal_file());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let input_file = matches
            ...
            .to_string();
        let tot_bal_file = matches
            .value_of("tot_bal_file")
            .expect("Error in getting `tot_bal_file` value.")
            .to_string();
    ...
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("input_file")
                .long("input-file")
                .help("Borrowings data file path")
                .value_name("Borrowings File")
                .required(true)
        )
        .arg(
            Arg::with_name("tot_bal_file")
                .long("tot-bal-file")
                .help("Total balance file path")
