...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "input_files_type: {}", self.input_files_type());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let diagnostics_file_path = matches
            ...
            .to_string();
        let input_files_type = matches
            .value_of("input_files_type")
            .expect("Error getting `input_files_type` value.")
            .trim()
            .to_uppercase();
...
impl ConfigurationParameters {
    ...
    pub fn input_files_type(&self) -> &str {
        &self.input_files_type
    }
}

fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about("This app modifies data into consolidated data using currency conversion rates!!")
        ...
        .arg(
            Arg::with_name("input_files_type")
                .short("ift")
                .long("input-files-type")
                .value_name("FILE")
                .help("Type of Input Files that are to be processed.")
                .possible_values(&["BALM", "BRWISE"])
                .default_value("BALM")
                .required(false)
        )
        .get_matches()
