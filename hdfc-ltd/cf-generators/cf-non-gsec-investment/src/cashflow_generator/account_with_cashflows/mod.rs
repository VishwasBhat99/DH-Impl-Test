...
//! Generated file from `new1.proto`
...
pub struct AccountWithCashflows {
    ...
    pub open_ended: ::std::string::String,
    pub haircut: ::std::string::String,
    pub mtm_gl_code: ::std::string::String,
    pub mtm_double: f64,
...
impl AccountWithCashflows {
    ...
    // string open_ended = 56;


    pub fn get_open_ended(&self) -> &str {
        &self.open_ended
    }
    pub fn clear_open_ended(&mut self) {
        self.open_ended.clear();
    }

    // Param is passed by value, moved
    pub fn set_open_ended(&mut self, v: ::std::string::String) {
        self.open_ended = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_open_ended(&mut self) -> &mut ::std::string::String {
        &mut self.open_ended
    }

    // Take field
    pub fn take_open_ended(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.open_ended, ::std::string::String::new())
    }

    // string haircut = 57;


    pub fn get_haircut(&self) -> &str {
        &self.haircut
    }
    pub fn clear_haircut(&mut self) {
        self.haircut.clear();
    }

    // Param is passed by value, moved
    pub fn set_haircut(&mut self, v: ::std::string::String) {
        self.haircut = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_haircut(&mut self) -> &mut ::std::string::String {
        &mut self.haircut
    }

    // Take field
    pub fn take_haircut(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.haircut, ::std::string::String::new())
    }

    // string mtm_gl_code = 58;


    pub fn get_mtm_gl_code(&self) -> &str {
        &self.mtm_gl_code
    }
    pub fn clear_mtm_gl_code(&mut self) {
        self.mtm_gl_code.clear();
    }

    // Param is passed by value, moved
    pub fn set_mtm_gl_code(&mut self, v: ::std::string::String) {
        self.mtm_gl_code = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_mtm_gl_code(&mut self) -> &mut ::std::string::String {
        &mut self.mtm_gl_code
    }

    // Take field
    pub fn take_mtm_gl_code(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.mtm_gl_code, ::std::string::String::new())
    }

    // double mtm_double = 59;


    pub fn get_mtm_double(&self) -> f64 {
        self.mtm_double
    }
    pub fn clear_mtm_double(&mut self) {
        self.mtm_double = 0.;
    }

    // Param is passed by value, moved
    pub fn set_mtm_double(&mut self, v: f64) {
        self.mtm_double = v;
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                55 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.listed_exchange)?;
                },
                56 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.open_ended)?;
                },
                57 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.haircut)?;
                },
                58 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.mtm_gl_code)?;
                },
                59 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.listing_status.is_empty() {
            my_size += ::protobuf::rt::string_size(54, &self.listing_status);
        }
        if !self.listed_exchange.is_empty() {
            my_size += ::protobuf::rt::string_size(55, &self.listed_exchange);
        }
        if !self.open_ended.is_empty() {
            my_size += ::protobuf::rt::string_size(56, &self.open_ended);
        }
        if !self.haircut.is_empty() {
            my_size += ::protobuf::rt::string_size(57, &self.haircut);
        }
        if !self.mtm_gl_code.is_empty() {
            my_size += ::protobuf::rt::string_size(58, &self.mtm_gl_code);
        }
        if self.mtm_double != 0. {
            my_size += 10;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.listing_status.is_empty() {
            os.write_string(54, &self.listing_status)?;
        }
        if !self.listed_exchange.is_empty() {
            os.write_string(55, &self.listed_exchange)?;
        }
        if !self.open_ended.is_empty() {
            os.write_string(56, &self.open_ended)?;
        }
        if !self.haircut.is_empty() {
            os.write_string(57, &self.haircut)?;
        }
        if !self.mtm_gl_code.is_empty() {
            os.write_string(58, &self.mtm_gl_code)?;
        }
        if self.mtm_double != 0. {
            os.write_double(59, self.mtm_double)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "listed_exchange",
                |m: &AccountWithCashflows| { &m.listed_exchange },
                |m: &mut AccountWithCashflows| { &mut m.listed_exchange },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "open_ended",
                |m: &AccountWithCashflows| { &m.open_ended },
                |m: &mut AccountWithCashflows| { &mut m.open_ended },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "haircut",
                |m: &AccountWithCashflows| { &m.haircut },
                |m: &mut AccountWithCashflows| { &mut m.haircut },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "mtm_gl_code",
                |m: &AccountWithCashflows| { &m.mtm_gl_code },
                |m: &mut AccountWithCashflows| { &mut m.mtm_gl_code },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "mtm_double",
                |m: &AccountWithCashflows| { &m.mtm_double },
                |m: &mut AccountWithCashflows| { &mut m.mtm_double },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sel_classification\x185\x20\x01(\tR\x17crarBaselClassification\x12%\n\
    \x0elisting_status\x186\x20\x01(\tR\rlistingStatus\x12'\n\x0flisted_exch\
    ange\x187\x20\x01(\tR\x0elistedExchange\x12\x1d\n\nopen_ended\x188\x20\
    \x01(\tR\topenEnded\x12\x18\n\x07haircut\x189\x20\x01(\tR\x07haircut\x12\
    \x1e\n\x0bmtm_gl_code\x18:\x20\x01(\tR\tmtmGlCode\x12\x1d\n\nmtm_double\
    \x18;\x20\x01(\x01R\tmtmDouble\x12'\n\tcashflows\x18<\x20\x03(\x0b2\t.Ca\
