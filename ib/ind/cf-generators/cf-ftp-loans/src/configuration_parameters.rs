...
pub struct ConfigurationParameters {
    ...
    additional_borm_file_path: String,
...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(
            logger,
            "additional_borm_file_path: {}",
            self.additional_borm_file_path()
        );
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let repayment_schedule_file_path = matches
            ...
            .to_string();
        let additional_borm_file_path = matches
            .value_of("additional_borm_file_path")
            .expect("Error getting `additional_borm_file_path`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn additional_borm_file_path(&self) -> &str {
        &self.additional_borm_file_path
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .arg(
            Arg::with_name("additional_borm_file_path")
                .long("add-borm-file-path")
                .value_name("Additional BORM File Path")
                .help("Path to Additional BORM file.")
                .required(true)
        )
        .arg(
