...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "filter_ccy: {}", self.filter_ccy());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let log_file_path = matches
            ...
            .to_string();
        let filter_ccy = matches
            .value_of("filter_ccy")
            .expect("Error getting `filter_ccy`.")
            .to_string();
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        .about(".cf file generator for CCY LCR Classified File")
        .arg(
        ...
        .arg(
            Arg::with_name("filter_ccy")
                .long("filter-ccy")
                .value_name("Filter CCY")
                .help("List of currency to be filtered in output.")
                .default_value("NONE")
                .required(false)
        )
        .arg(
