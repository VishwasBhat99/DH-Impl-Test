...
pub struct InputAccount {
    ...
    pub fv: String,
    pub fwd_outright_buy_fv: String,
    pub fwd_outright_buy_bv: String,
    pub fwd_outright_sale_fv: String,
    pub fwd_outright_sale_bv: String,
    pub reval_per_unit: String,
}
...
impl InputAccount {
    pub fn to_string(&self) -> String {
        format!(
            ...
            self.cf_int_amt,
            self.cf_prin_amt,
            self.fwd_outright_buy_fv,
            self.fwd_outright_buy_bv,
            self.fwd_outright_sale_fv,
            self.fwd_outright_sale_bv
        )
    }
}
