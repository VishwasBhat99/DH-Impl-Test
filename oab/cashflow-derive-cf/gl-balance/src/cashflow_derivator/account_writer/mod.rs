...
use cashflow_derivator::account_writer::account_indices::Index;
use macros;
...
impl AccountWithoutCashflows {
    pub fn write(&mut self, record: OutputAccount, line_number: i64) {
        // Write the account
        ...
        self.account_index.set_key(line_number.to_string());
