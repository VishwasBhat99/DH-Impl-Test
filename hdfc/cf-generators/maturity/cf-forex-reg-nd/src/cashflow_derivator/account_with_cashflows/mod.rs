...
pub struct AccountWithCashflows {
    ...
    pub trade_date: i64,
    pub ndf_settlementcurrency: ::std::string::String,
    pub mat_date_of_trade: i64,
...
impl AccountWithCashflows {
    ...
    pub fn take_counterparty_long_name(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.counterparty_long_name, ::std::string::String::new())
    }
    ...
    // string ndf_settlementcurrency = 48;


    pub fn get_ndf_settlementcurrency(&self) -> &str {
        &self.ndf_settlementcurrency
    }
    pub fn clear_ndf_settlementcurrency(&mut self) {
        self.ndf_settlementcurrency.clear();
    }

    // Param is passed by value, moved
    pub fn set_ndf_settlementcurrency(&mut self, v: ::std::string::String) {
        self.ndf_settlementcurrency = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ndf_settlementcurrency(&mut self) -> &mut ::std::string::String {
        &mut self.ndf_settlementcurrency
    }

    // Take field
    pub fn take_ndf_settlementcurrency(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.ndf_settlementcurrency, ::std::string::String::new())
    }

    // int64 mat_date_of_trade = 49;


    pub fn get_mat_date_of_trade(&self) -> i64 {
        self.mat_date_of_trade
    }
    pub fn clear_mat_date_of_trade(&mut self) {
        self.mat_date_of_trade = 0;
    }

    // Param is passed by value, moved
    pub fn set_mat_date_of_trade(&mut self, v: i64) {
        self.mat_date_of_trade = v;
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.trade_typology)?;
                },
                5 => {
                ...
                11 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.inter_entity)?;
                },
                12 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.counterparty_long_name)?;
                },
                13 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cp_category_level_1)?;
                },
                14 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cp_category_level_2)?;
                },
                15 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cp_category_level_3)?;
                },
                16 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.near_leg_far_leg)?;
                },
                17 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                21 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.ccil_guranteed)?;
                },
                22 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.buy_currency)?;
                },
                23 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                24 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.sell_currency)?;
                },
                25 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                37 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.bank_nonbank)?;
                },
                38 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                42 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cntry_resid)?;
                },
                43 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cntry_ultim_risk)?;
                },
                44 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                48 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.ndf_settlementcurrency)?;
                },
                49 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.option_start_date != 0 {
            my_size += ::protobuf::rt::value_size(17, self.option_start_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.option_end_date != 0 {
            my_size += ::protobuf::rt::value_size(18, self.option_end_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.effective_date != 0 {
            my_size += ::protobuf::rt::value_size(19, self.effective_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.mat_date_of_contract != 0 {
            my_size += ::protobuf::rt::value_size(20, self.mat_date_of_contract, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.original_tenor != 0 {
            my_size += ::protobuf::rt::value_size(38, self.original_tenor, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.residual_tenor != 0 {
            my_size += ::protobuf::rt::value_size(39, self.residual_tenor, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.trade_date != 0 {
            my_size += ::protobuf::rt::value_size(47, self.trade_date, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.ndf_settlementcurrency.is_empty() {
            my_size += ::protobuf::rt::string_size(48, &self.ndf_settlementcurrency);
        }
        if self.mat_date_of_trade != 0 {
            my_size += ::protobuf::rt::value_size(49, self.mat_date_of_trade, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.trade_date != 0 {
            os.write_int64(47, self.trade_date)?;
        }
        if !self.ndf_settlementcurrency.is_empty() {
            os.write_string(48, &self.ndf_settlementcurrency)?;
        }
        if self.mat_date_of_trade != 0 {
            os.write_int64(49, self.mat_date_of_trade)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "ndf_settlementcurrency",
                |m: &AccountWithCashflows| { &m.ndf_settlementcurrency },
                |m: &mut AccountWithCashflows| { &mut m.ndf_settlementcurrency },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "mat_date_of_trade",
                |m: &AccountWithCashflows| { &m.mat_date_of_trade },
                |m: &mut AccountWithCashflows| { &mut m.mat_date_of_trade },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xa1\x0f\n\x14AccountW\
    ...
    hild_code\x18.\x20\x01(\tR\x15counterpartyChildCode\x12\x1d\n\ntrade_dat\
    e\x18/\x20\x01(\x03R\ttradeDate\x125\n\x16ndf_settlementcurrency\x180\
    \x20\x01(\tR\x15ndfSettlementcurrency\x12)\n\x11mat_date_of_trade\x181\
    \x20\x01(\x03R\x0ematDateOfTrade\x12'\n\tcashflows\x182\x20\x03(\x0b2\t.\
