...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "tresury_gl_map: {}", self.tresury_gl_map());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let cust_master = matches
            ...
            .to_string();
        let tresury_gl_map = matches
            .value_of("tresury_gl_map")
            .expect("Error getting `tresury_gl_map` value.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn tresury_gl_map(&self) -> &str {
        &self.tresury_gl_map
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    App::new(app_name)
        ...
        .about("This app modifies data to conform with the input requirements of Borrowings and Lendings CFGen!")
        .arg(
        ...
        .arg(
            Arg::with_name("tresury_gl_map")
                .long("tresury-gl-map")
                .value_name("treasury gl and cbs gl mapping File")
                .help("Path to treasury gl and cbs gl mapping File.")
                .required(true),
        )
        .arg(
