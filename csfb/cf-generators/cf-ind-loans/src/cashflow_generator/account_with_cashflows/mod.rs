...
impl AccountWithCashflows {
    ...
    // int64 pre_emi_overdue_gl_cd = 65;
    ...
    // string lcr_fin_non_fin_flag = 68;
    ...
    // repeated .Cashflow cashflows = 82;
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.emi_overdue_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(64, self.emi_overdue_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.pre_emi_overdue_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(65, self.pre_emi_overdue_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.excess_emi_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(66, self.excess_emi_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.excess_pre_emi_gl_cd != 0 {
            my_size += ::protobuf::rt::value_size(67, self.excess_pre_emi_gl_cd, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.lcr_fin_non_fin_flag.is_empty() {
            my_size += ::protobuf::rt::string_size(68, &self.lcr_fin_non_fin_flag);
        }
        ...
        if !self.purpose.is_empty() {
            my_size += ::protobuf::rt::string_size(71, &self.purpose);
        }
        if self.drawing_power != 0. {
            my_size += 10;
        }
        if !self.tenor.is_empty() {
            my_size += ::protobuf::rt::string_size(73, &self.tenor);
        }
        if !self.turn_over.is_empty() {
            my_size += ::protobuf::rt::string_size(74, &self.turn_over);
        }
        if !self.line_of_activity.is_empty() {
            my_size += ::protobuf::rt::string_size(75, &self.line_of_activity);
        }
        if !self.rating.is_empty() {
            my_size += ::protobuf::rt::string_size(76, &self.rating);
        }
        if !self.net_weight.is_empty() {
            my_size += ::protobuf::rt::string_size(77, &self.net_weight);
        }
        ...
        if self.asondate != 0 {
            my_size += ::protobuf::rt::value_size(81, self.asondate, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.emi_overdue_gl_cd != 0 {
            os.write_int64(64, self.emi_overdue_gl_cd)?;
        }
        if self.pre_emi_overdue_gl_cd != 0 {
            os.write_int64(65, self.pre_emi_overdue_gl_cd)?;
        }
        if self.excess_emi_gl_cd != 0 {
            os.write_int64(66, self.excess_emi_gl_cd)?;
        }
        if self.excess_pre_emi_gl_cd != 0 {
            os.write_int64(67, self.excess_pre_emi_gl_cd)?;
        }
        if !self.lcr_fin_non_fin_flag.is_empty() {
            os.write_string(68, &self.lcr_fin_non_fin_flag)?;
        }
        if self.undrawn_loans != 0. {
            os.write_double(69, self.undrawn_loans)?;
        }
        if self.undrawn_ccod != 0. {
            os.write_double(70, self.undrawn_ccod)?;
        }
        if !self.purpose.is_empty() {
            os.write_string(71, &self.purpose)?;
        }
        if self.drawing_power != 0. {
            os.write_double(72, self.drawing_power)?;
        }
        if !self.tenor.is_empty() {
            os.write_string(73, &self.tenor)?;
        }
        if !self.turn_over.is_empty() {
            os.write_string(74, &self.turn_over)?;
        }
        if !self.line_of_activity.is_empty() {
            os.write_string(75, &self.line_of_activity)?;
        }
        if !self.rating.is_empty() {
            os.write_string(76, &self.rating)?;
        }
        if !self.net_weight.is_empty() {
            os.write_string(77, &self.net_weight)?;
        }
        if self.curr_os_bal != 0. {
            os.write_double(78, self.curr_os_bal)?;
        }
        if self.tot_prin_amt != 0. {
            os.write_double(79, self.tot_prin_amt)?;
        }
        if self.tot_int_amt != 0. {
            os.write_double(80, self.tot_int_amt)?;
        }
        if self.asondate != 0 {
            os.write_int64(81, self.asondate)?;
        }
        for v in &self.cashflows {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                ...
                |m: &AccountWithCashflows| { &m.lcr_fin_non_fin_flag },
                |m: &mut AccountWithCashflows| { &mut m.lcr_fin_non_fin_flag },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "undrawn_loans",
                |m: &AccountWithCashflows| { &m.undrawn_loans },
                |m: &mut AccountWithCashflows| { &mut m.undrawn_loans },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "undrawn_ccod",
                |m: &AccountWithCashflows| { &m.undrawn_ccod },
                |m: &mut AccountWithCashflows| { &mut m.undrawn_ccod },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "purpose",
                |m: &AccountWithCashflows| { &m.purpose },
                |m: &mut AccountWithCashflows| { &mut m.purpose },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "drawing_power",
                |m: &AccountWithCashflows| { &m.drawing_power },
                |m: &mut AccountWithCashflows| { &mut m.drawing_power },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "tenor",
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "turn_over",
                |m: &AccountWithCashflows| { &m.turn_over },
                |m: &mut AccountWithCashflows| { &mut m.turn_over },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "line_of_activity",
                |m: &AccountWithCashflows| { &m.line_of_activity },
                |m: &mut AccountWithCashflows| { &mut m.line_of_activity },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "rating",
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "net_weight",
                |m: &AccountWithCashflows| { &m.net_weight },
                |m: &mut AccountWithCashflows| { &mut m.net_weight },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "curr_os_bal",
                |m: &AccountWithCashflows| { &m.curr_os_bal },
                |m: &mut AccountWithCashflows| { &mut m.curr_os_bal },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeDouble>(
                "tot_prin_amt",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Amt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xbe\x16\n\x14Accou\
    ntWithCashflows\x12\x15\n\x06acc_no\x18\x01\x20\x01(\tR\x05accNo\x12#\n\
    \rdisbursed_amt\x18\x02\x20\x01(\x01R\x0cdisbursedAmt\x12%\n\x0fos_loan_\
    bal_lcy\x18\x03\x20\x01(\x01R\x0cosLoanBalLcy\x12\x19\n\x08int_rate\x18\
    \x04\x20\x01(\x01R\x07intRate\x12\x1e\n\x0bei_amt_crnt\x18\x05\x20\x01(\
    \x01R\teiAmtCrnt\x12\x19\n\x08int_type\x18\x06\x20\x01(\tR\x07intType\
    \x121\n\x16os_p_bal_due_local_ccy\x18\x07\x20\x01(\x01R\x11osPBalDueLoca\
    lCcy\x121\n\x16os_i_bal_due_local_ccy\x18\x08\x20\x01(\x01R\x11osIBalDue\
    LocalCcy\x12,\n\x13ei_amt_paid_adv_lcy\x18\t\x20\x01(\x01R\x0feiAmtPaidA\
    ...
    _date_crnt\x18\r\x20\x01(\x03R\x0feiStartDateCrnt\x12'\n\x10ei_end_date_\
    crnt\x18\x0e\x20\x01(\x03R\reiEndDateCrnt\x12'\n\x10ei_pay_freq_crnt\x18\
    \x0f\x20\x01(\tR\reiPayFreqCrnt\x124\n\x17emi_last_paid_date_crnt\x18\
    \x10\x20\x01(\x03R\x13emiLastPaidDateCrnt\x12\x1c\n\nei_pay_day\x18\x11\
    \x20\x01(\x03R\x08eiPayDay\x12&\n\x0fei_orginal_term\x18\x12\x20\x01(\
    \x03R\reiOrginalTerm\x12\x1e\n\x0bei_bal_term\x18\x13\x20\x01(\x03R\teiB\
    alTerm\x12\x15\n\x06rep_bm\x18\x14\x20\x01(\tR\x05repBm\x12\x16\n\x06spr\
    ead\x18\x15\x20\x01(\tR\x06spread\x12\"\n\rlast_rep_date\x18\x16\x20\x01\
    (\x03R\x0blastRepDate\x12\"\n\rnext_rep_date\x18\x17\x20\x01(\x03R\x0bne\
    ...
    \x20\x01(\tR\x06remark\x12$\n\x0emonths_os_comb\x18\x1c\x20\x01(\tR\x0cm\
    onthsOsComb\x12\x19\n\x08mor_type\x18\x1d\x20\x01(\tR\x07morType\x12\"\n\
    \rfrom_mor_date\x18\x1e\x20\x01(\x03R\x0bfromMorDate\x12\x1e\n\x0bto_mor\
    _date\x18\x1f\x20\x01(\x03R\ttoMorDate\x12+\n\x12recalc_ei_amt_flag\x18\
    \x20\x20\x01(\tR\x0frecalcEiAmtFlag\x12\x20\n\x0cmor_int_calc\x18!\x20\
    \x01(\tR\nmorIntCalc\x12&\n\x0fbullet_pay_flag\x18\"\x20\x01(\tR\rbullet\
    PayFlag\x12!\n\x0crestrct_flag\x18#\x20\x01(\tR\x0brestrctFlag\x121\n\
    ...
    \x01(\tR\x0eexternalRating\x12+\n\x11contractual_tenor\x18(\x20\x01(\x03\
    R\x10contractualTenor\x12%\n\x0eresidual_tenor\x18)\x20\x01(\x03R\rresid\
    ualTenor\x124\n\x16cust_constitution_code\x18*\x20\x01(\tR\x14custConsti\
    tutionCode\x12\x1b\n\tprod_code\x18+\x20\x01(\tR\x08prodCode\x12\x1a\n\t\
    p_gl_code\x18,\x20\x01(\tR\x07pGlCode\x12\x1d\n\nm_npaclass\x18-\x20\x01\
    (\tR\tmNpaclass\x12\x19\n\x08acrd_int\x18.\x20\x01(\x01R\x07acrdInt\x12\
    \x17\n\x07cust_id\x18/\x20\x01(\tR\x06custId\x12\x1b\n\tcust_name\x180\
    \x20\x01(\tR\x08custName\x12\x19\n\x08group_id\x181\x20\x01(\tR\x07group\
    Id\x12\x1d\n\ngroup_name\x182\x20\x01(\tR\tgroupName\x12\x1f\n\x0bbranch\
    _code\x183\x20\x01(\tR\nbranchCode\x12\x16\n\x06sector\x184\x20\x01(\tR\
    \x06sector\x12\x1a\n\x08industry\x185\x20\x01(\tR\x08industry\x12\x10\n\
    \x03ltv\x186\x20\x01(\tR\x03ltv\x12\x1f\n\x0boverdue_acc\x187\x20\x01(\t\
    R\noverdueAcc\x12\x1d\n\nexcess_acc\x188\x20\x01(\tR\texcessAcc\x12\x1b\
    \n\tloan_type\x189\x20\x01(\tR\x08loanType\x12\x1b\n\tresid_int\x18:\x20\
    \x01(\x01R\x08residInt\x12\x10\n\x03ccy\x18;\x20\x01(\tR\x03ccy\x12(\n\
    \x10hdfc_ltd_percent\x18<\x20\x01(\x01R\x0ehdfcLtdPercent\x12\x1f\n\x0bs\
    ec_percent\x18=\x20\x01(\x01R\nsecPercent\x12!\n\x0coverdue_type\x18>\
    \x20\x01(\tR\x0boverdueType\x12\x19\n\x08alm_line\x18?\x20\x01(\tR\x07al\
    mLine\x12)\n\x11emi_overdue_gl_cd\x18@\x20\x01(\x03R\x0eemiOverdueGlCd\
    \x120\n\x15pre_emi_overdue_gl_cd\x18A\x20\x01(\x03R\x11preEmiOverdueGlCd\
    \x12'\n\x10excess_emi_gl_cd\x18B\x20\x01(\x03R\rexcessEmiGlCd\x12.\n\x14\
    excess_pre_emi_gl_cd\x18C\x20\x01(\x03R\x10excessPreEmiGlCd\x12.\n\x14lc\
    r_fin_non_fin_flag\x18D\x20\x01(\tR\x10lcrFinNonFinFlag\x12#\n\rundrawn_\
    loans\x18E\x20\x01(\x01R\x0cundrawnLoans\x12!\n\x0cundrawn_ccod\x18F\x20\
    \x01(\x01R\x0bundrawnCcod\x12\x18\n\x07purpose\x18G\x20\x01(\tR\x07purpo\
    se\x12#\n\rdrawing_power\x18H\x20\x01(\x01R\x0cdrawingPower\x12\x14\n\
    \x05tenor\x18I\x20\x01(\tR\x05tenor\x12\x1b\n\tturn_over\x18J\x20\x01(\t\
    R\x08turnOver\x12(\n\x10line_of_activity\x18K\x20\x01(\tR\x0elineOfActiv\
    ity\x12\x16\n\x06rating\x18L\x20\x01(\tR\x06rating\x12\x1d\n\nnet_weight\
    \x18M\x20\x01(\tR\tnetWeight\x12\x1e\n\x0bcurr_os_bal\x18N\x20\x01(\x01R\
    \tcurrOsBal\x12\x20\n\x0ctot_prin_amt\x18O\x20\x01(\x01R\ntotPrinAmt\x12\
    \x1e\n\x0btot_int_amt\x18P\x20\x01(\x01R\ttotIntAmt\x12\x1a\n\x08asondat\
    e\x18Q\x20\x01(\x03R\x08asondate\x12'\n\tcashflows\x18R\x20\x03(\x0b2\t.\
