...
fn main() {
    ...
    let app_name = "pre-adjust-sp-buc-moc";
    ...
    info!(
        log,
        "Total Duration taken by Special Bucket Moc Pre-adjustor: {:?}", total_duration
    );
    println!(
        "Total Duration taken by Special Bucket Moc Pre-adjustor: {:?}",
        total_duration
    );
}
