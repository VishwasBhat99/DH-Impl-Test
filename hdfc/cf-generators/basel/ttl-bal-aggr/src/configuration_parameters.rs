...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "ca_file_path: {}", self.ca_file_path());
        info!(logger, "sa_file_path: {}", self.ca_file_path());
        info!(logger, "td_file_path: {}", self.td_file_path());
        info!(logger, "rd_file_path: {}", self.rd_file_path());
    }
}
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let td_file_path = matches
            ...
            .to_string();
        let rd_file_path = matches
            .value_of("rd_file")
            .expect("Error getting `rd_file_value`.")
            .to_string();
        let ca_file_path = matches
            .value_of("ca_file")
            .expect("Error getting `ca_file_value`.")
            .to_string();
        let sa_file_path = matches
            .value_of("sa_file")
...
impl ConfigurationParameters {
    ...
    pub fn ca_file_path(&self) -> &str {
        &self.ca_file_path
    }
    pub fn sa_file_path(&self) -> &str {
        &self.sa_file_path
    }
    pub fn td_file_path(&self) -> &str {
        &self.td_file_path
    }
    pub fn rd_file_path(&self) -> &str {
        &self.rd_file_path
    }
