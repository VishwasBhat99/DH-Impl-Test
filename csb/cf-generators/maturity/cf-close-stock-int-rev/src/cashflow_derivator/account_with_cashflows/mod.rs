...
pub struct AccountWithCashflows {
    ...
    pub residual_maturity: ::std::string::String,
...
impl AccountWithCashflows {
    ...
    // string residual_maturity = 39;


    pub fn get_residual_maturity(&self) -> &str {
        &self.residual_maturity
    }
    pub fn clear_residual_maturity(&mut self) {
        self.residual_maturity.clear();
    }

    // Param is passed by value, moved
    pub fn set_residual_maturity(&mut self, v: ::std::string::String) {
        self.residual_maturity = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_residual_maturity(&mut self) -> &mut ::std::string::String {
        &mut self.residual_maturity
    }

    // Take field
    pub fn take_residual_maturity(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.residual_maturity, ::std::string::String::new())
    }
...
impl ::protobuf::Message for AccountWithCashflows {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.portfolio_num)?;
                },
                2 => {
                ...
                24 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.inst_id)?;
                },
                25 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.inst_typ)?;
                },
                26 => {
                ...
                28 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.int_practice)?;
                },
                29 => {
                ...
                39 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.residual_maturity)?;
                },
                40 => {
                ...
                51 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.asset_typ)?;
                },
                52 => {
                ...
                58 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.trsy_gl_cd)?;
                },
                59 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cf_type)?;
                },
                60 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.cf_amt)?;
                },
                61 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.maturity_dt != 0 {
            my_size += ::protobuf::rt::value_size(4, self.maturity_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.coupon != 0. {
            my_size += 9;
        }
        ...
        if self.put_dt != 0 {
            my_size += ::protobuf::rt::value_size(31, self.put_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.call_dt != 0 {
            my_size += ::protobuf::rt::value_size(32, self.call_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.lst_coupon != 0 {
            my_size += ::protobuf::rt::value_size(33, self.lst_coupon, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.nxt_coupon != 0 {
            my_size += ::protobuf::rt::value_size(34, self.nxt_coupon, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.issue_dt != 0 {
            my_size += ::protobuf::rt::value_size(35, self.issue_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if !self.residual_maturity.is_empty() {
            my_size += ::protobuf::rt::string_size(39, &self.residual_maturity);
        }
        ...
        if self.lst_rep_dt != 0 {
            my_size += ::protobuf::rt::value_size(55, self.lst_rep_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.nxt_rep_dt != 0 {
            my_size += ::protobuf::rt::value_size(56, self.nxt_rep_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.cf_dt != 0 {
            my_size += ::protobuf::rt::value_size(62, self.cf_dt, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.prin_amt != 0. {
            my_size += 10;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.residual_maturity.is_empty() {
            os.write_string(39, &self.residual_maturity)?;
        }
        if !self.slr_non_slr.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15csb_close_stock.proto\"R\n\x08Cashflow\x12\x17\n\x07int_amt\x18\
    \x01\x20\x01(\x01R\x06intAmt\x12\x19\n\x08prin_amt\x18\x02\x20\x01(\x01R\
    \x07prinAmt\x12\x12\n\x04date\x18\x03\x20\x01(\x03R\x04date\"\xf0\x11\n\
    \x14AccountWithCashflows\x12#\n\rportfolio_num\x18\x01\x20\x01(\tR\x0cpo\
    rtfolioNum\x12\x1c\n\tportfolio\x18\x02\x20\x01(\tR\tportfolio\x12#\n\rs\
    ecurity_name\x18\x03\x20\x01(\tR\x0csecurityName\x12\x1f\n\x0bmaturity_d\
    t\x18\x04\x20\x01(\x03R\nmaturityDt\x12\x16\n\x06coupon\x18\x05\x20\x01(\
    \x01R\x06coupon\x12+\n\x12face_val_per_units\x18\x06\x20\x01(\x01R\x0ffa\
    ceValPerUnits\x12\x1a\n\x08quantity\x18\x07\x20\x01(\x01R\x08quantity\
    \x12\x19\n\x08face_val\x18\x08\x20\x01(\x01R\x07faceVal\x12\x10\n\x03wap\
    \x18\t\x20\x01(\x01R\x03wap\x12\x19\n\x08book_val\x18\n\x20\x01(\x01R\
    \x07bookVal\x12\x1d\n\nmarket_val\x18\x0b\x20\x01(\x01R\tmarketVal\x12\
    \x10\n\x03mtm\x18\x0c\x20\x01(\x01R\x03mtm\x12\x14\n\x05yeild\x18\r\x20\
    \x01(\x01R\x05yeild\x12\"\n\x0cappreciation\x18\x0e\x20\x01(\x01R\x0capp\
    reciation\x12\"\n\x0cdepreciation\x18\x0f\x20\x01(\x01R\x0cdepreciation\
    \x12B\n\x1dnet_appreciation_depreciation\x18\x10\x20\x01(\x01R\x1bnetApp\
    reciationDepreciation\x12#\n\x0eamort_as_on_dt\x18\x11\x20\x01(\x01R\x0b\
    amortAsOnDt\x12'\n\x0faccounted_amort\x18\x12\x20\x01(\x01R\x0eaccounted\
    Amort\x12,\n\x12un_accounted_amort\x18\x13\x20\x01(\x01R\x10unAccountedA\
    mort\x12\x1f\n\x0baccrued_int\x18\x14\x20\x01(\x01R\naccruedInt\x12\"\n\
    \rno_ca_skipped\x18\x15\x20\x01(\x01R\x0bnoCaSkipped\x12/\n\x14ca_int_no\
    t_receieved\x18\x16\x20\x01(\x01R\x11caIntNotReceieved\x12\x1b\n\ttotal_\
    int\x18\x17\x20\x01(\x01R\x08totalInt\x12\x17\n\x07inst_id\x18\x18\x20\
    \x01(\tR\x06instId\x12\x19\n\x08inst_typ\x18\x19\x20\x01(\tR\x07instTyp\
    \x12\x1b\n\tisin_code\x18\x1a\x20\x01(\tR\x08isinCode\x12\x19\n\x08int_f\
    req\x18\x1b\x20\x01(\tR\x07intFreq\x12!\n\x0cint_practice\x18\x1c\x20\
    \x01(\tR\x0bintPractice\x12\x1a\n\x08category\x18\x1d\x20\x01(\tR\x08cat\
    egory\x12!\n\x0csub_category\x18\x1e\x20\x01(\tR\x0bsubCategory\x12\x15\
    \n\x06put_dt\x18\x1f\x20\x01(\x03R\x05putDt\x12\x17\n\x07call_dt\x18\x20\
    \x20\x01(\x03R\x06callDt\x12\x1d\n\nlst_coupon\x18!\x20\x01(\x03R\tlstCo\
    upon\x12\x1d\n\nnxt_coupon\x18\"\x20\x01(\x03R\tnxtCoupon\x12\x19\n\x08i\
    ssue_dt\x18#\x20\x01(\x03R\x07issueDt\x12\x14\n\x05place\x18$\x20\x01(\t\
    R\x05place\x12\x18\n\x07country\x18%\x20\x01(\tR\x07country\x12#\n\rbook\
    ing_basis\x18&\x20\x01(\tR\x0cbookingBasis\x12+\n\x11residual_maturity\
    \x18'\x20\x01(\tR\x10residualMaturity\x12\x1e\n\x0bslr_non_slr\x18(\x20\
    \x01(\tR\tslrNonSlr\x12\x16\n\x06listed\x18)\x20\x01(\tR\x06listed\x12\
    \x1f\n\x0bissuer_name\x18*\x20\x01(\tR\nissuerName\x12#\n\rrating_agency\
    \x18+\x20\x01(\tR\x0cratingAgency\x12\x16\n\x06rating\x18,\x20\x01(\tR\
    \x06rating\x12\x16\n\x06market\x18-\x20\x01(\tR\x06market\x121\n\x14asse\
    t_classification\x18.\x20\x01(\tR\x13assetClassification\x12\x1a\n\x08gu\
    rantor\x18/\x20\x01(\tR\x08gurantor\x12\x1a\n\x08industry\x180\x20\x01(\
    \tR\x08industry\x12!\n\x0csub_industry\x181\x20\x01(\tR\x0bsubIndustry\
