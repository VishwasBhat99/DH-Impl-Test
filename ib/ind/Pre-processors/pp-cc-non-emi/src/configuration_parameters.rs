...
impl ConfigurationParameters {
    pub fn log_parameters(&self, logger: &Logger) {
        ...
        info!(logger, "start_mat_date: {}", self.start_mat_date());
...
impl ConfigurationParameters {
    fn new_from_matches(matches: clap::ArgMatches) -> ConfigurationParameters {
        ...
        let branch_code = matches
            ...
            .to_string();
        let start_mat_date = matches
            .value_of("start_mat_date")
            .expect("Error getting `start_mat_date`.")
            .to_string();
...
impl ConfigurationParameters {
    ...
    pub fn start_mat_date(&self) -> &str {
        &self.start_mat_date
    }
...
fn get_eligible_arguments_for_app(app_name: &str) -> clap::ArgMatches {
    Command::new(app_name)
        .about("Pre Processor Non EMI Credit Card for IB")
        ...
        .arg(
            Arg::new("currency")
                ...
                .help("The currency code the program assumes.")
                .required(true)
        )
        .arg(
            Arg::new("country")
                ...
                .help("The country code the program assumes.")
                .required(true)
        )
        .arg(
            Arg::new("int_rate")
        ...
        .arg(
            Arg::new("start_mat_date")
                .long("start-mat-date")
                .value_name("Start and Maturity Day")
                .help("The day of transaction and day of billing the program assumes.")
                .default_value("20,4")
                .required(false)
        )
        .get_matches()
