...
//! Generated file from `ib_loans_emi.proto`
...
pub struct Account {
    ...
    pub repay_count: i64,
    pub repay_day: i64,
    pub repay_freq: ::std::string::String,
    pub app_amt: f64,
    pub loan_bal: f64,
    pub adv_bal: f64,
    ...
    pub last_credit_dt: ::std::string::String,
...
impl Account {
    ...
    pub fn get_repay_count(&self) -> i64 {
        self.repay_count
    }
    ...
    // Param is passed by value, moved
    pub fn set_repay_count(&mut self, v: i64) {
        self.repay_count = v;
    }
    ...
    // Param is passed by value, moved
    pub fn set_repay_day(&mut self, v: i64) {
        self.repay_day = v;
    }
    ...
    pub fn get_repay_freq(&self) -> &str {
        &self.repay_freq
    }
    pub fn clear_repay_freq(&mut self) {
        self.repay_freq.clear();
    }

    // Param is passed by value, moved
    pub fn set_repay_freq(&mut self, v: ::std::string::String) {
        self.repay_freq = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_repay_freq(&mut self) -> &mut ::std::string::String {
        &mut self.repay_freq
    }

    // Take field
    pub fn take_repay_freq(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.repay_freq, ::std::string::String::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_loan_trm(&mut self, v: i64) {
        self.loan_trm = v;
    }
    ...
    // Param is passed by value, moved
    pub fn set_rt_incr(&mut self, v: i64) {
        self.rt_incr = v;
    }
    ...
    // int64 theo_unpd_arrs_int = 31;


    pub fn get_theo_unpd_arrs_int(&self) -> i64 {
    ...
    // Param is passed by value, moved
    pub fn set_theo_unpd_arrs_int(&mut self, v: i64) {
        self.theo_unpd_arrs_int = v;
    }

    // int64 security_amount = 32;


    pub fn get_security_amount(&self) -> i64 {
    ...
    // Param is passed by value, moved
    pub fn set_security_amount(&mut self, v: i64) {
        self.security_amount = v;
    }

    // string last_credit_dt = 33;


    pub fn get_last_credit_dt(&self) -> &str {
        &self.last_credit_dt
    }
    pub fn clear_last_credit_dt(&mut self) {
        self.last_credit_dt.clear();
    }

    // Param is passed by value, moved
    pub fn set_last_credit_dt(&mut self, v: ::std::string::String) {
        self.last_credit_dt = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_last_credit_dt(&mut self) -> &mut ::std::string::String {
        &mut self.last_credit_dt
    }

    // Take field
    pub fn take_last_credit_dt(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.last_credit_dt, ::std::string::String::new())
    }
...
impl ::protobuf::Message for Account {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                8 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.repay_freq)?;
                },
                9 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed64 {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                33 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.last_credit_dt)?;
                },
                34 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.repay_freq.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.repay_freq);
        }
        if self.app_amt != 0. {
            my_size += 9;
        }
        ...
        if self.loan_trm != 0 {
            my_size += ::protobuf::rt::value_size(21, self.loan_trm, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.rt_incr != 0 {
            my_size += ::protobuf::rt::value_size(25, self.rt_incr, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.theo_unpd_arrs_int != 0 {
            my_size += ::protobuf::rt::value_size(31, self.theo_unpd_arrs_int, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.security_amount != 0 {
            my_size += ::protobuf::rt::value_size(32, self.security_amount, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.last_credit_dt.is_empty() {
            my_size += ::protobuf::rt::string_size(33, &self.last_credit_dt);
        }
        ...
        if self.a1 != 0 {
            my_size += ::protobuf::rt::value_size(53, self.a1, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.a2 != 0 {
            my_size += ::protobuf::rt::value_size(54, self.a2, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.a3 != 0 {
            my_size += ::protobuf::rt::value_size(55, self.a3, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.a4 != 0 {
            my_size += ::protobuf::rt::value_size(56, self.a4, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.a5 != 0 {
            my_size += ::protobuf::rt::value_size(57, self.a5, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.a6 != 0 {
            my_size += ::protobuf::rt::value_size(58, self.a6, ::protobuf::wire_format::WireTypeVarint);
        }
        if !self.a7.is_empty() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.repay_count != 0 {
            os.write_int64(6, self.repay_count)?;
        }
        if self.repay_day != 0 {
            os.write_int64(7, self.repay_day)?;
        }
        if !self.repay_freq.is_empty() {
            os.write_string(8, &self.repay_freq)?;
        }
        if self.app_amt != 0. {
        ...
        if self.loan_trm != 0 {
            os.write_int64(21, self.loan_trm)?;
        }
        if !self.bad_debt_ind.is_empty() {
        ...
        if self.rt_incr != 0 {
            os.write_int64(25, self.rt_incr)?;
        }
        if !self.customer_no.is_empty() {
        ...
        if self.theo_unpd_arrs_int != 0 {
            os.write_int64(31, self.theo_unpd_arrs_int)?;
        }
        if self.security_amount != 0 {
            os.write_int64(32, self.security_amount)?;
        }
        if !self.last_credit_dt.is_empty() {
            os.write_string(33, &self.last_credit_dt)?;
        }
        if !self.old_bad_debt_ind.is_empty() {
        ...
        if self.a1 != 0 {
            os.write_int64(53, self.a1)?;
        }
        if self.a2 != 0 {
            os.write_int64(54, self.a2)?;
        }
        if self.a3 != 0 {
            os.write_int64(55, self.a3)?;
        }
        if self.a4 != 0 {
            os.write_int64(56, self.a4)?;
        }
        if self.a5 != 0 {
            os.write_int64(57, self.a5)?;
        }
        if self.a6 != 0 {
            os.write_int64(58, self.a6)?;
        }
        if !self.a7.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0capplicAmount\x12\x1f\n\x0brepay_count\x18\x06\x20\x01(\x03R\nrepayCo\
    unt\x12\x1b\n\trepay_day\x18\x07\x20\x01(\x03R\x08repayDay\x12\x1d\n\nre\
    pay_freq\x18\x08\x20\x01(\tR\trepayFreq\x12\x17\n\x07app_amt\x18\t\x20\
    ...
    \x08loan_trm\x18\x15\x20\x01(\x03R\x07loanTrm\x12\x20\n\x0cbad_debt_ind\
    \x18\x16\x20\x01(\tR\nbadDebtInd\x12\x20\n\x0carr_int_accr\x18\x17\x20\
    \x01(\x01R\narrIntAccr\x12\x20\n\x0carr_int_incr\x18\x18\x20\x01(\x01R\n\
    arrIntIncr\x12\x17\n\x07rt_incr\x18\x19\x20\x01(\x03R\x06rtIncr\x12\x1f\
    ...
    heo_unpd_arrs_int\x18\x1f\x20\x01(\x03R\x0ftheoUnpdArrsInt\x12'\n\x0fsec\
    urity_amount\x18\x20\x20\x01(\x03R\x0esecurityAmount\x12$\n\x0elast_cred\
    it_dt\x18!\x20\x01(\tR\x0clastCreditDt\x12'\n\x10old_bad_debt_ind\x18\"\
    \x20\x01(\tR\roldBadDebtInd\x12\x19\n\x08npa_date\x18#\x20\x01(\x03R\x07\
    npaDate\x12%\n\x0ecollection_amt\x18$\x20\x01(\x01R\rcollectionAmt\x12)\
    \n\x10provision_amount\x18%\x20\x01(\x01R\x0fprovisionAmount\x12,\n\x12l\
    ast_repriced_date\x18&\x20\x01(\x03R\x10lastRepricedDate\x12,\n\x12next_\
    repriced_date\x18'\x20\x01(\x03R\x10nextRepricedDate\x12/\n\x13repricing\
    _frequency\x18(\x20\x01(\tR\x12repricingFrequency\x12\x12\n\x04inca\x18)\
    \x20\x01(\tR\x04inca\x12#\n\rrating_source\x18*\x20\x01(\tR\x0cratingSou\
    rce\x12\x1f\n\x0brating_code\x18+\x20\x01(\tR\nratingCode\x12\x1c\n\tben\
    chmark\x18,\x20\x01(\tR\tbenchmark\x12\x12\n\x04name\x18-\x20\x01(\tR\
    \x04name\x12\x20\n\x0ccust_acct_no\x18.\x20\x01(\tR\ncustAcctNo\x12\x1b\
    \n\tprim_acct\x18/\x20\x01(\tR\x08primAcct\x12!\n\x0csegment_code\x180\
    \x20\x01(\tR\x0bsegmentCode\x12#\n\rindustry_code\x181\x20\x01(\tR\x0cin\
    dustryCode\x12\x1b\n\tgrup_code\x182\x20\x01(\tR\x08grupCode\x12&\n\x0fb\
    us_sector_code\x183\x20\x01(\tR\rbusSectorCode\x12$\n\x0etier_cust_type\
    \x184\x20\x01(\tR\x0ctierCustType\x12\x0e\n\x02a1\x185\x20\x01(\x03R\x02\
    a1\x12\x0e\n\x02a2\x186\x20\x01(\x03R\x02a2\x12\x0e\n\x02a3\x187\x20\x01\
    (\x03R\x02a3\x12\x0e\n\x02a4\x188\x20\x01(\x03R\x02a4\x12\x0e\n\x02a5\
    \x189\x20\x01(\x03R\x02a5\x12\x0e\n\x02a6\x18:\x20\x01(\x03R\x02a6\x12\
