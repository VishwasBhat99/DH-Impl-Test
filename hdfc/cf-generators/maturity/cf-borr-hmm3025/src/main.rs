...
fn main() {
    ...
    let app_name = "et_borr_hmm3025_cf";
    ...
    info!(
        log,
        "Total Duration of Etreasury-borrowing-HMM3025-Cashflow generator: {:?}", total_duration
    );
    println!(
        "Total Duration of Etreasury-borrowing-HMM3025-Cashflow generator: {:?}",
        total_duration
    );
}
